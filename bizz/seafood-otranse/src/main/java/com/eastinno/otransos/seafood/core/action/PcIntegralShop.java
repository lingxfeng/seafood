...
import com.eastinno.otransos.seafood.promotions.service.IIntegralBuyRegularService;
...
public class PcIntegralShop extends ShopBaseAction {
	...
	public Page doCreateOrder(WebForm form){
		...
		if(f!=null){
			...
			WeixinBaseUtils.sendMsgToFollower(a, f, "【舟山海鲜之家控股有限公司】尊敬的客户"+member.getNickname()+"您好！您于"+order.getCeateDate()+"所下订单:"+order.getCode()+"已成功，我们将及时为您发货，如需服务，请致电400-9261088；");
		}
