...
public class ShopMember extends User{
	...
	private Double consumptionDistri = 0.0;//分销总金额
	...
	public Double getConsumptionDistri() {
		return consumptionDistri;
	}

	public void setConsumptionDistri(Double consumptionDistri) {
		this.consumptionDistri = consumptionDistri;
	}
