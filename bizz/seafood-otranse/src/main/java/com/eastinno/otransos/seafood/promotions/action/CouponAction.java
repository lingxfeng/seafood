...
public class CouponAction extends AbstractPageCmdAction {
	...
	public Page doSave(WebForm form) {
		...
		String imgPath = FileUtil.uploadFile(form, "imgPath", UploadFileConstant.FILE_UPLOAD_PATH + "/"
				+ DiscoShopUtil.getMerchantCode() + "/" + UploadFileConstant.FILE_UPLOAD_TYPE_IMAGE, "jpg;png");
		if (!"".equals(imgPath)) {
