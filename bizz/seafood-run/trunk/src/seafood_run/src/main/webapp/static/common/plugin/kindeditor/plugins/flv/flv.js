            ...
            var dialog = self.createDialog({
                ...
                yesBtn: {
                    ...
                    click: function (e) {
                        ...
                        //É¾³ýÐÞ¸ÄflvÊÇÔö¼ÓµÄstr×Ö·û
                        var str = '/static/common/plugin/kindeditor/plugins/flv/swf/Flvplayer.swf?vcastr_file=';
                        if (url.indexOf(str) >= 0) {
                            var last = url.substring(url.indexOf(str) + str.length, url.length);
                            url = last;
                        }
                        var html = K.mediaImg(self.themesPath + 'common/blank.gif', {
                            src: '/static/common/plugin/kindeditor/plugins/flv/swf/Flvplayer.swf?vcastr_file=' + url,
