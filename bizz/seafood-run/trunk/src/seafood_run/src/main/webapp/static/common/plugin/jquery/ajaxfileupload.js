jQuery.extend({
	...
	createUploadForm : function(id, fileElementId, tag_name, tag_link,
			tag_sort, tag_status, tag_id) {
		// create form
		...
		// --
		var tagNameElement = '<input type="text" name="tag_name" value="'
				+ tag_name + '">';
		var tagLinkElement = '<input type="text" name="tag_link" value="'
				+ tag_link + '">';
		var tagSortElement = '<input type="text" name="tag_sort" value="'
				+ tag_sort + '">';
		var tagStatusElement = '<input type="text" name="tag_status" value="'
				+ tag_status + '">';
	...
	ajaxFileUpload : function(s) {
		...
		var form = jQuery.createUploadForm(id, s.fileElementId, s.tag_name,
