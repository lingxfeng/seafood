...
ConfigConst.CRM = {
    ...
    distributor: Ext.apply({}, {
        ...
        minChars: 20,
        queryParam: "searchKey"
    }, Disco.Ext.Util.buildRemoteCombox("distributor", "微店", "distributor.java?cmd=autocompleteList&pageSize=15", ["id", "fullName", "name", "tel", "address", "fax", "linkMan", "accountBalance", "qualityAssure", "other1", "company"], "name", "id", true)),
    orders: Ext.apply({}, {
        editable: true,
        enableKeyEvents: true,
        minChars: 2,
