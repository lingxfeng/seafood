/*
 * jqGrid 4.5.2 - jQuery Grid Copyright (c) 2008, Tony Tomov, tony@trirand.com
 * Dual licensed under the MIT and GPL licenses
 * http://www.opensource.org/licenses/mit-license.php
 * http://www.gnu.org/licenses/gpl-2.0.html Date:2013-05-21 Modules:
 * grid.base.js; jquery.fmatter.js; grid.custom.js; grid.common.js;
 * grid.formedit.js; grid.filter.js; grid.inlinedit.js; grid.celledit.js;
 * jqModal.js; jqDnR.js; grid.subgrid.js; grid.grouping.js; grid.treegrid.js;
 * grid.import.js; JsonXml.js; grid.tbltogrid.js; grid.jqueryui.js;
 */
...
(function(b) {
	...
	b.extend(b.jgrid, {
		...
		parse : function(d) {
			...
			d || (d = "{}");
			return !0 === b.jgrid.useJSON && "object" === typeof JSON
		...
		parseDate : function(d, f, c, e) {
			...
			if (f && null != f)
				if (!isNaN(f - 0) && "u" === ("" + d).toLowerCase())
					...
					h = new Date(parseInt(j[1], 10)), j[3]
							&& (d = 60 * Number(j[5]) + Number(j[6]), d *= "-" === j[4]
									? 1
									: -1, d -= h.getTimezoneOffset(), h
									.setTime(Number(Number(h) + 6E4 * d)));
				else {
					f = ("" + f).replace(/\\T/g, "T").replace(/\\t/, "t")
							.split(e.parseRe);
					d = d.replace(/\\T/g, "T").replace(/\\t/, "t")
							.split(e.parseRe);
					i = 0;
					for (k = d.length; i < k; i++)
						"M" === d[i]
								&& (j = b.inArray(f[i], e.monthNames), -1 !== j
										&& 12 > j && (f[i] = j + 1, g.m = f[i])), "F" === d[i]
								&& (j = b.inArray(f[i], e.monthNames, 12), -1 !== j
										&& 11 < j
										&& (f[i] = j + 1 - 12, g.m = f[i])), "a" === d[i]
								&& (j = b.inArray(f[i], e.AmPm), -1 !== j
										&& 2 > j && f[i] === e.AmPm[j]
										&& (f[i] = j, g.h = h(f[i], g.h))), "A" === d[i]
								&& (j = b.inArray(f[i], e.AmPm), -1 !== j
										&& 1 < j && f[i] === e.AmPm[j]
										&& (f[i] = j - 2, g.h = h(f[i], g.h))), "g" === d[i]
								&& (g.h = parseInt(f[i], 10)), void 0 !== f[i]
								&& (g[d[i].toLowerCase()] = parseInt(f[i], 10));
					g.f && (g.m = g.f);
					if (0 === g.m && 0 === g.y && 0 === g.d)
						return "&#160;";
					g.m = parseInt(g.m, 10) - 1;
					h = g.y;
					70 <= h && 99 >= h ? g.y = 1900 + g.y : 0 <= h && 69 >= h
							&& (g.y = 2E3 + g.y);
			...
			k = h.getSeconds();
			var l = h.getMilliseconds(), o = h.getDay(), n = h.getFullYear(), m = (o + 6)
					% 7 + 1, t = (new Date(n, j - 1, g) - new Date(n, 0, 1))
					/ 864E5, A = {
				d : a(g),
				D : e.dayNames[o],
				j : g,
				...
				w : o,
				z : t,
				W : 5 > m ? Math.floor((t + m - 1) / 7) + 1 : Math
						.floor((t + m - 1) / 7)
						|| (4 > ((new Date(n - 1, 0, 1)).getDay() + 6) % 7
								? 53
								: 52),
				...
				I : "?",
				O : (0 < i ? "-" : "+")
						+ a(	100 * Math.floor(Math.abs(i) / 60)
										+ Math.abs(i) % 60, 4),
				P : "?",
				T : (("" + h)
			...
			return c.replace(/\\.|[dDjlNSwzWFmMntLoYyaABgGhHisueIOPTZcrU]/g,
					function(a) {
						return A.hasOwnProperty(a) ? A[a] : a.substring(1)
					})
		},
		jqID : function(b) {
			return ("" + b).replace(/[!"#$%&'()*+,.\/:; <=>?@\[\\\]\^`{|}~]/g,
		...
		cellWidth : function() {
			var d = b("<div class='ui-jqgrid' style='left:10000px'><table class='ui-jqgrid-btable' style='width:5px;'><tr class='jqgrow'><td style='width:5px;'></td></tr></table></div>"), f = d
		...
		from : function(d) {
			return new function(d, c) {
				...
				var e = this, a = d, j = !0, g = !1, h = c, i = /[\$,%]/g, k = null, l = null, o = 0, n = !1, m = "", t = [], A = !0;
				...
				this._compare = function(a, b, e) {
					...
					!j && "number" !== typeof a && "number" !== typeof b
							&& (a = "" + a, b = "" + b);
					return a < b ? -e : a > b ? e : 0
				};
				...
				this._getOrder = function(a, d, g, c, f) {
					...
					void 0 === c && (c = "text");
					n = "float" === c || "number" === c || "currency" === c
							|| "numeric" === c ? function(a) {
							...
							case "datetime" :
								h = ""
										+ b.jgrid.parseDate(
												c.newfmt || "Y-m-d", h)
												.getTime();
								f = 'jQuery.jgrid.parseDate("' + c.srcfmt
										+ '",' + f + ").getTime()";
								break;
							default :
								f = e._getStr(f), h = e._getStr('"'
										+ e._toStr(h) + '"')
						}
					e._append(f + " " + j + " " + h);
					e._setCommand(a, d);
				...
				this.startsWith = function(a, d) {
					var c = null == d ? a : d, c = g
							? b.trim(c.toString()).length
							: c.toString().length;
					A ? e._append(e._getStr("jQuery.jgrid.getAccessor(this,'"
							+ a + "')")
							+ ".substr(0,"
							+ c
							+ ") == "
							+ e._getStr('"' + e._toStr(d) + '"')) : (c = g ? b
							.trim(d.toString()).length : d.toString().length, e
							._append(e._getStr("this") + ".substr(0," + c
									+ ") == "
									+ e._getStr('"' + e._toStr(a) + '"')));
				...
				this.endsWith = function(a, d) {
					...
					A ? e._append(e._getStr("jQuery.jgrid.getAccessor(this,'"
							+ a + "')")
							+ ".substr("
							+ e._getStr("jQuery.jgrid.getAccessor(this,'" + a
									+ "')")
							+ ".length-"
							+ c
							+ ","
							+ c
							+ ') == "' + e._toStr(d) + '"') : e._append(e
							._getStr("this")
							+ ".substr("
							+ e._getStr("this")
							+ '.length-"'
				...
				this.contains = function(a, b) {
					A ? e._append(e._getStr("jQuery.jgrid.getAccessor(this,'"
							+ a + "')")
							+ '.indexOf("' + e._toStr(b) + '",0) > -1') : e
							._append(e._getStr("this") + '.indexOf("'
									+ e._toStr(a) + '",0) > -1');
			...
			if (!this.grid) {
				var e = b.extend(!0, {
					...
					dragStart : function(c, d, g) {
						...
						this.curGbox = b("#rs_m" + b.jgrid.jqID(e.id), "#gbox_"
										+ b.jgrid.jqID(e.id));
						this.curGbox.css({
									display : "block",
									left : g[0],
						...
						b.isFunction(e.resizeStart)
								&& e.resizeStart.call(a, d, c);
					...
					dragMove : function(a) {
						if (this.resizing) {
							var b = a.clientX - this.resizing.startX, a = this.headers[this.resizing.idx], c = "ltr" === e.direction
									? a.width + b
									: a.width - b, d;
							33 < c
									&& (this.curGbox.css({
											...
											? (d = this.headers[this.resizing.idx
													+ e.nv], b = "ltr" === e.direction
													? d.width - b
													: d.width + b, 33 < b
													&& (a.newWidth = c, d.newWidth = b))
					...
					dragEnd : function() {
						...
						if (this.resizing) {
							var c = this.resizing.idx, d = this.headers[c].newWidth
									|| this.headers[c].width, d = parseInt(d,
									10);
							this.resizing = !1;
							b("#rs_m" + b.jgrid.jqID(e.id)).css("display",
									"none");
							e.colModel[c].width = d;
							this.headers[c].width = d;
							this.headers[c].el.style.width = d + "px";
							this.cols[c].style.width = d + "px";
							0 < this.footers.length
									&& (this.footers[c].style.width = d + "px");
							!0 === e.forceFit
									? (d = this.headers[c + e.nv].newWidth
											|| this.headers[c + e.nv].width, this.headers[c
											+ e.nv].width = d, this.headers[c
											+ e.nv].el.style.width = d + "px", this.cols[c
											+ e.nv].style.width = d + "px", 0 < this.footers.length
											&& (this.footers[c + e.nv].style.width = d
													+ "px"), e.colModel[c
											+ e.nv].width = d)
									: (e.tblwidth = this.newWidth || e.tblwidth, b(
											"table:first", this.bDiv).css(
											"width", e.tblwidth + "px"), b(
											"table:first", this.hDiv).css(
											"width", e.tblwidth + "px"), this.hDiv.scrollLeft = this.bDiv.scrollLeft, e.footerrow
											&& (b("table:first", this.sDiv)
													.css("width",
															e.tblwidth + "px"), this.sDiv.scrollLeft = this.bDiv.scrollLeft));
							b(a).triggerHandler("jqGridResizeStop", [d, c]);
							b.isFunction(e.resizeStop)
									&& e.resizeStop.call(a, d, c)
						}
						this.curGbox = null;
						document.onselectstart = function() {
							return !0
					...
					populateVisible : function() {
						...
						if (a) {
							...
							if (f) {
								...
								var i = Math.round(d.position().top) - g, k = i
										+ d.height();
								f *= h;
								var z, F, y;
								if (k < a
										&& 0 >= i
										&& (void 0 === e.lastpage || parseInt(
												(k + g + f - 1) / f, 10) <= e.lastpage))
									F = parseInt((a - k + f - 1) / f, 10), 0 <= k
											|| 2 > F || !0 === e.scroll
											? (z = Math.round((k + g) / f) + 1, i = -1)
											: i = 1;
								0 < i
										&& (z = parseInt(g / f, 10) + 1, F = parseInt(
												(g + a) / f, 10)
												+ 2 - z, y = !0);
								if (F
										&& (!e.lastpage || !(z > e.lastpage
												|| 1 === e.lastpage || z === e.page
												&& z === e.lastpage)))
									c.hDiv.loading
											? c.timer = setTimeout(
													c.populateVisible,
											...
											: (e.page = z, y
													&& (c
															.selectionPreserver(d[0]), c.emptyRows
															.call(d[0], !1, !1)), c
													.populate(F))
							}
						}
					...
					scrollGrid : function(a) {
						if (e.scroll) {
							...
							b !== c.scrollTop
									&& (c.scrollTop = b, c.timer
											&& clearTimeout(c.timer), c.timer = setTimeout(
											c.populateVisible, e.scrollTimeout))
						}
					...
					selectionPreserver : function(a) {
						var c = a.p, d = c.selrow, e = c.selarrrow ? b
								.makeArray(c.selarrrow) : null, g = a.grid.bDiv.scrollLeft, f = function() {
							var h;
							c.selrow = null;
							c.selarrrow = [];
				...
				if ("TABLE" !== this.tagName.toUpperCase())
					...
					if (0 === this.p.colNames.length)
						for (g = 0; g < this.p.colModel.length; g++)
							this.p.colNames[g] = this.p.colModel[g].label
									|| this.p.colModel[g].name;
					if (this.p.colNames.length !== this.p.colModel.length)
						...
						-1 === b.inArray(a.p.direction, ["ltr", "rtl"])
								&& (a.p.direction = "ltr");
						f = a.p.direction;
						...
						var o = function(a, b) {
							...
							if (e === 0)
								z = z
										+ ("width: " + c.headers[d].width + "px;");
							else if (R.cellattr && b.isFunction(R.cellattr))
								if ((d = R.cellattr.call(a, h, g, f, R, i))
										&& typeof d === "string") {
									d = d.replace(/style/i, "style").replace(
											/title/i, "title");
							...
							z = z
									+ ((F !== void 0
											...
											+ b.jgrid.stripHtml(g) + '"' : ""));
							z = z
									+ (' aria-describedby="' + a.p.id + "_" + y + '"');
							return z + G[0]
						}, m = function(c) {
							return c == null || c === ""
									? "&#160;"
									: a.p.autoencode
											? b.jgrid.htmlEncode(c)
											: "" + c
						}, t = function(c, d, e, g, f) {
							var h = a.p.colModel[e];
							if (h.formatter !== void 0) {
								c = "" + a.p.idPrefix !== "" ? b.jgrid
										.stripPref(a.p.idPrefix, c) : c;
								c = {
									rowId : c,
									colModel : h,
									gid : a.p.id,
								...
								d = b.isFunction(h.formatter) ? h.formatter
										.call(a, d, c, g, f) : b.fmatter
										? b.fn.fmatter.call(a, h.formatter, d,
												c, g, f)
										: m(d)
							} else
								d = m(d);
							...
							b = t(a, b, c, e, "add");
							return '<td role="gridcell" ' + n(c, d, b, e, a, g)
									+ ">" + b + "</td>"
						}, T = function(b, c, d, e) {
							...
							for (g = 0; g < a.p.colModel.length; g++) {
								c = a.p.colModel[g];
								if (c.name !== "cb" && c.name !== "subgrid"
										&& c.name !== "rn") {
									d[e] = b === "local" ? c.name : b === "xml"
											|| b === "xmlstring" ? c.xmlmap
											|| c.name : c.jsonmap || c.name;
									e++
								}
							}
							return d
							...
							var j = "-1", i = "", k, d = d
									...
									+ a.p.direction
									+ (e ? " " + e : "")
									+ (h ? " ui-state-highlight" : ""), h = b(a)
									.triggerHandler("jqGridRowAttr", [g, f, c]);
							typeof h !== "object"
									&& (h = b.isFunction(a.p.rowattr)
							...
							return '<tr role="row" id="' + c + '" tabindex="'
									+ j + '" class="' + e + '"'
									+ (d === "" ? "" : ' style="' + d + '"')
									+ i + ">"
						}, J = function(c, d, e, g, f) {
							var h = new Date, j = a.p.datatype !== "local"
									&& a.p.loadonce
									|| a.p.datatype === "xmlstring", i = a.p.xmlReader, k = a.p.datatype === "local"
									? "local"
									: "xml";
							if (j) {
								a.p.data = [];
							...
							if (b.isXMLDoc(c)) {
								if (a.p.treeANode === -1 && !a.p.scroll) {
									...
									e = e > 1 ? e : 1;
								var F = b(a), y, G, l = 0, o, s = a.p.multiselect === true
										? 1
										: 0, u = 0, n, m = a.p.rownumbers === true
										? 1
										: 0, t, p = [], E, q = {}, x, D, r = [], K = a.p.altRows === true
										? a.p.altclass
										: "", v;
								if (a.p.subGrid === true) {
									u = 1;
								...
								i.repeatitems || (p = $(k));
								t = a.p.keyIndex === false ? b.isFunction(i.id)
										? i.id.call(a, c)
										: i.id : a.p.keyIndex;
								...
								k = ("" + t).indexOf("[") === -1 ? p.length
										? function(a, c) {
											return b(t, a).text() || c
										}
										: function(a, c) {
											return b(i.cell, a).eq(t).text()
													|| c
										} : function(a, b) {
								...
								a.p.userData = {};
								a.p.page = b.jgrid.getXmlData(c, i.page)
										|| a.p.page || 0;
								a.p.lastpage = b.jgrid.getXmlData(c, i.total);
								if (a.p.lastpage === void 0)
									a.p.lastpage = 1;
								a.p.records = b.jgrid.getXmlData(c, i.records)
										|| 0;
								b.isFunction(i.userdata)
										? a.p.userData = i.userdata.call(a, c)
												|| {}
										: b.jgrid.getXmlData(c, i.userdata,
												true).each(function() {
											a.p.userData[this
								...
								(c = b.jgrid.getXmlData(c, i.row, true))
										|| (c = []);
								var w = c.length, L = 0, B = [], C = parseInt(
										a.p.rowNum, 10), H = a.p.scroll
										? b.jgrid.randId()
										: 1;
								if (w > 0 && a.p.page <= 0)
									a.p.page = 1;
								if (c && w) {
									...
									for (; L < w;) {
										...
										r.push("");
										m
												&& r.push(M(0, L, a.p.page,
														a.p.rowNum));
										s && r.push(T(D, m, L, false));
										u && r.push(n.call(F, s + m, L + e));
										if (i.repeatitems) {
											E || (E = U(s + u + m));
											var N = b.jgrid.getXmlData(x,
													i.cell, true);
											b.each(E, function(b) {
												var c = N[this];
												if (!c)
										...
										if (j || a.p.treeGrid === true) {
											q._id_ = b.jgrid.stripPref(
													a.p.idPrefix, D);
											a.p.data.push(q);
											a.p._index[q._id_] = a.p.data.length
													- 1
										}
										if (a.p.gridview === false) {
											b("tbody:first", d).append(r
													.join(""));
											F.triggerHandler(
													"jqGridAfterInsertRow", [D,
															q, x]);
											f
							...
							if (c) {
								...
								var k = b(a), l = 0, y, o, n, m = [], s = a.p.multiselect
										? 1
										: 0, u = a.p.subGrid === true ? 1 : 0, t, p = a.p.rownumbers === true
										? 1
										: 0, w = U(s + u + p);
								i = $(i);
								var v, E, q, x = {}, D, r, K = [], B = a.p.altRows === true
										? a.p.altclass
										: "", C;
								a.p.page = b.jgrid.getAccessor(c, d.page)
										|| a.p.page || 0;
								E = b.jgrid.getAccessor(c, d.total);
								u && (t = b.jgrid.getMethod("addSubGridCell"));
								a.p.lastpage = E === void 0 ? 1 : E;
								a.p.records = b.jgrid.getAccessor(c, d.records)
										|| 0;
								a.p.userData = b.jgrid.getAccessor(c,
										d.userdata)
										|| {};
								q = a.p.keyIndex === false ? b.isFunction(d.id)
										? d.id.call(a, c)
										: d.id : a.p.keyIndex;
								if (!d.repeatitems) {
									m = i;
								...
								if (c > 0 && a.p.page <= 0)
									a.p.page = 1;
								var L = parseInt(a.p.rowNum, 10), H = a.p.scroll
										? b.jgrid.randId()
										: 1, J = false, I;
								f && (L = L * (f + 1));
								a.p.datatype === "local"
										&& !a.p.deselectAfterSort && (J = true);
								var O = b.isFunction(a.p.afterInsertRow), N = [], P = false, Q;
								if (a.p.grouping) {
								...
								for (; o < c;) {
									...
									if (r === void 0) {
										typeof q === "number"
												...
												&& (r = b.jgrid.getAccessor(f,
														a.p.colModel[q + s + u
																+ p].name));
										if (r === void 0) {
											r = H + o;
											if (m.length === 0 && d.cell) {
												y = b.jgrid.getAccessor(f,
														d.cell)
														|| f;
												r = y != null
														&& y[q] !== void 0
									...
									if (j || a.p.treeGrid === true) {
										x._id_ = b.jgrid.stripPref(
												a.p.idPrefix, r);
										a.p.data.push(x);
										a.p._index[x._id_] = a.p.data.length
												- 1
									}
									if (a.p.gridview === false) {
										b("#" + b.jgrid.jqID(a.p.id)
												+ " tbody:first").append(K
												.join(""));
										k.triggerHandler(
												"jqGridAfterInsertRow", [r, x,
														f]);
										O
								...
								if (j)
									for (; l < c && E[l];) {
										...
										if (f) {
											...
											for (n = 0; n < v.length; n++)
												x[a.p.colModel[n + s + u + p].name] = b.jgrid
														.getAccessor(f, v[n]);
											x._id_ = b.jgrid.stripPref(
													a.p.idPrefix, r);
											a.p.data.push(x);
								...
								if (a.rules != null)
									try {
										...
										for (d = 0; d < a.rules.length; d++) {
											i = a.rules[d];
											h = a.groupOp.toString()
													.toUpperCase();
											if (p[i.op] && i.field) {
												b > 0 && h && h === "OR"
														&& (s = s.or());
												s = p[i.op](s, h)(i.field,
														i.data, f[i.field])
											}
											b++
										}
							...
							if (b.isArray(a.p.data)) {
								...
								if (a.p.treeGrid)
									...
									if (a.p.grouping)
										for (m = 0; m < n; m++)
											s.orderBy(i[m], o.groupOrder[m],
													h[m].stype, h[m].srcfmt);
									a.p.multiSort
											? b.each(d, function(a) {
														s.orderBy(this, e[a],
																f[this].stype,
													...
													&& (a.p.sortorder
															...
															: s
																	.orderBy(
																			...
																			f[d].stype,
																			f[d].srcfmt));
									var u = s.select(), v = parseInt(
											a.p.rowNum, 10), w = u.length, A = parseInt(
											a.p.page, 10), B = Math.ceil(w / v), q = {}, u = u
											.slice((A - 1) * v, A * v), f = s = null;
							...
							if (!a.grid.hDiv.loading) {
								...
								var h = b.isFunction(a.p.loadComplete), i = h
										? a.p.loadComplete
										: null, j = 0, c = c || 1;
								if (c > 1)
									if (f.npage !== null) {
								...
								var n = !a.p.scroll ? 1 : a.rows.length - 1, e = b(a)
							...
							var e = "", g = "<table cellspacing='0' cellpadding='0' border='0' style='table-layout:auto;' class='ui-pg-table'><tbody><tr>", i = "", j, k, l, m, n = function(
									c) {
								var d;
								b.isFunction(a.p.onPaging)
										&& (d = a.p.onPaging.call(a, c));
								a.p.selrow = null;
								if (a.p.multiselect) {
									a.p.selarrrow = [];
									ca(false)
							...
							if (a.p.pgbuttons === true) {
								k = ["first" + d, "prev" + d, "next" + d,
										"last" + d];
								f === "rtl" && k.reverse();
								g = g
										+ ("<td id='" + k[0] + "' class='ui-pg-button ui-corner-all'><span class='ui-icon ui-icon-seek-first'></span></td>");
								g = g
										+ ("<td id='" + k[1] + "' class='ui-pg-button ui-corner-all'><span class='ui-icon ui-icon-seek-prev'></span></td>");
								g = g
										+ (e !== ""
								...
								g = g
										+ ("<td id='" + k[3] + "' class='ui-pg-button ui-corner-all'><span class='ui-icon ui-icon-seek-end'></span></td>")
							} else
								e !== "" && (g = g + e);
							f === "ltr" && (g = g + i);
							g = g + "</tr></tbody></table>";
							a.p.viewrecords === true
									&& b("td#" + c + "_" + a.p.recordpos,
											"#" + j)
											.append("<div dir='"
													+ f
													+ "' style='text-align:"
							...
							if (a.p.pgbuttons === true) {
								...
								b("#first" + b.jgrid.jqID(d) + ", #prev"
										+ b.jgrid.jqID(d) + ", #next"
										+ b.jgrid.jqID(d) + ", #last"
										+ b.jgrid.jqID(d)).click(function() {
									var b = o(a.p.page, 1), c = o(a.p.lastpage,
											1), e = false, g = true, f = true, h = true, i = true;
									if (c === 0 || c === 1)
										i = h = f = g = false;
									else if (c > 1 && b >= 1)
										if (b === 1)
							...
							if (a.p.colModel[d].sortable) {
								...
								if (!(a.p.savedRow.length > 0)) {
									...
									if (a.p.multiSort)
										...
										if (a.p.frozenColumns) {
											a.grid.fhDiv
													...
													.addClass("ui-state-disabled");
											a.grid.fhDiv.find("th").attr(
													"aria-selected", "false")
										}
										b("span.ui-icon-" + a.p.sortorder, f)
												.removeClass("ui-state-disabled");
									...
									if (b(a).triggerHandler("jqGridSortCol",
											[c, d, h]) === "stop")
										a.p.lastsort = d;
									else if (b.isFunction(a.p.onSortCol)
											&& a.p.onSortCol.call(a, c, d, h) === "stop")
										a.p.lastsort = d;
									else {
										if (a.p.datatype === "local")
							...
							c.push(b(a.grid.bDiv).offset().top
									- b(a.grid.hDiv).offset().top
									+ b(a.grid.bDiv).height());
							return c
						}, ma = function(c) {
							var d, e = a.grid.headers, g = b.jgrid
									.getCellIndex(c);
						...
						this.p.id = this.id;
						-1 === b.inArray(a.p.multikey, ["shiftKey", "altKey",
										"ctrlKey"])
								&& (a.p.multikey = !1);
						a.p.keyIndex = !1;
						for (g = 0; g < a.p.colModel.length; g++)
							a.p.colModel[g] = b.extend(!0, {}, a.p.cmTemplate,
									a.p.colModel[g].template || {},
									a.p.colModel[g]), !1 === a.p.keyIndex
									&& !0 === a.p.colModel[g].key
									&& (a.p.keyIndex = g);
						a.p.sortorder = a.p.sortorder.toLowerCase();
						b.jgrid.cell_width = b.jgrid.cellWidth();
						!0 === a.p.grouping
								&& (a.p.scroll = !1, a.p.rownumbers = !1, a.p.treeGrid = !1, a.p.gridview = !0);
						...
						a.p.scroll
								&& (a.p.pgbuttons = !1, a.p.pginput = !1, a.p.rowList = []);
						a.p.data.length && N();
						var B = "<thead><tr class='ui-jqgrid-labels' role='rowheader'>", na, C, da, ea, fa, v, p, W, oa = W = "", ba = [], pa = [];
						C = [];
						...
						"horizontal" === a.p.viewsortcols[1]
								&& (W = " ui-i-asc", oa = " ui-i-desc");
						na = k ? "class='ui-th-div-ie'" : "";
						W = "<span class='s-ico' style='display:none'><span sort='asc' class='ui-grid-ico-sort ui-icon-asc"
								+ W
						...
						if (a.p.multiSort) {
							...
							for (g = 0; g < ba.length; g++)
								C = b.trim(ba[g]).split(" "), ba[g] = b
										.trim(C[0]), pa[g] = C[1] ? b
										.trim(C[1]) : a.p.sortorder || "asc"
						}
						for (g = 0; g < this.p.colNames.length; g++)
							C = a.p.headertitles
									? ' title="'
											+ b.jgrid
													.stripHtml(a.p.colNames[g])
											+ '"'
									: "", B += "<th id='"
									+ a.p.id
									+ "_"
									...
									+ f + "'" + C + ">", C = a.p.colModel[g].index
									|| a.p.colModel[g].name, B += "<div id='jqgh_"
									+ a.p.id
									+ "_"
									+ a.p.colModel[g].name
									+ "' " + na + ">" + a.p.colNames[g], a.p.colModel[g].width = a.p.colModel[g].width
									? parseInt(a.p.colModel[g].width, 10)
									: 150, "boolean" !== typeof a.p.colModel[g].title
									&& (a.p.colModel[g].title = !0), a.p.colModel[g].lso = "", C === a.p.sortname
									&& (a.p.lastsort = g), a.p.multiSort
									&& (C = b.inArray(C, ba), -1 !== C
											&& (a.p.colModel[g].lso = pa[C])), B += W
									+ "</div></th>";
						W = null;
							...
							b("#cb_" + b.jgrid.jqID(a.p.id), this).bind(
									"click", function() {
										...
										b(a).triggerHandler("jqGridSelectAll",
												[Y ? a.p.selarrrow : ga, Y]);
										b.isFunction(a.p.onSelectAll)
												&& a.p.onSelectAll.call(a, Y
																? a.p.selarrrow
																: ga, Y)
									})
						}
						!0 === a.p.autowidth
								&& (B = b(l).innerWidth(), a.p.width = 0 < B
										? B
										: "nw");
		(function		() {
							var d = 0, e = b.jgrid.cell_width ? 0 : o(
									a.p.cellLayout, 0), g = 0, f, h = o(
									a.p.scrollOffset, 0), i, k = false, l, m = 0, n;
							b.each(a.p.colModel, function() {
								if (this.hidden === void 0)
									this.hidden = false;
								if (a.p.grouping && a.p.autowidth) {
									var c = b.inArray(this.name,
											a.p.groupingView.groupField);
									if (c >= 0
											&& a.p.groupingView.groupColumnShow.length > c)
							...
							if (isNaN(a.p.width))
								a.p.width = d
										+ (a.p.shrinkToFit === false
												&& !isNaN(a.p.height) ? h : 0);
							c.width = a.p.width;
							a.p.tblwidth = d;
						...
						var Z = null, i = b("<table class='ui-jqgrid-htable' style='width:"
								+ a.p.tblwidth
								+ "px' role='grid' aria-labelledby='gbox_"
								+ this.id
								+ "' cellspacing='0' cellpadding='0' border='0'></table>")
								.append(B), H = a.p.caption
								&& !0 === a.p.hiddengrid ? !0 : !1;
						...
						H && b(c.hDiv).hide();
						a.p.pager
								&& ("string" === typeof a.p.pager
										? "#" !== a.p.pager.substr(0, 1)
												&& (a.p.pager = "#" + a.p.pager)
										: a.p.pager = "#"
												+ b(a.p.pager).attr("id"), b(a.p.pager)
										.css({
													width : c.width + "px"
												})
										.addClass("ui-state-default ui-jqgrid-pager ui-corner-bottom")
										.appendTo(l), H && b(a.p.pager).hide(), ka(
										a.p.pager, ""));
						!1 === a.p.cellEdit && !0 === a.p.hoverrows
								&& b(a).bind("mouseover", function(a) {
									p = b(a.target).closest("tr.jqgrow");
									b(p).attr("class") !== "ui-subgrid"
											&& b(p).addClass("ui-state-hover")
						...
						b(a).before(c.hDiv).click(function(c) {
							...
							if (b(p).length === 0
									...
									|| (b(v, a)
											...
											"_frozen", "") !== a.id)
								return this;
							var d = b(v).hasClass("cbox"), e = b(a)
									.triggerHandler("jqGridBeforeSelectRow",
											[p[0].id, c]);
							(e = e === false || e === "stop" ? false : true)
									&& b.isFunction(a.p.beforeSelectRow)
									&& (e = a.p.beforeSelectRow.call(a,
											p[0].id, c));
							if (!(v.tagName === "A" || (v.tagName === "INPUT"
									|| v.tagName === "TEXTAREA"
								...
								b(a).triggerHandler("jqGridCellSelect",
										[w, I, ha, c]);
								...
								if (a.p.cellEdit === true)
									...
									if (a.p.multiselect && a.p.multiboxonly
											&& !d) {
										var f = a.p.frozenColumns ? a.p.id
												+ "_frozen" : "";
							...
							if (b(p).length !== 0) {
								...
								b(a).triggerHandler("jqGridDblClickRow",
										[b(p).attr("id"), w, I, c]);
								b.isFunction(a.p.ondblClickRow)
										&& a.p.ondblClickRow.call(a, b(p)
														.attr("id"), w, I, c)
							}
							...
							if (b(p).length !== 0) {
								...
								b(a).triggerHandler("jqGridRightClickRow",
										[b(p).attr("id"), w, I, c]);
								b.isFunction(a.p.onRightClickRow)
										&& a.p.onRightClickRow.call(a, b(p)
														.attr("id"), w, I, c)
							}
						});
						c.bDiv = document.createElement("div");
						k && "auto" === ("" + a.p.height).toLowerCase()
								&& (a.p.height = "100%");
						...
						b.support.tbody || 2 === b("tbody", this).length
								&& b("tbody:gt(0)", this).remove();
						a.p.multikey
								&& (b.jgrid.msie ? b(c.bDiv).bind(
						...
						a.p.toolbar[0]
								&& (c.uDiv = document.createElement("div"), "top" === a.p.toolbar[1]
										? b(c.uDiv).insertBefore(c.hDiv)
										: "bottom" === a.p.toolbar[1]
												&& b(c.uDiv)
														.insertAfter(c.hDiv), "both" === a.p.toolbar[1]
										? (c.ubDiv = document
												.createElement("div"), b(c.uDiv)
												.addClass("ui-userdata ui-state-default")
												.attr("id", "t_" + this.id)
												.insertBefore(c.hDiv), b(c.ubDiv)
												.addClass("ui-userdata ui-state-default")
												.attr("id", "tb_" + this.id)
												.insertAfter(c.hDiv), H
												&& b(c.ubDiv).hide())
										: b(c.uDiv)
												.width(c.width)
												.addClass("ui-userdata ui-state-default")
												.attr("id", "t_" + this.id), H
										&& b(c.uDiv).hide());
						a.p.toppager
								&& (a.p.toppager = b.jgrid.jqID(a.p.id)
										+ "_toppager", c.topDiv = b("<div id='"
										+ a.p.toppager + "'></div>")[0], a.p.toppager = "#"
										+ a.p.toppager, b(c.topDiv)
										.addClass("ui-state-default ui-jqgrid-toppager")
										.width(c.width).insertBefore(c.hDiv), ka(
										a.p.toppager, "_t"));
						a.p.footerrow
								&& (c.sDiv = b("<div class='ui-jqgrid-sdiv'></div>")[0], g = b("<div class='ui-jqgrid-hbox"
										+ ("rtl" === f ? "-rtl" : "")
										+ "'></div>"), b(c.sDiv).append(g)
										.width(c.width).insertAfter(c.hDiv), b(g)
										.append(Q), c.footers = b(
										".ui-jqgrid-ftable", c.sDiv)[0].rows[0].cells, a.p.rownumbers
										&& (c.footers[0].className = "ui-state-default jqgrid-rownum"), H
										&& b(c.sDiv).hide());
						g = null;
						if (a.p.caption) {
							var ta = a.p.datatype;
							!0 === a.p.hidegrid
									&& (b(".ui-jqgrid-titlebar-close", c.cDiv)
											.click(function(d) {
												var e = b
														.isFunction(a.p.onHeaderClick), g = ".ui-jqgrid-bdiv, .ui-jqgrid-hdiv, .ui-jqgrid-pager, .ui-jqgrid-sdiv", f, h = this;
						...
						a.updatepager = function(c, d) {
							var e, g, f, h, i, j, k, l = "", m = a.p.pager
									? "_" + b.jgrid.jqID(a.p.pager.substr(1))
									: "", n = a.p.toppager ? "_"
							...
							if (a.p.scroll) {
								...
								if (e = e.outerHeight() || a.grid.prevRowHeight) {
									...
									if (a.grid.bDiv.scrollTop == 0
											&& a.p.page > 1)
										a.grid.bDiv.scrollTop = a.p.rowNum
												* (a.p.page - 1) * e
								}
									...
									if (a.p.reccount === 0)
										...
										if (b.fmatter) {
											h = b.fmatter.util.NumberFormat(h,
													k);
											i = b.fmatter.util.NumberFormat(i,
													k);
											j = b.fmatter.util.NumberFormat(j,
													k)
										}
										b(".ui-paging-info", l)
												.html(b.jgrid
	...
	b.jgrid.extend({
		getGridParam : function(b) {
			var f = this[0];
			return !f || !f.grid ? void 0 : !b ? f.p : void 0 !== f.p[b]
					? f.p[b]
					: null
		},
		setGridParam : function(d) {
			return this.each(function() {
						this.grid && "object" === typeof d
								&& b.extend(!0, this.p, d)
					})
		},
		getDataIDs : function() {
			...
			this.each(function() {
						if ((c = this.rows.length) && 0 < c)
							for (; f < c;)
								b(this.rows[f]).hasClass("jqgrow")
										&& (d[e] = this.rows[f].id, e++), f++
					});
			return d
		},
		setSelection : function(d, f, c) {
			return this.each(function() {
				var e, a, j, g, h, i;
				if (void 0 !== d
						&& (f = !1 === f ? !1 : !0, (a = this.rows.namedItem(""
								+ d))
								&& a.className
								&& !(-1 < a.className
										.indexOf("ui-state-disabled"))))
					if (!0 === this.p.scrollrows
							&& (j = this.rows.namedItem(d).rowIndex, 0 <= j
									&& (e = b(this.grid.bDiv)[0].clientHeight, g = b(this.grid.bDiv)[0].scrollTop, h = b(this.rows[j])
											.position().top, j = this.rows[j].clientHeight, h
											+ j >= e + g
											? b(this.grid.bDiv)[0].scrollTop = h
													- (e + g) + j + g
											: h < e + g
													&& h < g
													&& (b(this.grid.bDiv)[0].scrollTop = h))), !0 === this.p.frozenColumns
							&& (i = this.p.id + "_frozen"), this.p.multiselect) {
						if (this.setHeadCheckBox(!1), this.p.selrow = a.id, g = b
								.inArray(this.p.selrow, this.p.selarrrow), -1 === g
								? ("ui-subgrid" !== a.className
										&& b(a).addClass("ui-state-highlight")
												.attr("aria-selected", "true"), e = !0, this.p.selarrrow
										.push(this.p.selrow))
								: ("ui-subgrid" !== a.className
										&& b(a)
												.removeClass("ui-state-highlight")
												.attr("aria-selected", "false"), e = !1, this.p.selarrrow
										.splice(g, 1), h = this.p.selarrrow[0], this.p.selrow = void 0 === h
										? null
										: h), b("#jqg_"
								+ b.jgrid.jqID(this.p.id) + "_"
								+ b.jgrid.jqID(a.id))[this.p.useProp
								? "prop"
								: "attr"]("checked", e), i
								&& (-1 === g ? b("#" + b.jgrid.jqID(d),
										"#" + b.jgrid.jqID(i))
										.addClass("ui-state-highlight") : b(
										"#" + b.jgrid.jqID(d),
										"#" + b.jgrid.jqID(i))
										.removeClass("ui-state-highlight"), b(
										"#jqg_" + b.jgrid.jqID(this.p.id) + "_"
												+ b.jgrid.jqID(d), "#"
												+ b.jgrid.jqID(i))[this.p.useProp
										? "prop"
										: "attr"]("checked", e)), f)
							b(this).triggerHandler("jqGridSelectRow",
									[a.id, e, c]), this.p.onSelectRow
									&& this.p.onSelectRow
											.call(this, a.id, e, c)
					} else if ("ui-subgrid" !== a.className
							&& (this.p.selrow !== a.id
									? (b(this.rows.namedItem(this.p.selrow))
											.removeClass("ui-state-highlight")
											.attr({
														"aria-selected" : "false",
														tabindex : "-1"
											...
											&& (b(
													...
													"#" + b.jgrid.jqID(d),
													"#" + b.jgrid.jqID(i))
													.addClass("ui-state-highlight")), e = !0)
									: e = !1, this.p.selrow = a.id, f))
						b(this).triggerHandler("jqGridSelectRow", [a.id, e, c]), this.p.onSelectRow
								&& this.p.onSelectRow.call(this, a.id, e, c)
			})
		},
		resetSelection : function(d) {
			return this.each(function() {
				...
				if (void 0 !== d) {
					...
					b("#" + b.jgrid.jqID(f.p.id) + " tbody:first tr#"
							+ b.jgrid.jqID(e))
							.removeClass("ui-state-highlight").attr(
									"aria-selected", "false");
					a
							&& b("#" + b.jgrid.jqID(e), "#" + b.jgrid.jqID(a))
									.removeClass("ui-state-highlight");
					if (f.p.multiselect) {
						b(		"#jqg_" + b.jgrid.jqID(f.p.id) + "_"
										+ b.jgrid.jqID(e), "#"
										+ b.jgrid.jqID(f.p.id))[f.p.useProp
								? "prop"
								: "attr"]("checked", !1);
						if (a)
							b(		"#jqg_" + b.jgrid.jqID(f.p.id) + "_"
											+ b.jgrid.jqID(e), "#"
											+ b.jgrid.jqID(a))[f.p.useProp
									? "prop"
									: "attr"]("checked", !1);
						f.setHeadCheckBox(!1)
					}
					...
					f.p.multiselect
							? (b(f.p.selarrrow).each(function(d, e) {
								...
								b(c).removeClass("ui-state-highlight").attr(
										"aria-selected", "false");
								b("#jqg_" + b.jgrid.jqID(f.p.id) + "_"
										+ b.jgrid.jqID(e))[f.p.useProp
										? "prop"
										: "attr"]("checked", !1);
								a
										&& (b("#" + b.jgrid.jqID(e),
							...
							: f.p.selrow
									&& (b("#" + b.jgrid.jqID(f.p.id)
											+ " tbody:first tr#"
											+ b.jgrid.jqID(f.p.selrow))
											.removeClass("ui-state-highlight")
											.attr("aria-selected", "false"), a
											&& b(
													"#"
															+ b.jgrid
																	.jqID(f.p.selrow),
													"#" + b.jgrid.jqID(a))
													.removeClass("ui-state-highlight"), f.p.selrow = null);
				!0 === f.p.cellEdit
						&& 0 <= parseInt(f.p.iCol, 10)
						&& 0 <= parseInt(f.p.iRow, 10)
						&& (b("td:eq(" + f.p.iCol + ")", f.rows[f.p.iRow])
								.removeClass("edit-cell ui-state-highlight"), b(f.rows[f.p.iRow])
		...
		getRowData : function(d) {
			...
			this.each(function() {
				...
				for (; j < a;)
					e && (i = g.rows[j]), b(i).hasClass("jqgrow")
							&& (b('td[role="gridcell"]', i).each(function(a) {
								h = g.p.colModel[a].name;
								if ("cb" !== h && "subgrid" !== h && "rn" !== h)
									if (!0 === g.p.treeGrid
											&& h === g.p.ExpandColumn)
										f[h] = b.jgrid.htmlDecode(b(
		...
		delRowData : function(d) {
			...
			this.each(function() {
				...
				f = !0;
				this.p.multiselect
						&& (e = b.inArray(d, this.p.selarrrow), -1 !== e
								&& this.p.selarrrow.splice(e, 1));
				this.p.selrow = this.p.multiselect
						&& 0 < this.p.selarrrow.length
				...
				if ("local" === this.p.datatype) {
					...
					void 0 !== a
							&& (this.p.data.splice(a, 1), this.refreshIndex())
				}
				if (!0 === this.p.altRows && f) {
					var j = this.p.altclass;
					b(this.rows).each(function(a) {
						a % 2 === 1 ? b(this).addClass(j) : b(this)
								.removeClass(j)
					})
				}
			});
		...
		setRowData : function(d, f, c) {
			...
			this.each(function() {
				...
				if (f)
					try {
						if (b(this.p.colModel).each(function(a) {
							...
							void 0 !== n
									&& (g.p.data[n] = b.extend(!0, g.p.data[n],
											l));
							l = null
						}
					} catch (t) {
				...
				a
						&& ("string" === k ? b(i).addClass(c) : "object" === k
								&& b(i).css(c), b(g)
		...
		addRowData : function(d, f, c, e) {
			...
			f
					&& (b.isArray(f)
						...
						if (!t)
							if (d !== void 0)
								...
								if (this.p.keyIndex !== false) {
									A = this.p.colModel[this.p.keyIndex + h + i
											+ k].name;
						...
						T = this.p.altclass;
						for (var N = 0, X = "", J = {}, S = b
								.isFunction(this.p.afterInsertRow)
								? true
								: false; N < V;) {
							M = f[N];
							g = [];
							...
							if (h) {
								n = '<input role="checkbox" type="checkbox" id="jqg_'
										+ this.p.id
										+ "_"
										+ d
										+ '" class="cbox"/>';
								m = this.formatCol(k, 1, "", null, d, true);
								g[g.length] = '<td role="gridcell" ' + m + ">"
										+ n + "</td>"
							}
							i
									&& (g[g.length] = b(this).jqGrid(
											"addSubGridCell", h + k, 1));
							for (o = h + i + k; o < this.p.colModel.length; o++) {
								$ = this.p.colModel[o];
								j = $.name;
								J[j] = M[j];
								n = this.formatter(d,
										b.jgrid.getAccessor(M, j), o, M);
							...
							if (this.rows.length === 0)
								b("table:first", this.grid.bDiv).append(g
										.join(""));
							else
								switch (c) {
									case "last" :
										b(this.rows[this.rows.length - 1])
												.after(g.join(""));
									...
									case "first" :
										...
										break;
									case "after" :
										(l = this.rows.namedItem(e))
												&& (b(this.rows[l.rowIndex + 1])
														.hasClass("ui-subgrid")
														? b(this.rows[l.rowIndex
																+ 1]).after(g)
														: b(l)
																.after(g
																		.join("")));
							...
							this.p.subGrid === true
									&& b(this).jqGrid("addSubGrid", h + k, l);
							this.p.records++;
							this.p.reccount++;
							b(this).triggerHandler("jqGridAfterInsertRow",
									[d, M, M]);
		...
		footerData : function(d, f, c) {
			...
			this.each(function() {
				...
				b(this.p.colModel).each(function(e) {
					...
					"set" === d
							? void 0 !== f[a]
									&& (k = c ? i.formatter("", f[a], e, f,
											"edit") : f[a], h = this.title ? {
										title : b.jgrid.stripHtml(k)
									} : {}, b("tr.footrow td:eq(" + e + ")",
											i.grid.sDiv).html(k).attr(h), j = !0)
							: "get" === d
									&& (g[a] = b("tr.footrow td:eq(" + e + ")",
											i.grid.sDiv).html())
				})
			});
			return "get" === d ? g : j
		...
		showHideCol : function(d, f) {
			return this.each(function() {
				var c = this, e = !1, a = b.jgrid.cell_width
						? 0
						: c.p.cellLayout, j;
				if (c.grid) {
					"string" === typeof d && (d = [d]);
					f = "none" !== f ? "" : "none";
					var g = "" === f ? !0 : !1, h = c.p.groupHeader
							&& ("object" === typeof c.p.groupHeader || b
									.isFunction(c.p.groupHeader));
					...
					b(this.p.colModel).each(function(h) {
						if (-1 !== b.inArray(this.name, d) && this.hidden === g) {
							...
							c.p.footerrow
									&& b("tr.footrow td:eq(" + h + ")",
											c.grid.sDiv).css("display", f);
							j = parseInt(this.width, 10);
							c.p.tblwidth = "none" === f ? c.p.tblwidth
									- (j + a) : c.p.tblwidth + (j + a);
							this.hidden = !g;
							e = !0;
					...
					!0 === e
							&& (!0 === c.p.shrinkToFit
									&& !isNaN(c.p.height)
									&& (c.p.tblwidth += parseInt(
											c.p.scrollOffset, 10)), b(c)
									.jqGrid(
											"setGridWidth",
											!0 === c.p.shrinkToFit
													? c.p.tblwidth
		...
		setGridWidth : function(d, f) {
			return this.each(function() {
				if (this.grid) {
					var c = this, e, a = 0, j = b.jgrid.cell_width
							? 0
							: c.p.cellLayout, g, h = 0, i = !1, k = c.p.scrollOffset, l, o = 0, n;
					"boolean" !== typeof f && (f = c.p.shrinkToFit);
					if (!isNaN(d)) {
						d = parseInt(d, 10);
						c.grid.width = c.p.width = d;
						b("#gbox_" + b.jgrid.jqID(c.p.id)).css("width",
								d + "px");
						...
						!0 === c.p.toolbar[0]
								&& (b(c.grid.uDiv).css("width", d + "px"), "both" === c.p.toolbar[1]
										&& b(c.grid.ubDiv).css("width",
												d + "px"));
						...
						if (!0 === f) {
							...
							l = d - j * h - o;
							if (!isNaN(c.p.height)
									&& (b(c.grid.bDiv)[0].clientHeight < b(c.grid.bDiv)[0].scrollHeight || 1 === c.rows.length))
								i = !0, l -= k;
							...
							b.each(c.p.colModel, function(b) {
										if (this.hidden === false
											...
											if (!(e < 0)) {
												...
												c.grid.headers[b].el.style.width = e
														+ "px";
												if (c.p.footerrow)
													c.grid.footers[b].style.width = e
															+ "px";
												if (m)
													c.grid.cols[b].style.width = e
															+ "px";
												g = b
											}
										}
							...
							c.p.footerrow
									&& (c.grid.footers[g].style.width = e
											+ "px")
						}
						c.p.tblwidth
								&& (b("table:first", c.grid.bDiv).css("width",
										c.p.tblwidth + "px"), b("table:first",
										c.grid.hDiv).css("width",
										c.p.tblwidth + "px"), c.grid.hDiv.scrollLeft = c.grid.bDiv.scrollLeft, c.p.footerrow
										&& b("table:first", c.grid.sDiv).css(
		...
		setLabel : function(d, f, c, e) {
			return this.each(function() {
						var a = -1;
						if (this.grid && void 0 !== d
								&& (b(this.p.colModel).each(function(b) {
											if (this.name === d)
												return a = b, !1
										}), 0 <= a)) {
							var j = b("tr.ui-jqgrid-labels th:eq(" + a + ")",
									this.grid.hDiv);
							if (f) {
								var g = b(".s-ico", j);
		...
		setCell : function(d, f, c, e, a, j) {
			return this.each(function() {
				var g = -1, h, i;
				if (this.grid
						&& (isNaN(f) ? b(this.p.colModel).each(function(a) {
									if (this.name === f)
										return g = a, !1
								}) : g = parseInt(f, 10), 0 <= g
								&& (h = this.rows.namedItem(d)))) {
					var k = b("td:eq(" + g + ")", h);
					if ("" !== c || !0 === j)
						h = this.formatter(d, c, g, h, "edit"), i = this.p.colModel[g].title
								? {
									title : b.jgrid.stripHtml(h)
								}
								: {}, this.p.treeGrid
								&& 0 < b(".tree-wrap", b(k)).length ? b("span",
								b(k)).html(h).attr(i) : b(k).html(h).attr(i), "local" === this.p.datatype
								&& (h = this.p.colModel[g], c = h.formatter
										&& "string" === typeof h.formatter
										&& "date" === h.formatter
										? b.unformat.date.call(this, c, h)
										: c, i = this.p._index[b.jgrid
										.stripPref(this.p.idPrefix, d)], void 0 !== i
										&& (this.p.data[i][h.name] = c));
		...
		getCell : function(d, f) {
			...
			this.each(function() {
						var e = -1;
						if (this.grid
								&& (isNaN(f) ? b(this.p.colModel).each(
										function(a) {
											if (this.name === f)
												return e = a, !1
										}) : e = parseInt(f, 10), 0 <= e)) {
							...
							if (a)
								try {
									c = b.unformat.call(this, b("td:eq(" + e
															+ ")", a), {
												rowId : a.id,
												colModel : this.p.colModel[e]
											}, e)
								} catch (j) {
									c = b.jgrid.htmlDecode(b(
											"td:eq(" + e + ")", a).html())
								}
						}
					});
		...
		getCol : function(d, f, c) {
			...
			this.each(function() {
				var k = -1;
				if (this.grid
						&& (isNaN(d) ? b(this.p.colModel).each(function(a) {
									if (this.name === d)
										return k = a, !1
								}) : k = parseInt(d, 10), 0 <= k)) {
					...
					if (l && 0 < l) {
						for (; o < l;) {
							if (b(this.rows[o]).hasClass("jqgrow")) {
								try {
									a = b.unformat.call(this,
											b(this.rows[o].cells[k]), {
			...
			return this.each(function() {
						if (this.grid) {
							...
							if (this.p.deepempty)
								...
								var f = b("#" + b.jgrid.jqID(this.p.id)
										+ " tbody:first tr:first")[0];
								b("#" + b.jgrid.jqID(this.p.id)
										+ " tbody:first").empty().append(f)
							}
							this.p.footerrow
									&& d
									&& b(".ui-jqgrid-ftable td", this.grid.sDiv)
											.html("&#160;");
							this.p.selrow = null;
							this.p.selarrrow = [];
							this.p.savedRow = [];
		...
		bindKeys : function(d) {
			...
			return this.each(function() {
				...
				b(c).keydown(function(d) {
					...
					if (a)
						if (h = c.p._index[b.jgrid
								.stripPref(c.p.idPrefix, a.id)], 37 === d.keyCode
								|| 38 === d.keyCode
								|| 39 === d.keyCode
								|| 40 === d.keyCode) {
							if (38 === d.keyCode) {
							...
							37 === d.keyCode
									&& (c.p.treeGrid
											&& c.p.data[h][i]
											&& b(a).find("div.treeclick")
													.trigger("click"), b(c)
											.triggerHandler("jqGridKeyLeft",
													[c.p.selrow]), b
											.isFunction(f.onLeftKey)
											&& f.onLeftKey.call(c, c.p.selrow));
							39 === d.keyCode
									&& (c.p.treeGrid
											&& !c.p.data[h][i]
											&& b(a).find("div.treeclick")
													.trigger("click"), b(c)
											.triggerHandler("jqGridKeyRight",
													[c.p.selrow]), b
											.isFunction(f.onRightKey)
											&& f.onRightKey.call(c, c.p.selrow))
						} else
							13 === d.keyCode
									? (b(c).triggerHandler("jqGridKeyEnter",
											[c.p.selrow]), b
											.isFunction(f.onEnter)
											&& f.onEnter.call(c, c.p.selrow))
									: 32 === d.keyCode
											&& (b(c).triggerHandler(
													"jqGridKeySpace",
													[c.p.selrow]), b
													.isFunction(f.onSpace)
													&& f.onSpace.call(c,
															c.p.selrow))
				})
			})
		...
		getLocalRow : function(d) {
			...
			this.each(function() {
						void 0 !== d
								&& (c = this.p._index[b.jgrid.stripPref(
										this.p.idPrefix, d)], 0 <= c
										&& (f = this.p.data[c]))
					});
			return f
		}
...
(function(a) {
	...
	a.extend(a.fmatter, {
				...
				isObject : function(c) {
					return c && ("object" === typeof c || a.isFunction(c))
							|| !1
				},
				isString : function(a) {
				...
				isEmpty : function(c) {
					...
					if (!this.isValue(c))
						return !0;
					c = a.trim(c).replace(/\&nbsp\;/ig, "").replace(
							/\&#160\;/ig, "");
					return "" === c
				}
			});
		...
		NumberFormat : function(c, b) {
			...
			if (a.fmatter.isNumber(c)) {
				...
				if (a.fmatter.isNumber(b.decimalPlaces)) {
					var h = b.decimalPlaces, e = Math.pow(10, h), e = ""
							+ Math.round(c * e) / e;
					g = e.lastIndexOf(".");
					if (0 < h) {
						0 > g ? (e += f, g = e.length - 1) : "." !== f
								&& (e = e.replace(".", f));
						for (; e.length - 1 - g < h;)
							e += "0"
					}
	...
	a.fn.fmatter.email = function(c, b) {
		return !a.fmatter.isEmpty(c) ? '<a href="mailto:' + c + '">' + c
				+ "</a>" : a.fn.fmatter.defaultFormat(c, b)
	};
	a.fn.fmatter.checkbox = function(c, b) {
		...
		return '<input type="checkbox" '
				+ (0 > c.search(/(false|f|0|no|n|off|undefined)/i)
						? " checked='checked' "
						: "") + ' value="' + c + '" offval="no" ' + e + "/>"
	};
	a.fn.fmatter.link = function(c, b) {
		...
		return !a.fmatter.isEmpty(c) ? "<a " + e + ' href="' + c + '">' + c
				+ "</a>" : a.fn.fmatter.defaultFormat(c, b)
	};
	a.fn.fmatter.showlink = function(c, b) {
		...
		d = d.baseLinkUrl + d.showAction + "?" + d.idName + "=" + b.rowId
				+ d.addParam;
		return a.fmatter.isString(c) || a.fmatter.isNumber(c) ? "<a " + e
				+ ' href="' + d + '">' + c + "</a>" : a.fn.fmatter
				.defaultFormat(c, b)
	};
	a.fn.fmatter.integer = function(c, b) {
		...
		void 0 !== b.colModel && void 0 !== b.colModel.formatoptions
				&& (d = a.extend({}, d, b.colModel.formatoptions));
		return a.fmatter.isEmpty(c) ? d.defaultValue : a.fmatter.util
				.NumberFormat(c, d)
	};
	...
	a.fn.fmatter.date = function(c, b, d, e) {
		...
		void 0 !== b.colModel && void 0 !== b.colModel.formatoptions
				&& (d = a.extend({}, d, b.colModel.formatoptions));
		return !d.reformatAfterEdit && "edit" === e ? a.fn.fmatter
				.defaultFormat(c, b) : !a.fmatter.isEmpty(c) ? a.jgrid
				.parseDate(d.srcformat, c, d.newformat, d) : a.fn.fmatter
				.defaultFormat(c, b)
	};
	a.fn.fmatter.select = function(c, b) {
		...
		void 0 !== b.colModel.formatoptions
				...
				: void 0 !== b.colModel.editoptions
						&& (d = b.colModel.editoptions.value, f = void 0 === b.colModel.editoptions.separator
								? ":"
		...
		if (d) {
			...
			if (a.fmatter.isString(d)) {
				...
				for (l = 0; l < i.length; l++)
					if (g = i[l].split(f), 2 < g.length
							&& (g[1] = a.map(g, function(a, b) {
										if (b > 0)
											return a
									}).join(f)), h)
	...
	a.fn.fmatter.rowactions = function(c) {
		var b = a(this).closest("tr.jqgrow"), d = b.attr("id"), e = a(this)
				.closest("table.ui-jqgrid-btable").attr("id").replace(
						/_frozen([^_]*)$/, "$1"), e = a("#" + e), f = e[0], g = f.p, h = g.colModel[a.jgrid
				.getCellIndex(this)], j = h.frozen ? a("tr#" + d + " td:eq("
						+ a.jgrid.getCellIndex(this) + ") > div", e) : a(this)
				.parent(), i = {
			keys : !1,
			onEdit : null,
			onSuccess : null,
		...
		b.hasClass("jqgrid-new-row")
				&& (i.extraparam[g.prmNames.oper] = g.prmNames.addoper);
		b = {
			keys : i.keys,
			oneditfunc : i.onEdit,
		...
		switch (c) {
			...
			case "del" :
				...
				break;
			case "formedit" :
				e.jqGrid("setSelection", d), e.jqGrid("editGridRow", d,
						i.editOptions)
		}
	};
	a.fn.fmatter.actions = function(c, b) {
		...
		d.editformbutton
				? f += "<div title='"
						+ a.jgrid.nav.edittitle
						+ "' style='float:left;cursor:pointer;' class='ui-pg-div ui-inline-edit' "
						+ ("id='jEditButton_" + e + "' onclick=jQuery.fn.fmatter.rowactions.call(this,'formedit'); onmouseover=jQuery(this).addClass('ui-state-hover'); onmouseout=jQuery(this).removeClass('ui-state-hover'); ")
						+ "><span class='ui-icon ui-icon-pencil'></span></div>"
				: d.editbutton
						&& (f += "<div title='"
								+ a.jgrid.nav.edittitle
								+ "' style='float:left;cursor:pointer;' class='ui-pg-div ui-inline-edit' "
								+ ("id='jEditButton_" + e + "' onclick=jQuery.fn.fmatter.rowactions.call(this,'edit'); onmouseover=jQuery(this).addClass('ui-state-hover'); onmouseout=jQuery(this).removeClass('ui-state-hover') ")
								+ "><span class='ui-icon ui-icon-pencil'></span></div>");
		d.delbutton
				&& (f += "<div title='"
						+ a.jgrid.nav.deltitle
						+ "' style='float:left;margin-left:5px;' class='ui-pg-div ui-inline-del' "
						+ ("id='jDeleteButton_" + e + "' onclick=jQuery.fn.fmatter.rowactions.call(this,'del'); onmouseover=jQuery(this).addClass('ui-state-hover'); onmouseout=jQuery(this).removeClass('ui-state-hover'); ")
						+ "><span class='ui-icon ui-icon-trash'></span></div>");
		f += "<div title='"
				+ a.jgrid.edit.bSubmit
				+ "' style='float:left;display:none' class='ui-pg-div ui-inline-save' "
				+ ("id='jSaveButton_" + e + "' onclick=jQuery.fn.fmatter.rowactions.call(this,'save'); onmouseover=jQuery(this).addClass('ui-state-hover'); onmouseout=jQuery(this).removeClass('ui-state-hover'); ")
				+ "><span class='ui-icon ui-icon-disk'></span></div>";
		f += "<div title='"
				+ a.jgrid.edit.bCancel
				+ "' style='float:left;display:none;margin-left:5px;' class='ui-pg-div ui-inline-cancel' "
				+ ("id='jCancelButton_" + e + "' onclick=jQuery.fn.fmatter.rowactions.call(this,'cancel'); onmouseover=jQuery(this).addClass('ui-state-hover'); onmouseout=jQuery(this).removeClass('ui-state-hover'); ")
				+ "><span class='ui-icon ui-icon-cancel'></span></div>";
		return "<div style='margin-left:8px;'>" + f + "</div>"
	};
	a.unformat = function(c, b, d, e) {
		var f, g = b.colModel.formatter, h = b.colModel.formatoptions || {}, j = /([\.\*\_\'\(\)\{\}\+\?\\])/g, i = b.colModel.unformat
				|| a.fn.fmatter[g] && a.fn.fmatter[g].unformat;
		if (void 0 !== i && a.isFunction(i))
			...
			switch (f = a.jgrid.formatter || {}, g) {
				...
				case "number" :
					...
					b = h.thousandsSeparator.replace(j, "\\$1");
					f = a(c).text().replace(RegExp(b, "g"), "").replace(
							h.decimalSeparator, ".");
					break;
				case "currency" :
					...
					b = RegExp(b, "g");
					f = a(c).text();
					h.prefix && h.prefix.length
							&& (f = f.substr(h.prefix.length));
					h.suffix && h.suffix.length
							&& (f = f.substr(0, f.length - h.suffix.length));
					f = f.replace(b, "").replace(h.decimalSeparator, ".");
					break;
				case "checkbox" :
					h = b.colModel.editoptions ? b.colModel.editoptions.value
							.split(":") : ["Yes", "No"];
		...
		return void 0 !== f ? f : !0 === e ? a(c).text() : a.jgrid
				.htmlDecode(a(c).html())
	};
		...
		if (e.value) {
			...
			if (a.fmatter.isString(g)) {
				...
				for (k = 0; k < j.length; k++)
					if (f = j[k].split(b), 2 < f.length
							&& (f[1] = a.map(f, function(a, b) {
										if (b > 0)
											return a
									}).join(b)), e)
	...
	a.unformat.date = function(c, b) {
		...
		return !a.fmatter.isEmpty(c) ? a.jgrid.parseDate(d.newformat, c,
				d.srcformat, d) : a.fn.fmatter.defaultFormat(c, b)
	}
})(jQuery);
(function(a) {
	a.jgrid.extend({
			...
			return this.each(function() {
				...
				if (this.grid) {
					...
					for (j = 0; j < this.p.colModel.length; j++)
						if (this.p.colModel[j].index === a
								|| this.p.colModel[j].name === a) {
							g = j;
							break
						}
					-1 !== g
							&& (j = this.p.colModel[g].sortable, "boolean" !== typeof j
									&& (j = !0), "boolean" !== typeof c
									&& (c = !1), j
									&& this.sortData("jqgh_" + this.p.id + "_"
													+ a, g, c, f))
				}
			})
		},
		...
		GridDestroy : function() {
			return this.each(function() {
						if (this.grid) {
							...
							try {
								a(this).jqGrid("clearBeforeUnload"), a("#gbox_"
										+ a.jgrid.jqID(this.id)).remove()
							} catch (b) {
							}
						}
					})
		...
		GridUnload : function() {
			return this.each(function() {
				if (this.grid) {
					...
					1 === a(this.p.pager).parents("#gbox_" + b).length ? (a(f)
							.insertBefore("#gbox_" + b).show(), a(this.p.pager)
							.insertBefore("#gbox_" + b)) : a(f)
							.insertBefore("#gbox_" + b).show();
				...
				this.grid
						&& ("hidden" === b
								? (a(".ui-jqgrid-bdiv, .ui-jqgrid-hdiv",
										"#gview_" + a.jgrid.jqID(this.p.id))
										.slideUp("fast"), this.p.pager
										&& a(this.p.pager).slideUp("fast"), this.p.toppager
										&& a(this.p.toppager).slideUp("fast"), !0 === this.p.toolbar[0]
										&& ("both" === this.p.toolbar[1]
												&& a(this.grid.ubDiv)
														.slideUp("fast"), a(this.grid.uDiv)
												.slideUp("fast")), this.p.footerrow
										&& a(
												".ui-jqgrid-sdiv",
												"#gbox_"
														+ a.jgrid
										...
										this.grid.cDiv)
										.removeClass("ui-icon-circle-triangle-n")
										.addClass("ui-icon-circle-triangle-s"), this.p.gridstate = "hidden")
								: "visible" === b
										&& (a(
												...
												"#gview_"
														+ a.jgrid
																.jqID(this.p.id))
												.slideDown("fast"), this.p.pager
												&& a(this.p.pager)
														.slideDown("fast"), this.p.toppager
												&& a(this.p.toppager)
														.slideDown("fast"), !0 === this.p.toolbar[0]
												&& ("both" === this.p.toolbar[1]
														&& a(this.grid.ubDiv)
																.slideDown("fast"), a(this.grid.uDiv)
														.slideDown("fast")), this.p.footerrow
												&& a(
														".ui-jqgrid-sdiv",
														"#gbox_"
																+ a.jgrid
												...
												this.grid.cDiv)
												.removeClass("ui-icon-circle-triangle-s")
												.addClass("ui-icon-circle-triangle-n"), this.p.gridstate = "visible"))
			})
		},
				...
				if (!this.ftoolbar) {
					var f = function() {
						...
						a.each(c.p.colModel, function() {
							var i = a("#gs_" + a.jgrid.jqID(this.name),
									!0 === this.frozen
											&& !0 === c.p.frozenColumns
											? c.grid.fhDiv
											: c.grid.hDiv);
							l = this.index || this.name;
							n = b.searchOperators ? i.parent().prev()
									.children("a").attr("soper")
									|| b.defaultSearch : this.searchoptions
									&& this.searchoptions.sopt
									? this.searchoptions.sopt[0]
									: "select" === this.stype
											? "eq"
											: b.defaultSearch;
							if ((f = "custom" === this.stype
									&& a
											.isFunction(this.searchoptions.custom_value)
									&& 0 < i.length
									&& "SPAN" === i[0].nodeName.toUpperCase()
									? this.searchoptions.custom_value.call(c,
											i.children(".customelement:first"),
											"get")
									: i.val())
									|| "nu" === n || "nn" === n)
								e[l] = f, j[l] = n, d++;
						...
						var g;
						c.p.searchurl
								&& (g = c.p.url, a(c).jqGrid("setGridParam", {
											url : c.p.searchurl
										}));
						var o = "stop" === a(c)
						...
						a("#sopt_menu").remove();
						var d = parseInt(d, 10), j = parseInt(j, 10) + 18, d = '<ul id="sopt_menu" class="ui-search-menu" role="menu" tabindex="0" style="font-size:'
								+ (a(".ui-jqgrid-view").css("font-size") || "11px")
								+ ";left:" + d + "px;top:" + j + 'px;">', j = a(e)
								.attr("soper"), l, h = [], n, i = 0, k = a(e)
								.attr("colname");
						for (l = c.p.colModel.length; i < l
								&& c.p.colModel[i].name !== k;)
							i++;
						i = c.p.colModel[i];
						k = a.extend({}, i.searchoptions);
						k.sopt
								|| (k.sopt = [], k.sopt[0] = "select" === i.stype
										? "eq"
										: b.defaultSearch);
						...
						a("#sopt_menu > li > a").hover(function() {
							...
							var d = a(this).attr("value"), i = a(this)
									.attr("oper");
							a(c).triggerHandler("jqGridToolbarSelectOper",
									[d, i, e]);
							a("#sopt_menu").hide();
					...
					a.each(c.p.colModel, function() {
						var e = this, d, g;
						g = "";
						var l = "=", s, n = a("<th role='columnheader' class='ui-state-default ui-th-column ui-th-"
								+ c.p.direction + "'></th>"), i = a("<div style='position:relative;height:100%;padding-right:0.3em;padding-left:0.3em;'></div>"), k = a("<table class='ui-search-table' cellspacing='0'><tr><td class='ui-search-oper'></td><td class='ui-search-input'></td></tr></table>");
						...
						if (this.search) {
							if (b.searchOperators) {
								g = d.sopt ? d.sopt[0] : "select" === e.stype
										? "eq"
										: b.defaultSearch;
							...
							switch (this.stype) {
										...
										if (m) {
											...
											if ("string" === typeof m) {
												...
												for (q = 0; q < g.length; q++)
													m = g[q].split(r), o = document
															.createElement("option"), o.value = m[0], o.innerHTML = m[1], l
															.appendChild(o)
											} else if ("object" === typeof m)
												for (q in m)
													m.hasOwnProperty(q)
															&& (o = document
																	.createElement("option"), o.value = q, o.innerHTML = m[q], l
																	.appendChild(o));
											void 0 !== d.defaultValue
													&& a(l).val(d.defaultValue);
								...
								case "text" :
									r = void 0 !== d.defaultValue
											...
											: "";
									a("td:eq(1)", k)
											.append("<input type='text' style='width:100%;padding:0px;' name='"
													+ (e.index || e.name)
													+ "' id='gs_"
													+ e.name
													+ "' value='" + r + "'/>");
								...
								case "custom" :
									a("td:eq(1)", k)
											.append("<span style='width:95%;padding:0px;' name='"
													+ (e.index || e.name)
													+ "' id='gs_"
													+ e.name
													+ "'/>");
									...
									try {
										if (a.isFunction(d.custom_element)) {
											var u = d.custom_element.call(c,
													void 0 !== d.defaultValue
															? d.defaultValue
															: "", d);
											if (u)
												u = a(u)
														.addClass("customelement"), a(i)
														.find(">span")
														.append(u);
											else
												throw "e2";
					...
					this.clearToolbar = function(e) {
						var d = {}, f = 0, g, e = typeof e !== "boolean"
								? true
								: e;
						a.each(c.p.colModel, function() {
							var b, e = a("#gs_" + a.jgrid.jqID(this.name),
									this.frozen === true
											&& c.p.frozenColumns === true
											? c.grid.fhDiv
											: c.grid.hDiv);
							if (this.searchoptions
									&& this.searchoptions.defaultValue !== void 0)
						...
						var m = a(c).triggerHandler("jqGridToolbarBeforeClear") === "stop"
								? true
								: false;
						!m && a.isFunction(b.beforeClear)
								&& (m = b.beforeClear.call(c));
					...
					this.toggleToolbar = function() {
						var b = a("tr.ui-search-toolbar", c.grid.hDiv), d = c.p.frozenColumns === true
		...
		destroyFilterToolbar : function() {
			return this.each(function() {
				this.ftoolbar
						&& (this.toggleToolbar = this.clearToolbar = this.triggerToolbar = null, this.ftoolbar = !1, a(this.grid.hDiv)
		...
		setGroupHeaders : function(b) {
			...
			return this.each(function() {
				...
				var c, f, g = 0, j, h, e, d, p, l = this.p.colModel, s = l.length, n = this.grid.headers, i = a(
						"table.ui-jqgrid-htable", this.grid.hDiv), k = i
				...
				for (c = 0; c < s; c++)
					if (e = n[c].el, d = a(e), f = l[c], h = {
						...
						display : f.hidden ? "none" : ""
								...
								role : "gridcell"
							}).css(h).addClass("ui-first-th-"
							+ this.p.direction).appendTo(m), e.style.width = "", h = o(
							f.name, b.groupHeaders), 0 <= h) {
						h = b.groupHeaders[h];
						g = h.numberOfColumns;
						p = h.titleText;
				...
				i.append(l);
				b.useColSpanStyle
						&& (i.find("span.ui-jqgrid-resize").each(function() {
							var b = a(this).parent();
							b.is(":visible")
		...
		setFrozenColumns : function() {
			return this.each(function() {
				if (this.grid) {
					...
					if (!(!0 === b.p.subGrid || !0 === b.p.treeGrid
							|| !0 === b.p.cellEdit || b.p.sortable
						...
						if (0 <= j && h) {
							...
							f = a(".ui-jqgrid-htable",
									"#gview_" + a.jgrid.jqID(b.p.id)).height();
							b.p.toppager
									&& (c += a(b.grid.topDiv).outerHeight());
							!0 === b.p.toolbar[0]
									&& "bottom" !== b.p.toolbar[1]
									&& (c += a(b.grid.uDiv).outerHeight());
							...
							if (b.p.groupHeader) {
								...
								var e = -1, d = -1, p, l;
								a("tr.jqg-second-row-header th", c).each(
										function() {
											p = parseInt(a(this)
															.attr("colspan"),
													10);
											if (l = parseInt(a(this)
															.attr("rowspan"),
													10))
												e++, d++;
											p && (e += p, d++);
								...
								e !== j && (d = j);
								a("tr.jqg-second-row-header", c).each(
										function() {
											a("th:gt(" + d + ")", this)
													.remove()
										})
							...
							a(b).bind("jqGridResizeStop.setFrozenColumns",
									function(c, d, e) {
										...
										a("tr:first td:eq(" + e + ")", c)
												.width(d)
									});
							a(b).bind("jqGridOnSortCol.setFrozenColumns",
									function(c, d, e) {
										c = a(	"tr.ui-jqgrid-labels:last th:eq("
														+ b.p.lastsort + ")",
												b.grid.fhDiv);
										d = a(	"tr.ui-jqgrid-labels:last th:eq("
														+ e + ")", b.grid.fhDiv);
										a("span.ui-grid-ico-sort", c)
												.addClass("ui-state-disabled");
										a(c).attr("aria-selected", "false");
										a("span.ui-icon-" + b.p.sortorder, d)
												.removeClass("ui-state-disabled");
										a(d).attr("aria-selected", "true");
										!b.p.viewsortcols[0]
												&& b.p.lastsort !== e
												&& (a("span.s-ico", c).hide(), a(
														"span.s-ico", d).show())
									});
							a("#gview_" + a.jgrid.jqID(b.p.id))
									.append(b.grid.fbDiv);
							a(b.grid.bDiv).scroll(function() {
										a(b.grid.fbDiv).scrollTop(a(this)
												.scrollTop())
									});
							!0 === b.p.hoverrows
									&& a("#" + a.jgrid.jqID(b.p.id))
											.unbind("mouseover")
											.unbind("mouseout");
							a(b).bind(
									...
									function() {
										a("#" + a.jgrid.jqID(b.p.id)
												+ "_frozen").remove();
										a(b.grid.fbDiv).height(a(b.grid.bDiv)
												.height()
												- 16);
			...
			return this.each(function() {
						if (this.grid && !0 === this.p.frozenColumns) {
							...
							if (!0 === this.p.hoverrows) {
								var b;
								a("#" + a.jgrid.jqID(this.p.id)).bind(
										"mouseover", function(c) {
											b = a(c.target)
													.closest("tr.jqgrow");
											"ui-subgrid" !== a(b).attr("class")
													&& a(b)
															.addClass("ui-state-hover")
...
(function(a) {
	a.extend(a.jgrid, {
		...
		hideModal : function(d, b) {
			...
			if (b.onClose) {
				var c = b.gb && "string" === typeof b.gb
						&& "#gbox_" === b.gb.substr(0, 6) ? b.onClose.call(
						a("#" + b.gb.substr(6))[0], d) : b.onClose(d);
		...
		createModal : function(d, b, c, g, e, h, f) {
			var c = a.extend(!0, {}, a.jgrid.jqModal || {}, c), i = document
					.createElement("div"), j, n = this, f = a.extend({}, f
							|| {});
			...
			k.id = d.modalhead;
			a(k).append("<span class='ui-jqdialog-title'>" + c.caption
					+ "</span>");
			var l = a("<a href='javascript:void(0)' class='ui-jqdialog-titlebar-close ui-corner-all'></a>")
					.hover(function() {
			...
			a(k).append(l);
			j ? (i.dir = "rtl", a(".ui-jqdialog-title", k)
					.css("float", "right"), a(".ui-jqdialog-titlebar-close", k)
					.css("left", "0.3em")) : (i.dir = "ltr", a(
					".ui-jqdialog-title", k).css("float", "left"), a(
					".ui-jqdialog-titlebar-close", k).css("right", "0.3em"));
			...
			i.appendChild(m);
			a(i).prepend(k);
			!0 === h ? a("body").append(i) : "string" === typeof h ? a(h)
					.append(i) : a(i).insertBefore(g);
			a(i).css(f);
			...
			if (a.fn.jqm && !0 === c.jqModal)
				0 === c.left
						&& 0 === c.top
						&& c.overlay
						&& (f = [], f = a.jgrid.findPos(e), c.left = f[0] + 4, c.top = f[1]
								+ 4), b.top = c.top + "px", b.left = c.left;
			else if (0 !== c.left || 0 !== c.top)
				b.left = c.left, b.top = c.top + "px";
			a("a.ui-jqdialog-titlebar-close", k).click(function() {
				var b = a("#" + a.jgrid.jqID(d.themodal)).data("onClose")
						|| c.onClose, e = a("#" + a.jgrid.jqID(d.themodal))
						.data("gbox")
						|| c.gbox;
			...
			if (0 === c.height || !c.height)
				c.height = 200;
			c.zIndex
					|| (g = a(g).parents("*[role=dialog]").filter(":first")
							.css("z-index"), c.zIndex = g
							? parseInt(g, 10) + 2
							: 950);
			g = 0;
			j
					...
					&& !h
					&& (g = a(c.gbox).width()
							- (!isNaN(c.width) ? parseInt(c.width, 10) : 0) - 8, b.left = parseInt(
							b.left, 10)
							+ parseInt(g, 10));
			b.left && (b.left += "px");
			a(i).css(a.extend({
			...
			if (c.resize)
				if (a.fn.jqResize)
					a(i)
							.append("<div class='jqResize ui-resizable-handle ui-resizable-se ui-icon ui-icon-gripsmall-diagonal-se'></div>"), a("#"
							+ a.jgrid.jqID(d.themodal)).jqResize(".jqResize",
							d.scrollelm ? "#" + a.jgrid.jqID(d.scrollelm) : !1);
				else
					try {
						a(i).resizable({
							handles : "se, sw",
							alsoResize : d.scrollelm ? "#"
									+ a.jgrid.jqID(d.scrollelm) : !1
						})
					} catch (p) {
					}
		...
		viewModal : function(d, b) {
			...
			if (a.fn.jqm && !0 === b.jqm)
				...
				"" !== b.gbox
						&& (a(".jqgrid-overlay:first", b.gbox).show(), a(d)
								.data("gbox", b.gbox));
		...
		info_dialog : function(d, b, c, g) {
			...
			if (0 < e.buttons.length)
				for (g = 0; g < e.buttons.length; g++)
					void 0 === e.buttons[g].id
							&& (e.buttons[g].id = "info_button_" + g), d += "<a href='javascript:void(0)' id='"
							+ e.buttons[g].id
			...
			d && a.each(e.buttons, function(d) {
						a("#" + a.jgrid.jqID(this.id), "#info_id").bind(
								"click", function() {
									e.buttons[d].onClick
											.call(a("#info_dialog"));
									return !1
		...
		bindEv : function(d, b) {
			...
			b.dataEvents && a.each(b.dataEvents, function() {
						void 0 !== this.data ? a(d).bind(this.type, this.data,
								this.fn) : a(d).bind(this.type, this.fn)
					})
		},
		createEl : function(d, b, c, g, e) {
			...
			switch (d) {
				...
				case "checkbox" :
					...
					f.type = "checkbox";
					b.value
							? (d = b.value.split(":"), c === d[0]
									&& (f.checked = !0, f.defaultChecked = !0), f.value = d[0], a(f)
									.attr("offval", d[1]))
							: (d = c.toLowerCase(), 0 > d
									.search(/(false|f|0|no|n|off|undefined)/i)
									&& "" !== d
				...
				case "select" :
					...
					g = [];
					!0 === b.multiple ? (d = !0, f.multiple = "multiple", a(f)
							.attr("aria-multiselectable", "true")) : d = !1;
					if (void 0 !== b.dataUrl)
						d = b.name
								? ("" + b.id).substring(0, ("" + b.id).length
												- ("" + b.name).length - 1)
								: "" + b.id, g = b.postData || e.postData, i.p
								&& i.p.idPrefix ? d = a.jgrid.stripPref(
								i.p.idPrefix, d) : g = void 0, a.ajax(a.extend(
								{
									url : b.dataUrl,
									type : "GET",
									dataType : "html",
									data : a.isFunction(g) ? g.call(i, d, c, ""
													+ b.name) : g,
									context : {
										elem : f,
										options : b,
									...
									success : function(d) {
										var b = [], c = this.elem, e = this.vl, f = a
												.extend({}, this.options), g = f.multiple === true, d = a
												.isFunction(f.buildSelect)
												? f.buildSelect.call(i, d)
												: d;
										typeof d === "string"
												&& (d = a(a.trim(d)).html());
										if (d) {
						...
						var n, k, l = void 0 === b.separator
								? ":"
								: b.separator, e = void 0 === b.delimiter
								? ";"
								: b.delimiter;
						if ("string" === typeof b.value) {
							...
							for (j = 0; j < n.length; j++) {
								...
								f.appendChild(e);
								if (!d
										&& (a.trim(k[0]) === a.trim(c) || a
												.trim(k[1]) === a.trim(c)))
									e.selected = "selected";
								if (d
										&& (-1 < a.inArray(a.trim(k[1]), g) || -1 < a
												.inArray(a.trim(k[0]), g)))
									e.selected = "selected"
							}
					...
					try {
						...
						"e1" === m
								&& a.jgrid.info_dialog(a.jgrid.errors.errcap,
										"function 'custom_element' "
												+ a.jgrid.edit.msg.nodefined,
										a.jgrid.edit.bClose), "e2" === m
								? a.jgrid.info_dialog(a.jgrid.errors.errcap,
										"function 'custom_element' "
												+ a.jgrid.edit.msg.novalue,
										a.jgrid.edit.bClose)
								: a.jgrid.info_dialog(a.jgrid.errors.errcap,
										"string" === typeof m ? m : m.message,
										a.jgrid.edit.bClose)
					}
			}
			return f
		...
		checkDate : function(a, b) {
			...
			for (i = 0; i < a.length; i++)
				e = isNaN(b[i]) ? 0 : parseInt(b[i], 10), c[a[i]] = e, e = a[i], -1 !== e
						.indexOf("y")
						&& (g = i), -1 !== e.indexOf("m") && (f = i), -1 !== e
						.indexOf("d")
						&& (h = i);
			...
			return 1 > j.length
					...
					|| 2 === c[a[f]]
					&& c[a[h]] > (0 === c[a[g]] % 4
							&& (0 !== c[a[g]] % 100 || 0 === c[a[g]] % 400)
							? 29
							: 28) || c[a[h]] > i[c[a[f]]] ? !1 : !0
		},
		isEmpty : function(a) {
		...
		checkValues : function(d, b, c, g) {
				...
				if ("string" === typeof b) {
					...
					for (g = f.length; c < g; c++)
						if (f[c].name === b) {
							e = f[c].editrules;
							b = c;
							null != f[c].formoptions
									&& (h = f[c].formoptions.label);
							break
						}
				} else
					0 <= b && (e = f[b].editrules);
			...
			if (e) {
				...
				if (void 0 !== e.minValue && !isNaN(e.minValue)
						&& parseFloat(d) < parseFloat(e.minValue))
					return [
							!1,
							h + ": " + a.jgrid.edit.msg.minValue + " "
									+ e.minValue, ""];
				if (void 0 !== e.maxValue && !isNaN(e.maxValue)
						&& parseFloat(d) > parseFloat(e.maxValue))
					return [
							!1,
							h + ": " + a.jgrid.edit.msg.maxValue + " "
									+ e.maxValue, ""];
				if (!0 === e.email
						&& !(!1 === c && a.jgrid.isEmpty(d))
						&& (g = /^((([a-z]|\d|[!#\$%&'\*\+\-\/=\?\^_`{\|}~]|[\u00A0-\uD7FF\uF900-\uFDCF\uFDF0-\uFFEF])+(\.([a-z]|\d|[!#\$%&'\*\+\-\/=\?\^_`{\|}~]|[\u00A0-\uD7FF\uF900-\uFDCF\uFDF0-\uFFEF])+)*)|((\x22)((((\x20|\x09)*(\x0d\x0a))?(\x20|\x09)+)?(([\x01-\x08\x0b\x0c\x0e-\x1f\x7f]|\x21|[\x23-\x5b]|[\x5d-\x7e]|[\u00A0-\uD7FF\uF900-\uFDCF\uFDF0-\uFFEF])|(\\([\x01-\x09\x0b\x0c\x0d-\x7f]|[\u00A0-\uD7FF\uF900-\uFDCF\uFDF0-\uFFEF]))))*(((\x20|\x09)*(\x0d\x0a))?(\x20|\x09)+)?(\x22)))@((([a-z]|\d|[\u00A0-\uD7FF\uF900-\uFDCF\uFDF0-\uFFEF])|(([a-z]|\d|[\u00A0-\uD7FF\uF900-\uFDCF\uFDF0-\uFFEF])([a-z]|\d|-|\.|_|~|[\u00A0-\uD7FF\uF900-\uFDCF\uFDF0-\uFFEF])*([a-z]|\d|[\u00A0-\uD7FF\uF900-\uFDCF\uFDF0-\uFFEF])))\.)+(([a-z]|[\u00A0-\uD7FF\uF900-\uFDCF\uFDF0-\uFFEF])|(([a-z]|[\u00A0-\uD7FF\uF900-\uFDCF\uFDF0-\uFFEF])([a-z]|\d|-|\.|_|~|[\u00A0-\uD7FF\uF900-\uFDCF\uFDF0-\uFFEF])*([a-z]|[\u00A0-\uD7FF\uF900-\uFDCF\uFDF0-\uFFEF])))\.?$/i, !g
								.test(d)))
					return [!1, h + ": " + a.jgrid.edit.msg.email, ""];
				if (!0 === e.integer && !(!1 === c && a.jgrid.isEmpty(d))
						&& (isNaN(d) || 0 !== d % 1 || -1 !== d.indexOf(".")))
					return [!1, h + ": " + a.jgrid.edit.msg.integer, ""];
				if (!0 === e.date
						&& !(!1 === c && a.jgrid.isEmpty(d))
						&& (f[b].formatoptions && f[b].formatoptions.newformat
								? (f = f[b].formatoptions.newformat, a.jgrid.formatter.date.masks
										.hasOwnProperty(f)
										&& (f = a.jgrid.formatter.date.masks[f]))
								: f = f[b].datefmt || "Y-m-d", !a.jgrid
								.checkDate(f, d)))
					return [!1, h + ": " + a.jgrid.edit.msg.date + " - " + f,
							""];
				if (!0 === e.time && !(!1 === c && a.jgrid.isEmpty(d))
						&& !a.jgrid.checkTime(d))
					return [
							!1,
				...
				if (!0 === e.url
						&& !(!1 === c && a.jgrid.isEmpty(d))
						&& (g = /^(((https?)|(ftp)):\/\/([\-\w]+\.)+\w{2,3}(\/[%\-\w]+(\.\w{2,})?)*(([\w\-\.\?\\\/+@&#;`~=%!]*)(\.\w{2,})?)*\/?)/i, !g
								.test(d)))
					return [!1, h + ": " + a.jgrid.edit.msg.url, ""];
				if (!0 === e.custom && !(!1 === c && a.jgrid.isEmpty(d)))
					return a.isFunction(e.custom_func) ? (d = e.custom_func
							.call(this, d, h, b), a.isArray(d) ? d : [!1,
							a.jgrid.edit.msg.customarray, ""]) : [!1,
...
(function(a) {
	...
	a.jgrid.extend({
		searchGrid : function(b) {
			...
			return this.each(function() {
				function c(c) {
					...
					void 0 === t && (t = !0);
					t && a.isFunction(b.beforeShowSearch)
							&& (t = b.beforeShowSearch.call(e, c));
					t
							&& (a.jgrid.viewModal("#"
				...
				if (e.grid) {
					...
					!0 === b.recreateFilter
							&& a("#" + a.jgrid.jqID(u.themodal)).remove();
					if (void 0 !== a("#" + a.jgrid.jqID(u.themodal))[0])
						...
						var m = a("<div><div id='"
								...
								.insertBefore("#gview_" + a.jgrid.jqID(e.p.id)), h = "left", g = "";
						"rtl" === e.p.direction
								&& (h = "right", g = " style='text-align:left'", m
										.attr("dir", "rtl"));
						var n = a.extend([], e.p.colModel), x = "<a href='javascript:void(0)' id='"
								+ i
								...
								+ b.Find + "</a>", d = "<a href='javascript:void(0)' id='"
								+ i
								...
								+ b.Reset + "</a>", q = "", f = "", o, k = !1, p = -1;
						b.showQuery
								&& (q = "<a href='javascript:void(0)' id='"
										+ i
								...
								: a.each(n, function(a, b) {
									...
									if (!k) {
										var c = b.search === void 0
												? true
												: b.search, d = b.hidden === true;
										if (b.searchoptions
												&& b.searchoptions.searchhidden === true
												&& c || c && !d) {
											k = true;
											o = b.index || b.name;
											p = a
						...
						if (!s && o || !1 === b.multipleSearch) {
							var y = "eq";
							0 <= p && n[p].searchoptions
									&& n[p].searchoptions.sopt
						...
						b.tmplNames
								&& b.tmplNames.length
								&& (k = !0, f = b.tmplLabel, f += "<select class='ui-template'>", f += "<option value='default'>Default</option>", a
										.each(b.tmplNames, function(a, b) {
											f = f
													+ ("<option value='" + a
															+ "'>" + b + "</option>")
										}), f += "</select>");
						h = "<table class='EditTable' style='border:0px none;margin-top:5px' id='"
								+ i
						...
						a.isFunction(b.onInitializeSearch)
								&& b.onInitializeSearch.call(e, a("#" + i));
						b.gbox = "#gbox_" + i;
						b.layer ? a.jgrid.createModal(u, m, b, "#gview_"
										+ a.jgrid.jqID(e.p.id), a("#gbox_"
										+ a.jgrid.jqID(e.p.id))[0], "#"
										+ a.jgrid.jqID(b.layer), {
									position : "relative"
								}) : a.jgrid.createModal(u, m, b, "#gview_"
										+ a.jgrid.jqID(e.p.id), a("#gbox_"
										+ a.jgrid.jqID(e.p.id))[0]);
						(b.searchOnEnter || b.closeOnEscape)
								&& a("#" + a.jgrid.jqID(u.themodal)).keydown(
										function(c) {
											var d = a(c.target);
											if (b.searchOnEnter
													&& c.which === 13
						...
						c(a("#" + i));
						a(".fm-button:not(.ui-state-disabled)", m).hover(
								function() {
									a(this).addClass("ui-state-hover")
								}, function() {
									a(this).removeClass("ui-state-hover")
			...
			return this.each(function() {
						...
						if (c.length) {
							...
							a.each(d.p.colModel, function() {
								if (this.name === b
									...
									try {
										if (j[b] = this.editoptions.custom_value
												.call(
														d,
														a(
																"#"
							...
							switch (a(this).get(0).type) {
								...
								case "select-multiple" :
									j[this.name] = a(this).val();
									j[this.name] = j[this.name] ? j[this.name]
											.join(",") : "";
							...
							d.p.autoencode
									&& (j[this.name] = a.jgrid
											.htmlEncode(j[this.name]))
						}
					});
					return !0
				}
				function i(c, e, l, g) {
					var h, j, k, p = 0, i, m, o, n = [], q = !1, z = "", r;
					for (r = 1; r <= g; r++)
					...
					a(e.p.colModel).each(function(r) {
						h = this.name;
						m = (j = this.editrules
								&& !0 === this.editrules.edithidden
								? !1
								: !0 === this.hidden ? !0 : !1)
								? "style='display:none'"
								: "";
						if ("cb" !== h && "subgrid" !== h
								&& !0 === this.editable && "rn" !== h) {
							if (!1 === q)
								i = "";
							else if (h === e.p.ExpandColumn
									&& !0 === e.p.treeGrid)
								i = a("td[role='gridcell']:eq(" + r + ")",
										e.rows[q]).text();
							else {
								try {
									i = a.unformat.call(e,
							...
							var v = a.extend({}, this.editoptions || {}, {
									...
									s.rowpos, 10)
									|| p + 1, u = parseInt(2
											* (parseInt(s.colpos, 10) || 1), 10);
							"_empty" === c
									&& v.defaultValue
									&& (i = a.isFunction(v.defaultValue)
											? v.defaultValue.call(d)
											: v.defaultValue);
							this.edittype || (this.edittype = "text");
							d.p.autoencode && (i = a.jgrid.htmlDecode(i));
							o = a.jgrid.createEl.call(d, this.edittype, v, i,
									!1, a.extend({}, a.jgrid.ajaxOptions,
											e.p.ajaxSelectOptions || {}));
							if (b[d.p.id].checkOnSubmit
									|| b[d.p.id].checkOnUpdate)
								b[d.p.id]._savedData[h] = i;
							a(o).addClass("FormElement");
							-1 < a.inArray(this.edittype, ["text", "textarea",
											"password", "select"])
									&& a(o)
											.addClass("ui-widget-content ui-corner-all");
							k = a(l).find("tr[rowpos=" + w + "]");
							if (s.rowabove) {
								var y = a("<tr><td class='contentinfo' colspan='"
										+ 2
										* g
										+ "'>"
										+ s.rowcontent
							...
							0 === k.length
									&& (k = a("<tr " + m + " rowpos='" + w
											...
											.attr("id", "tr_" + h), a(k)
											.append(z), a(l).append(k), k[0].rp = w);
							a("td:eq(" + (u - 2) + ")", k[0])
									.html(void 0 === s.label
											? e.p.colNames[r]
											: s.label);
							a("td:eq(" + (u - 1) + ")", k[0])
									.append(s.elmprefix).append(o)
									.append(s.elmsuffix);
							a.isFunction(v.custom_value)
									&& "_empty" !== c
									&& v.custom_value.call(d, a("#" + h, "#"
															+ f), "set", i);
					...
					if (0 < p
							&& (r = a("<tr class='FormData' style='display:none'><td class='CaptionTD'></td><td colspan='"
									+ (2 * g - 1)
									+ "' class='DataTD'><input class='FormElement' id='id_g' type='text' name='"
									+ e.p.id
									+ "_id' value='"
									+ c
									+ "'/></td></tr>"), r[0].rp = p + 999, a(l)
									.append(r), b[d.p.id].checkOnSubmit
									|| b[d.p.id].checkOnUpdate))
				...
				function t(c, e, f) {
					...
					if (b[d.p.id].checkOnSubmit || b[d.p.id].checkOnUpdate)
						b[d.p.id]._savedData = {}, b[d.p.id]._savedData[e.p.id
								+ "_id"] = c;
					var m = e.p.colModel;
					if ("_empty" === c)
						a(m).each(function() {
							...
							if ((j = a("#" + a.jgrid.jqID(l), "#" + f))
								...
								if (p = "", i.defaultValue
										? (p = a.isFunction(i.defaultValue)
												...
												: j.val(p))
										: "checkbox" === j[0].type
												? (j[0].checked = !1, j[0].defaultChecked = !1, p = a(j)
														.attr("offval"))
												: j[0].type
														&& "select" === j[0].type
																.substr(0, 6)
														? j[0].selectedIndex = 0
														: j.val(p), !0 === b[d.p.id].checkOnSubmit
										|| b[d.p.id].checkOnUpdate)
						...
						o && (a('td[role="gridcell"]', o).each(function(j) {
							l = m[j].name;
							if ("cb" !== l && "subgrid" !== l && "rn" !== l
									&& !0 === m[j].editable) {
								if (l === e.p.ExpandColumn
										&& !0 === e.p.treeGrid)
									g = a(this).text();
								else
									try {
								...
								switch (m[j].edittype) {
									...
									case "textarea" :
										...
										break;
									case "select" :
										var k = g.split(","), k = a.map(k,
												function(c) {
													return a.trim(c)
												});
										a("#" + l + " option", "#" + f).each(
												function() {
													this.selected = !m[j].editoptions.multiple
															&& (a.trim(g) === a
																	.trim(a(this)
																			.text())
																	|| k[0] === a
									...
									case "checkbox" :
										g = "" + g;
										if (m[j].editoptions
												&& m[j].editoptions.value)
											if (m[j].editoptions.value
													.split(":")[0] === g)
												a("#" + l, "#" + f)[d.p.useProp
														? "prop"
														: "attr"]({
									...
									case "custom" :
										try {
											if (m[j].editoptions
													&& a
															.isFunction(m[j].editoptions.custom_value))
												m[j].editoptions.custom_value
														.call(
																d,
																a("#" + l,
																		"#" + f),
				...
				function u() {
					a.each(d.p.colModel, function(a, c) {
								c.editoptions
										&& !0 === c.editoptions.NullIfEmpty
										&& j.hasOwnProperty(c.name)
										&& "" === j[c.name]
										&& (j[c.name] = "null")
							})
				}
				function s() {
					var e, l = [!0, "", ""], g = {}, h = d.p.prmNames, i, m, r, o, n, z = a(d)
							.triggerHandler("jqGridAddEditBeforeCheckValues",
									[a("#" + f), v]);
					z && "object" === typeof z && (j = z);
					a.isFunction(b[d.p.id].beforeCheckValues)
							&& (z = b[d.p.id].beforeCheckValues.call(d, j,
									a("#" + f), v)) && "object" === typeof z
							&& (j = z);
					for (r in j)
						if (j.hasOwnProperty(r)
								&& (l = a.jgrid.checkValues.call(d, j[r], r), !1 === l[0]))
							break;
					u();
					l[0]
							&& (g = a(d).triggerHandler(
									"jqGridAddEditClickSubmit",
									[b[d.p.id], j, v]), void 0 === g
									&& a.isFunction(b[d.p.id].onclickSubmit)
									&& (g = b[d.p.id].onclickSubmit.call(d,
											b[d.p.id], j, v)
											|| {}), l = a(d).triggerHandler(
									"jqGridAddEditBeforeSubmit",
									[j, a("#" + f), v]), void 0 === l
									&& (l = [!0, "", ""]), l[0]
									&& a.isFunction(b[d.p.id].beforeSubmit)
									&& (l = b[d.p.id].beforeSubmit.call(d, j,
											a("#" + f), v)));
					if (l[0] && !b[d.p.id].processing) {
						...
						if (!0 === d.p.treeGrid)
							for (n in j[m] === h.addoper
									&& (o = a(d).jqGrid("getGridParam",
											"selrow"), j["adjacency" === d.p.treeGridModel
											? d.p.treeReader.parent_id_field
											: "parent_id"] = o), d.p.treeReader)
								d.p.treeReader.hasOwnProperty(n)
										&& (g = d.p.treeReader[n], j
												.hasOwnProperty(g)
												&& !(j[m] === h.addoper && "parent_id_field" === n)
												&& delete j[g]);
						j[i] = a.jgrid.stripPref(d.p.idPrefix, j[i]);
						n = a.extend({
							url : b[d.p.id].url
									|| a(d).jqGrid("getGridParam", "editurl"),
							type : b[d.p.id].mtype,
							data : a.isFunction(b[d.p.id].serializeEditData)
									? b[d.p.id].serializeEditData.call(d, j)
									: j,
							complete : function(g, r) {
								...
								if (g.status >= 300 && g.status !== 304) {
									l[0] = false;
									l[1] = a(d).triggerHandler(
											"jqGridAddEditErrorTextFormat",
											[g, v]);
									l[1] = a
											.isFunction(b[d.p.id].errorTextFormat)
											? b[d.p.id].errorTextFormat.call(d,
													g, v)
											: r + " Status: '" + g.statusText
													+ "'. Error code: "
													+ g.status
								} else {
									l = a(d).triggerHandler(
									...
									l[0]
											&& a
													.isFunction(b[d.p.id].afterSubmit)
											&& (l = b[d.p.id].afterSubmit.call(
													d, g, j, v))
								}
								if (l[0] === false) {
										...
										setTimeout(function() {
											a(d)
													.triggerHandler(
															...
															[e, j, a("#" + f),
																	v]);
											b[d.p.id].afterComplete.call(d, e,
													j, a("#" + f), v);
											e = null
										}, 500)
									}
						...
						!n.url
								&& !b[d.p.id].useDataProxy
								&& (a.isFunction(d.p.dataProxy)
										? b[d.p.id].useDataProxy = !0
										: (l[0] = !1, l[1] += " "
												+ a.jgrid.errors.nourl));
						l[0]
								&& (b[d.p.id].useDataProxy
										? (g = d.p.dataProxy.call(d, n, "set_"
														+ d.p.id), void 0 === g
												&& (g = [!0, ""]), !1 === g[0]
												? (l[0] = !1, l[1] = g[1]
														|| "Error deleting the selected row!")
												: (n.data.oper === h.addoper
				...
				function h() {
					var c = !0;
					a("#FormError", k).hide();
					if (b[d.p.id].checkOnUpdate
							&& (j = {}, e(), K = m(j, b[d.p.id]._savedData)))
						a("#" + f).data("disabled", !0), a(".confirm",
								"#" + p.themodal).show(), c = !1;
					return c
				}
				function g() {
					var c;
					if ("_empty" !== r && void 0 !== d.p.savedRow
							&& 0 < d.p.savedRow.length
				...
				function n(c, b) {
					var d = b[1].length - 1;
					0 === c ? a("#pData", k + "_2")
							.addClass("ui-state-disabled") : void 0 !== b[1][c
							- 1]
							&& a("#" + a.jgrid.jqID(b[1][c - 1]))
									.hasClass("ui-state-disabled")
							? a("#pData", k + "_2")
									.addClass("ui-state-disabled")
							: a("#pData", k + "_2")
				...
				var d = this;
				if (d.grid && r) {
					var q = d.p.id, f = "FrmGrid_" + q, o = "TblGrid_" + q, k = "#"
							+ a.jgrid.jqID(o), p = {
						themodal : "editmod" + q,
						modalhead : "edithd" + q,
						...
						scrollelm : f
							...
							: !1, A = a.isFunction(b[d.p.id].afterShowForm)
							? b[d.p.id].afterShowForm
							: !1, w = a.isFunction(b[d.p.id].beforeInitData)
							? b[d.p.id].beforeInitData
							: !1, B = a.isFunction(b[d.p.id].onInitializeForm)
							? b[d.p.id].onInitializeForm
							: !1, l = !0, z = 1, F = 0, j, K, v, f = a.jgrid
							.jqID(f);
					"new" === r
							? (r = "_empty", v = "add", c.caption = b[d.p.id].addCaption)
							: (c.caption = b[d.p.id].editCaption, v = "edit");
					!0 === c.recreateForm
							&& void 0 !== a("#" + a.jgrid.jqID(p.themodal))[0]
							&& a("#" + a.jgrid.jqID(p.themodal)).remove();
					var G = !0;
					...
					if (void 0 !== a("#" + a.jgrid.jqID(p.themodal))[0]) {
						...
						if (!1 === l)
							return;
						g();
						a(".ui-jqdialog-title", "#" + a.jgrid.jqID(p.modalhead))
								.html(c.caption);
						a("#FormError", k).hide();
						b[d.p.id].topinfo
								? (a(".topinfo", k).html(b[d.p.id].topinfo), a(
										".tinfo", k).show())
								: a(".tinfo", k).hide();
						b[d.p.id].bottominfo ? (a(".bottominfo", k + "_2")
								.html(b[d.p.id].bottominfo), a(".binfo",
								k + "_2").show()) : a(".binfo", k + "_2")
								.hide();
						t(r, d, f);
						"_empty" === r || !b[d.p.id].viewPagerButtons ? a(
								"#pData, #nData", k + "_2").hide() : a(
								"#pData, #nData", k + "_2").show();
						!0 === b[d.p.id].processing
								&& (b[d.p.id].processing = !1, a("#sData",
										k + "_2")
										.removeClass("ui-state-active"));
						!0 === a("#" + f).data("disabled")
								&& (a(".confirm",
										"#" + a.jgrid.jqID(p.themodal)).hide(), a("#"
										+ f).data("disabled", !1));
						a(d).triggerHandler("jqGridAddEditBeforeShowForm",
								[a("#" + f), v]);
						y && y.call(d, a("#" + f), v);
						a("#" + a.jgrid.jqID(p.themodal)).data("onClose",
								b[d.p.id].onClose);
						...
						G
								|| a("." + a.jgrid.jqID(c.overlayClass)).click(
										function() {
											if (!h())
												return false;
											a.jgrid
						...
						var E = isNaN(c.dataheight)
								? c.dataheight
								: c.dataheight + "px", l = isNaN(c.datawidth)
								? c.datawidth
								: c.datawidth + "px", E = a("<form name='FormPost' id='"
								+ f
								+ "' class='FormGrid' onSubmit='return false;' style='width:"
								+ l
								+ ";overflow:auto;position:relative;height:"
								+ E + ";'></form>").data("disabled", !1), C = a("<table id='"
								+ o
								+ "' class='EditTable' cellspacing='0' cellpadding='0' border='0'><tbody></tbody></table>"), l = a(d)
								.triggerHandler("jqGridAddEditBeforeInitData",
										[a("#" + f), v]);
						void 0 === l && (l = !0);
						l && w && (l = w.call(d, a("#" + f, v)));
						if (!1 === l)
						...
						a(E).append(C);
						w = a("<tr id='FormError' style='display:none'><td class='ui-state-error' colspan='"
								+ 2 * z + "'></td></tr>");
						w[0].rp = 0;
						a(C).append(w);
						w = a("<tr style='display:none' class='tinfo'><td class='topinfo' colspan='"
								+ 2
								* z
								+ "'>"
								+ b[d.p.id].topinfo
						...
						w[0].rp = 0;
						a(C).append(w);
						var l = (w = "rtl" === d.p.direction ? !0 : !1)
								? "nData"
								: "pData", D = w ? "pData" : "nData";
						i(r, d, C, z);
						var l = "<a href='javascript:void(0)' id='"
								+ l
								+ "' class='fm-button ui-state-default ui-corner-left'><span class='ui-icon ui-icon-triangle-1-w'></span></a>", D = "<a href='javascript:void(0)' id='"
								+ D
								+ "' class='fm-button ui-state-default ui-corner-right'><span class='ui-icon ui-icon-triangle-1-e'></span></a>", H = "<a href='javascript:void(0)' id='sData' class='fm-button ui-state-default ui-corner-all'>"
								+ c.bSubmit + "</a>", I = "<a href='javascript:void(0)' id='cData' class='fm-button ui-state-default ui-corner-all'>"
								+ c.bCancel + "</a>", o = "<table border='0' cellspacing='0' cellpadding='0' class='EditTable' id='"
								+ o
						...
						var L = !1;
						!0 === c.closeOnEscape
								&& (c.closeOnEscape = !1, L = !0);
						o = a("<div></div>").append(E).append(o);
						a.jgrid.createModal(p, o, c, "#gview_"
										+ a.jgrid.jqID(d.p.id), a("#gbox_"
										+ a.jgrid.jqID(d.p.id))[0]);
						w
								&& (a("#pData, #nData", k + "_2").css("float",
										"right"), a(".EditButton", k + "_2")
										.css("text-align", "left"));
						...
						a("#" + a.jgrid.jqID(p.themodal)).keydown(function(e) {
							...
							if (a("#" + f).data("disabled") === true)
								return false;
							if (b[d.p.id].savekey[0] === true
									&& e.which === b[d.p.id].savekey[1]
									&& l.tagName !== "TEXTAREA") {
						...
						c.saveicon = a.extend([!0, "left", "ui-icon-disk"],
								c.saveicon);
						c.closeicon = a.extend([!0, "left", "ui-icon-close"],
								c.closeicon);
						!0 === c.saveicon[0]
								&& a("#sData", k + "_2")
										.addClass("right" === c.saveicon[1]
						...
						if (b[d.p.id].checkOnSubmit || b[d.p.id].checkOnUpdate)
							H = "<a href='javascript:void(0)' id='sNew' class='fm-button ui-state-default ui-corner-all' style='z-index:1002'>"
									+ c.bYes + "</a>", D = "<a href='javascript:void(0)' id='nNew' class='fm-button ui-state-default ui-corner-all' style='z-index:1002'>"
									+ c.bNo + "</a>", I = "<a href='javascript:void(0)' id='cNew' class='fm-button ui-state-default ui-corner-all' style='z-index:1002'>"
									+ c.bExit + "</a>", o = c.zIndex || 999, o++, a("<div class='"
									+ c.overlayClass
									...
									+ c.saveData
									+ "<br/><br/>" + H + D + I + "</div>")
									.insertAfter("#" + f), a("#sNew",
									"#" + a.jgrid.jqID(p.themodal)).click(
									function() {
										s();
										a("#" + f).data("disabled", false);
										a(".confirm",
						...
						a(d).triggerHandler("jqGridAddEditAfterShowForm",
								[a("#" + f), v]);
						A && A.call(d, a("#" + f), v);
						a(".fm-button", "#" + a.jgrid.jqID(p.themodal)).hover(
								function() {
									a(this).addClass("ui-state-hover")
								}, function() {
									a(this).removeClass("ui-state-hover")
						...
						a("#nData", k + "_2").click(function() {
							...
							if (b[0] !== -1 && b[1][b[0] + 1]) {
								...
								if (a.isFunction(c.onclickPgButtons)) {
									e = c.onclickPgButtons.call(d, "next",
											a("#" + f), b[1][b[0]]);
									if (e !== void 0 && e === false)
										return false
								}
								if (a("#" + a.jgrid.jqID(b[1][b[0] + 1]))
										.hasClass("ui-state-disabled"))
									return false;
								t(b[1][b[0] + 1], d, f);
						...
						a("#pData", k + "_2").click(function() {
							...
							if (b[0] !== -1 && b[1][b[0] - 1]) {
								...
								var e;
								if (a.isFunction(c.onclickPgButtons)) {
									e = c.onclickPgButtons.call(d, "prev",
											a("#" + f), b[1][b[0]]);
									if (e !== void 0 && e === false)
										return false
								}
		...
		viewGridRow : function(r, c) {
			...
			return this.each(function() {
				function e() {
					(!0 === b[m.p.id].closeOnEscape || !0 === b[m.p.id].navkeys[0])
							&& setTimeout(function() {
										a(".ui-jqdialog-titlebar-close",
				...
				function i(b, d, e, g) {
					var f, h, i, k = 0, p, m, n = [], r = !1, o, q = "<td class='CaptionTD form-view-label ui-widget-content' width='"
							+ c.labelswidth
							+ "'>&#160;</td><td class='DataTD form-view-data ui-helper-reset ui-widget-content'>&#160;</td>", s = "", t = [
							"integer", "number", "currency"], w = 0, u = 0, y, x, A;
					for (o = 1; o <= g; o++)
						s += 1 === o
								? q
					...
					a(d.p.colModel).each(function() {
						...
						!h
								&& "right" === this.align
								&& (this.formatter
										&& -1 !== a.inArray(this.formatter, t)
										? w = Math.max(w, parseInt(this.width,
														10))
										: u = Math.max(u, parseInt(this.width,
														10)))
					});
					y = 0 !== w ? w : 0 !== u ? u : 0;
					...
					a(d.p.colModel).each(function(b) {
						...
						if ("cb" !== f && "subgrid" !== f && "rn" !== f && A) {
							p = !1 === r ? "" : f === d.p.ExpandColumn
									&& !0 === d.p.treeGrid ? a(
									"td:eq(" + b + ")", d.rows[r]).text() : a(
									"td:eq(" + b + ")", d.rows[r]).html();
							x = "right" === this.align && 0 !== y ? !0 : !1;
							var c = a.extend({}, {
										rowabove : !1,
										rowcontent : ""
									}, this.formoptions || {}), l = parseInt(
									c.rowpos, 10)
									|| k + 1, o = parseInt(2
											* (parseInt(c.colpos, 10) || 1), 10);
							if (c.rowabove) {
								var q = a("<tr><td class='contentinfo' colspan='"
										+ 2
										* g
										+ "'>"
										+ c.rowcontent
							...
							0 === i.length
									&& (i = a("<tr " + m + " rowpos='" + l
											+ "'></tr>").addClass("FormData")
											.attr("id", "trv_" + f), a(i)
											.append(s), a(e).append(i), i[0].rp = l);
							a("td:eq(" + (o - 2) + ")", i[0]).html("<b>"
									+ (void 0 === c.label
											? d.p.colNames[b]
											: c.label) + "</b>");
							a("td:eq(" + (o - 1) + ")", i[0]).append("<span>"
									+ p + "</span>").attr("id", "v_" + f);
					...
					0 < k
							&& (b = a("<tr class='FormData' style='display:none'><td class='CaptionTD'></td><td colspan='"
									+ (2 * g - 1)
									+ "' class='DataTD'><input class='FormElement' id='id_g' type='text' name='id' value='"
									+ b + "'/></td></tr>"), b[0].rp = k + 99, a(e)
									.append(b));
					return n
				}
				function t(b, c) {
					...
					if (h = a(c).jqGrid("getInd", b, !0))
						a("td", h).each(function(b) {
							...
							e = c.p.colModel[b].editrules
									...
									? !1
									: !0 === c.p.colModel[b].hidden ? !0 : !1;
							"cb" !== d
									&& "subgrid" !== d
									&& "rn" !== d
									&& (f = d === c.p.ExpandColumn
											&& !0 === c.p.treeGrid ? a(this)
											.text() : a(this).html(), d = a.jgrid
											.jqID("v_" + d), a(
											"#" + d + " span", "#" + n).html(f), e
											&& a("#" + d, "#" + n)
													.parents("tr:first").hide(), g++)
						}), 0 < g && a("#id_g", "#" + n).val(b)
				}
				function u(b, c) {
					var d = c[1].length - 1;
					0 === b ? a("#pData", "#" + n + "_2")
							.addClass("ui-state-disabled") : void 0 !== c[1][b
							- 1]
				...
				function s() {
					var b = a(m).jqGrid("getDataIDs"), c = a("#id_g", "#" + n)
							.val();
					return [a.inArray(c, b), b]
				}
				var m = this;
				if (m.grid && r) {
					var h = m.p.id, g = "ViewGrid_" + a.jgrid.jqID(h), n = "ViewTbl_"
							+ a.jgrid.jqID(h), x = "ViewGrid_" + h, d = "ViewTbl_"
							+ h, q = {
						themodal : "viewmod" + h,
						modalhead : "viewhd" + h,
					...
					!0 === c.recreateForm
							...
							&& a("#" + a.jgrid.jqID(q.themodal)).remove();
					if (void 0 !== a("#" + a.jgrid.jqID(q.themodal))[0]) {
						f
								&& (o = f.call(m, a("#" + g)), void 0 === o
										&& (o = !0));
						if (!1 === o)
							return;
						a(".ui-jqdialog-title", "#" + a.jgrid.jqID(q.modalhead))
								.html(c.caption);
						a("#FormError", "#" + n).hide();
						t(r, m);
						a.isFunction(b[m.p.id].beforeShowForm)
								&& b[m.p.id].beforeShowForm.call(m, a("#" + g));
						...
						var y = isNaN(c.dataheight)
								? c.dataheight
								: c.dataheight + "px", A = isNaN(c.datawidth)
								? c.datawidth
								: c.datawidth + "px", x = a("<form name='FormPost' id='"
								+ x
						...
						x = a("<div></div>")
								...
								.append("<table border='0' class='EditTable' id='"
										...
										+ y
										+ "</td></tr></tbody></table>");
						a.jgrid.createModal(q, x, c, "#gview_"
										+ a.jgrid.jqID(m.p.id), a("#gview_"
										+ a.jgrid.jqID(m.p.id))[0]);
						d
								&& (a("#pData, #nData", "#" + n + "_2").css(
										"float", "right"), a(".EditButton",
										"#" + n + "_2").css("text-align",
										"left"));
						c.viewPagerButtons
								|| a("#pData, #nData", "#" + n + "_2").hide();
						x = null;
						...
						!0 === c.closeicon[0]
								&& a("#cData", "#" + n + "_2")
										...
										.append("<span class='ui-icon "
												+ c.closeicon[2] + "'></span>");
						a.isFunction(c.beforeShowForm)
								&& c.beforeShowForm.call(m, a("#" + g));
						a.jgrid.viewModal("#" + a.jgrid.jqID(q.themodal), {
									gbox : "#gbox_" + a.jgrid.jqID(h),
									jqm : c.jqModal,
									overlay : c.overlay,
						...
						a(".fm-button:not(.ui-state-disabled)", "#" + n + "_2")
								.hover(function() {
											a(this).addClass("ui-state-hover")
										}, function() {
											a(this)
						...
						a("#nData", "#" + n + "_2").click(function() {
							...
							b[0] = parseInt(b[0], 10);
							if (b[0] !== -1 && b[1][b[0] + 1]) {
								a.isFunction(c.onclickPgButtons)
										&& c.onclickPgButtons.call(m, "next",
												a("#" + g), b[1][b[0]]);
								t(b[1][b[0] + 1], m);
								a(m).jqGrid("setSelection", b[1][b[0] + 1]);
								a.isFunction(c.afterclickPgButtons)
										&& c.afterclickPgButtons.call(m,
												"next", a("#" + g), b[1][b[0]
														+ 1]);
								u(b[0] + 1, b)
							}
						...
						a("#pData", "#" + n + "_2").click(function() {
							...
							if (b[0] !== -1 && b[1][b[0] - 1]) {
								a.isFunction(c.onclickPgButtons)
										&& c.onclickPgButtons.call(m, "prev",
												a("#" + g), b[1][b[0]]);
								t(b[1][b[0] - 1], m);
								a(m).jqGrid("setSelection", b[1][b[0] - 1]);
								a.isFunction(c.afterclickPgButtons)
		...
		delGridRow : function(r, c) {
			...
			return this.each(function() {
				var e = this;
				if (e.grid && r) {
					var i = a.isFunction(b[e.p.id].beforeShowForm), t = a
							.isFunction(b[e.p.id].afterShowForm), u = a
							.isFunction(b[e.p.id].beforeInitData)
							? b[e.p.id].beforeInitData
							: !1, s = e.p.id, m = {}, h = !0, g = "DelTbl_"
							+ a.jgrid.jqID(s), n, x, d, q, f = "DelTbl_" + s, o = {
						themodal : "delmod" + s,
						modalhead : "delhd" + s,
					...
					if (void 0 !== a("#" + a.jgrid.jqID(o.themodal))[0]) {
						...
						var k = isNaN(b[e.p.id].dataheight)
								? b[e.p.id].dataheight
								: b[e.p.id].dataheight + "px", p = isNaN(c.datawidth)
								? c.datawidth
								: c.datawidth + "px", f = "<div id='"
								+ f
								+ "' class='formdata' style='width:"
								+ p
								+ ";overflow:auto;position:relative;height:"
								+ k
								+ ";'><table class='DelTable'><tbody><tr id='DelError' style='display:none'><td class='ui-state-error'></td></tr>"
								+ ("<tr id='DelData' style='display:none'><td >"
										+ r + "</td></tr>"), f = f
								+ ('<tr><td class="delmsg" style="white-space:pre;">'
										+ b[e.p.id].msg + "</td></tr><tr><td >&#160;</td></tr>"), f = f
								+ "</tbody></table></div>"
						...
						a.jgrid.createModal(o, f, c, "#gview_"
										+ a.jgrid.jqID(e.p.id), a("#gview_"
										+ a.jgrid.jqID(e.p.id))[0]);
						u
								&& (h = u.call(e, a("#" + g)), void 0 === h
										&& (h = !0));
						...
						c.delicon = a.extend([!0, "left", "ui-icon-scissors"],
								b[e.p.id].delicon);
						c.cancelicon = a.extend([!0, "left", "ui-icon-cancel"],
								b[e.p.id].cancelicon);
						!0 === c.delicon[0]
								&& a("#dData", "#" + g + "_2")
										.addClass("right" === c.delicon[1]
												? "fm-button-icon-right"
												: "fm-button-icon-left")
										.append("<span class='ui-icon "
												+ c.delicon[2] + "'></span>");
						!0 === c.cancelicon[0]
								&& a("#eData", "#" + g + "_2")
										.addClass("right" === c.cancelicon[1]
												? "fm-button-icon-right"
												: "fm-button-icon-left")
										.append("<span class='ui-icon "
												+ c.cancelicon[2] + "'></span>");
						a("#dData", "#" + g + "_2").click(function() {
							var f = [true, ""], h, i = a("#DelData>td", "#" + g)
									.text();
							m = {};
							a.isFunction(b[e.p.id].onclickSubmit)
									&& (m = b[e.p.id].onclickSubmit.call(e,
											b[e.p.id], i)
											|| {});
				...
				if (!this.nav) {
					...
					if (h.grid && "string" === typeof b) {
								...
								&& (!c.alerttop
										...
										&& (void 0 !== window.innerWidth
												...
												: void 0 !== document.documentElement
														...
														: (c.alertleft = 1024, c.alerttop = 768), c.alertleft = c.alertleft
												/ 2
												- parseInt(c.alertwidth, 10)
												/ 2, c.alerttop = c.alerttop
												/ 2 - 25), a.jgrid
										.createModal(
												m,
												"<div>"
						...
						for (x = 0; x < n; x++) {
							...
							0 === x
									? (o = b, k = h.p.id, o === h.p.toppager
											&& (k += "_top", n = 1))
									: (o = h.p.toppager, k = h.p.id + "_top");
							"rtl" === h.p.direction
									&& a(f).attr("dir", "rtl").css("float",
											"right");
							c.add
									&& (i = i || {}, g = a("<td class='ui-pg-button ui-corner-all'></td>"), a(g)
											.append("<div class='ui-pg-div'><span class='ui-icon "
													+ c.addicon
													+ "'></span>"
													+ c.addtext + "</div>"), a(
											"tr", f).append(g), a(g, f).attr({
												title : c.addtitle || "",
												id : i.id || "add_" + k
											}).click(function() {
										a(this).hasClass("ui-state-disabled")
							...
							c.edit
									&& (g = a("<td class='ui-pg-button ui-corner-all'></td>"), e = e
											|| {}, a(g)
											.append("<div class='ui-pg-div'><span class='ui-icon "
													+ c.editicon
													+ "'></span>"
							...
							c.view
									&& (g = a("<td class='ui-pg-button ui-corner-all'></td>"), s = s
											|| {}, a(g)
											.append("<div class='ui-pg-div'><span class='ui-icon "
													+ c.viewicon
													+ "'></span>"
							...
							c.del
									&& (g = a("<td class='ui-pg-button ui-corner-all'></td>"), t = t
											|| {}, a(g)
											.append("<div class='ui-pg-div'><span class='ui-icon "
													+ c.delicon
													+ "'></span>"
												...
												|| (a.isFunction(c.searchfunc)
														...
														: a(h)
																.jqGrid(
																		...
																		u));
										return false
									}).hover(d, q), u.showOnLoad
											&& !0 === u.showOnLoad
											&& a(g, f).click(), g = null);
							c.refresh
									&& (g = a("<td class='ui-pg-button ui-corner-all'></td>"), a(g)
											.append("<div class='ui-pg-div'><span class='ui-icon "
													+ c.refreshicon
													+ "'></span>"
													+ c.refreshtext + "</div>"), a(
										...
										if (!a(this)
												.hasClass("ui-state-disabled")) {
											a.isFunction(c.beforeRefresh)
													&& c.beforeRefresh.call(h);
											h.p.search = false;
											try {
												var b = h.p.id;
							...
							h.p._nvtd
									&& (g > h.p._nvtd[0]
											&& (a(o + "_" + c.position, o)
													.width(g), h.p._nvtd[0] = g), h.p._nvtd[1] = g);
							f = g = g = null;
							this.nav = !0
						}
					}
		...
		navButtonAdd : function(b, c) {
			...
			return this.each(function() {
				if (this.grid) {
					...
					if (e
							&& !(c.id && void 0 !== a("#" + a.jgrid.jqID(c.id),
									e)[0])) {
						var t = a("<td></td>");
						"NONE" === c.buttonicon.toString().toUpperCase()
								? a(t).addClass("ui-pg-button ui-corner-all")
		...
		navSeparatorAdd : function(b, c) {
			...
			return this.each(function() {
				if (this.grid) {
					...
					if (e) {
						var i = "<td class='ui-pg-button ui-state-disabled' style='width:4px;'><span class='"
								+ c.sepclass
								+ "'></span>"
								+ c.sepcontent
								+ "</td>";
						"first" === c.position ? 0 === e.rows[0].cells.length
								? a("tr", e).append(i)
								: a("tr td:eq(0)", e).before(i) : a("tr", e)
								.append(i)
					}
				}
			})
	...
	a.fn.jqFilter = function(d) {
		...
		return this.each(function() {
			if (!this.filter) {
				...
				var d, l = this.p.columns.length, f, t = /msie/i
				...
				if (l) {
					for (d = 0; d < l; d++)
						if (f = this.p.columns[d], f.stype
								...
								: f.searchtype || (f.searchtype = "string"), void 0 === f.hidden
								&& (f.hidden = !1), f.label
								|| (f.label = f.name), f.index
								&& (f.name = f.index), f
					...
					this.p.showQuery
							&& a(this)
									.append("<table class='queryresult ui-widget ui-widget-content' style='display:block;max-width:440px;border:0px none;' dir='"
											+ this.p.direction
					...
					var u = function() {
						...
						if (a.isFunction(j.searchrules))
							...
							try {
								b = a.jgrid.checkValues.call(c, g, -1,
										j.searchrules, j.label)
							} catch (k) {
							}
						b && b.length && !1 === b[0]
								&& (n.error = !b[0], n.errmsg = b[1])
					};
					this.onchange = function() {
						this.p.error = !1;
						this.p.errmsg = "";
						return a.isFunction(this.p.onChange) ? this.p.onChange
								.call(this, this.p) : !1
					};
					...
					this.createTableForGroup = function(g, j) {
						...
						h = "<span></span>";
						this.p.groupButton
								&& (h = a("<input type='button' value='+ {}' title='Add subgroup' class='add-group'/>"), h
										.bind("click", function() {
											if (g.groups === void 0)
												g.groups = [];
											g.groups.push({
							...
							h.bind("click", function() {
								...
								for (c = 0; c < b.p.columns.length; c++) {
									var e = b.p.columns[c].search === void 0
											? true
											: b.p.columns[c].search, j = b.p.columns[c].hidden === true;
									if (b.p.columns[c].searchoptions.searchhidden === true
											&& e || e && !j) {
										f = b.p.columns[c];
										break
									}
						...
						null !== j
								&& (h = a("<input type='button' value='-' title='Delete group' class='delete-group'/>"), e
										.append(h), h.bind("click", function() {
						...
						if (void 0 !== g.groups)
							for (c = 0; c < g.groups.length; c++)
								e = a("<tr></tr>"), k.append(e), h = a("<td class='first'></td>"), e
										.append(h), h = a("<td colspan='4'></td>"), h
										.append(this.createTableForGroup(
												g.groups[c], g)), e.append(h);
						void 0 === g.groupOp
								&& (g.groupOp = b.p.groupOps[0].op);
						if (void 0 !== g.rules)
							for (c = 0; c < g.rules.length; c++)
								k.append(this.createTableRowForRule(g.rules[c],
										g));
						return k
					};
					this.createTableRowForRule = function(g, j) {
						...
						l.bind("change", function() {
							...
							if (i) {
								...
								t && "text" === i.inputtype
										&& !i.searchoptions.size
										&& (i.searchoptions.size = 10);
								var d = a.jgrid.createEl.call(c, i.inputtype,
										i.searchoptions, "", !0,
										b.p.ajaxSelectOptions, !0);
								a(d).addClass("input-elm");
								h = i.searchoptions.sopt
										? i.searchoptions.sopt
										: b.p.sopt ? b.p.sopt : -1 !== a
												.inArray(i.searchtype,
														b.p.strarr)
												? b.p.stropts
												: b.p.numopts;
								var j = "", k = 0;
								...
								for (e = 0; e < h.length; e++)
									o = a.inArray(h[e], q), -1 !== o
											&& (0 === k
													&& (g.op = b.p.ops[o].oper), j += "<option value='"
													+ b.p.ops[o].oper
													+ "'>"
													+ b.p.ops[o].text
													+ "</option>", k++);
								...
								a.jgrid.msie
										&& 9 > a.jgrid.msiever()
										&& (j = parseInt(a("select.selectopts",
														f)[0].offsetWidth, 10)
												+ 1, a(".selectopts", f)
												.width(j), a(".selectopts", f)
												.css("width", "auto"));
								...
								a(".input-elm", f).bind("change", function(e) {
									...
									setTimeout(function() {
										var d = e.target;
										g.data = d.nodeName.toUpperCase() === "SPAN"
												&& i.searchoptions
												&& a
														.isFunction(i.searchoptions.custom_value)
												? i.searchoptions.custom_value
														.call(
																c,
																a(d)
																		.children(".customelement:first"),
						...
						for (e = m = 0; e < b.p.columns.length; e++) {
							...
							if (!0 === b.p.columns[e].searchoptions.searchhidden
									&& p || p && !r)
								p = "", g.field === b.p.columns[e].name
										&& (p = " selected='selected'", m = e), d += "<option value='"
										+ b.p.columns[e].name
										+ "'"
										+ p
										+ ">"
										+ b.p.columns[e].label + "</option>"
						}
						l.append(d);
						...
						i = n.columns[m];
						i.searchoptions.id = a.jgrid.randId();
						t && "text" === i.inputtype && !i.searchoptions.size
								&& (i.searchoptions.size = 10);
						m = a.jgrid.createEl.call(c, i.inputtype,
								i.searchoptions, g.data, !0,
								b.p.ajaxSelectOptions, !0);
						if ("nu" === g.op || "nn" === g.op)
							a(m).attr("readonly", "true"), a(m).attr(
									"disabled", "true");
						...
						h = i.searchoptions.sopt
								? i.searchoptions.sopt
								: b.p.sopt ? b.p.sopt : -1 !== a.inArray(
										i.searchtype, b.p.strarr)
										? b.p.stropts
										: b.p.numopts;
						d = "";
						a.each(b.p.ops, function() {
						...
						for (e = 0; e < h.length; e++)
							o = a.inArray(h[e], q), -1 !== o
									&& (p = g.op === b.p.ops[o].oper
											? " selected='selected'"
											: "", d += "<option value='"
											+ b.p.ops[o].oper + "'" + p + ">"
											+ b.p.ops[o].text + "</option>");
						s.append(d);
						...
						!0 === this.p.ruleButtons
								&& (m = a("<input type='button' value='-' title='Delete rule' class='delete-rule ui-del'/>"), d
										.append(m), m.bind("click", function() {
					...
					this.getStringForRule = function(d) {
						...
						for (c = 0; c < this.p.ops.length; c++)
							if (this.p.ops[c].oper === d.op) {
								f = this.p.operands.hasOwnProperty(d.op)
						...
						return -1 !== a.inArray(k.searchtype, ["int",
	...
	a.jgrid.extend({
		editRow : function(c, b, e, o, l, g, n, h, f) {
			...
			if ("object" === a.type(d[0]))
				j = d[0];
			else if (void 0 !== b && (j.keys = b), a.isFunction(e)
					&& (j.oneditfunc = e), a.isFunction(o)
					&& (j.successfunc = o), void 0 !== l && (j.url = l), void 0 !== g
					&& (j.extraparam = g), a.isFunction(n)
					&& (j.aftersavefunc = n), a.isFunction(h)
					&& (j.errorfunc = h), a.isFunction(f))
			...
			return this.each(function() {
				...
				if (d.grid
						&& (g = a(d).jqGrid("getInd", c, !0), !1 !== g
								&& "0" === (a(g).attr("editable") || "0")
								&& !a(g).hasClass("not-editable-row")))
					k = d.p.colModel, a('td[role="gridcell"]', g).each(
							function(g) {
								b = k[g].name;
								var j = !0 === d.p.treeGrid
										&& b === d.p.ExpandColumn;
								if (j)
								...
								if ("cb" !== b
										...
										&& "rn" !== b
										&& (d.p.autoencode
												&& (f = a.jgrid.htmlDecode(f)), l[b] = f, !0 === k[g].editable)) {
									null === h && (h = g);
									j
									...
									"select" === k[g].edittype
											&& void 0 !== k[g].editoptions
											&& !0 === k[g].editoptions.multiple
											&& void 0 === k[g].editoptions.dataUrl
											&& a.jgrid.msie
											&& a(v).width(a(v).width());
									e++
								}
							}), 0 < e
							&& (l.id = c, d.p.savedRow.push(l), a(g).attr(
									"editable", "1"), a(
									"td:eq(" + h + ") input", g).focus(), !0 === j.keys
									&& a(g).bind("keydown", function(f) {
										if (27 === f.keyCode) {
											a(d).jqGrid("restoreRow", c,
													j.afterrestorefunc);
											if (d.p._inlinenav)
												try {
													a(d)
									...
									"jqGridInlineEditRow", [c, j]), a
									.isFunction(j.oneditfunc)
									&& j.oneditfunc.call(d, c))
			})
		},
		saveRow : function(c, b, e, o, l, g, n) {
			...
			if ("object" === a.type(h[0]))
				f = h[0];
			else if (a.isFunction(b) && (f.successfunc = b), void 0 !== e
					&& (f.url = e), void 0 !== o && (f.extraparam = o), a
					.isFunction(l)
					&& (f.aftersavefunc = l), a.isFunction(g)
					&& (f.errorfunc = g), a.isFunction(n))
			...
			if ("1" === h) {
				...
				a('td[role="gridcell"]', q).each(function(c) {
					k = d.p.colModel[c];
					m = k.name;
					if ("cb" !== m && "subgrid" !== m && !0 === k.editable
							&& "rn" !== m
						...
						switch (k.edittype) {
							...
							case "select" :
								if (k.editoptions.multiple) {
									...
									i[m] = a("select option:selected", this)
											.val(), w[m] = a(
											"select option:selected", this)
											.text();
								k.formatter && "select" === k.formatter
										&& (w = {});
								break;
							case "custom" :
								try {
									if (k.editoptions
										...
										if (i[m] = k.editoptions.custom_value
												.call(d, a(".customelement",
																this), "get"), void 0 === i[m])
											throw "e2";
									} else
										throw "e1";
						...
						"clientArray" !== f.url && k.editoptions
								&& !0 === k.editoptions.NullIfEmpty
								&& "" === i[m] && (r[m] = "null")
					}
				});
				if (!1 === s[0]) {
					try {
						...
						a.jgrid.info_dialog(a.jgrid.errors.errcap, s[1],
								a.jgrid.edit.bClose, {
									left : p[0],
				...
				h = d.p.prmNames;
				u = c;
				p = !1 === d.p.keyIndex ? h.id : d.p.colModel[d.p.keyIndex
						+ (!0 === d.p.rownumbers ? 1 : 0)
						+ (!0 === d.p.multiselect ? 1 : 0)
						+ (!0 === d.p.subGrid ? 1 : 0)].name;
				if (i) {
					i[h.oper] = h.editoper;
					if (void 0 === i[p] || "" === i[p])
						i[p] = c;
					else if (q.id !== d.p.idPrefix + i[p]
							&& (h = a.jgrid.stripPref(d.p.idPrefix, c), void 0 !== d.p._index[h]
									&& (d.p._index[i[p]] = d.p._index[h], delete d.p._index[h]), c = d.p.idPrefix
									+ i[p], a(q).attr("id", c), d.p.selrow === u
									&& (d.p.selrow = c), a
									.isArray(d.p.selarrrow)
									&& (h = a.inArray(u, d.p.selarrrow), 0 <= h
											&& (d.p.selarrrow[h] = c)), d.p.multiselect))
						h = "jqg_" + d.p.id + "_" + c, a("input.cbox", q).attr(
								"id", h).attr("name", h);
				...
				if ("clientArray" === f.url) {
					...
					a(d).triggerHandler("jqGridInlineAfterSaveRow",
							[c, h, i, f]);
					a.isFunction(f.aftersavefunc)
							&& f.aftersavefunc.call(d, c, h, f);
					j = !0;
					a(q).removeClass("jqgrid-new-row").unbind("keydown")
				} else
					a("#lui_" + a.jgrid.jqID(d.p.id)).show(), r = a.extend({},
							i, r), r[p] = a.jgrid.stripPref(d.p.idPrefix, r[p]), a
							.ajax(a.extend({
								url : f.url,
								data : a.isFunction(d.p.serializeRowData)
										? d.p.serializeRowData.call(d, r)
										: r,
								type : f.mtype,
								async : !1,
								complete : function(b, g) {
									...
									if ("success" === g) {
										var e = !0, h;
										h = a(d).triggerHandler(
												"jqGridInlineSuccessSaveRow",
												[b, c, f]);
										a.isArray(h) || (h = [!0, i]);
										h[0]
												&& a.isFunction(f.successfunc)
												&& (h = f.successfunc
														.call(d, b));
										a.isArray(h)
												? (e = h[0], i = h[1] || i)
										...
										if (!0 === e) {
											...
											a(d).triggerHandler(
													...
													[c, b, i, f]);
											a.isFunction(f.aftersavefunc)
													&& f.aftersavefunc.call(d,
															c, b);
											j = !0;
											a(q).removeClass("jqgrid-new-row")
													.unbind("keydown")
										} else
											a(d).triggerHandler(
													...
													&& f.errorfunc.call(d, c,
															b, g, null), !0 === f.restoreAfterError
													&& a(d).jqGrid(
															"restoreRow", c,
															f.afterrestorefunc)
									}
			...
			return this.each(function() {
				...
				if (b.grid) {
					...
					if (n !== false) {
						...
						a.isFunction(o.afterrestorefunc)
								&& o.afterrestorefunc.call(b, c)
					}
				}
			})
		},
		addRow : function(c) {
			...
			return this.each(function() {
						if (this.grid) {
							var b = this;
							c.rowID = a.isFunction(c.rowID) ? c.rowID
									.call(b, c) : null != c.rowID
									? c.rowID
									: a.jgrid.randId();
							!0 === c.useDefValues
									&& a(b.p.colModel).each(function() {
										if (this.editoptions
											...
											var e = this.editoptions.defaultValue, e = a
													.isFunction(e)
													? e.call(b)
													: e;
							...
							a(b).jqGrid("addRowData", c.rowID, c.initdata,
									c.position);
				...
				if (this.grid) {
					...
					b.edit && a(e).jqGrid("navButtonAdd", c, {
						...
						onClickButton : function() {
							...
							c
									? (a(e).jqGrid("editRow", c, b.editParams), a("#"
											+ l + "_ilsave")
											.removeClass("ui-state-disabled"), a("#"
											+ l + "_ilcancel")
											.removeClass("ui-state-disabled"), a("#"
						...
						onClickButton : function() {
							...
							if (c) {
								...
								a("#" + a.jgrid.jqID(c), "#" + l)
										...
										: (b.editParams.extraparam
												|| (b.editParams.extraparam = {}), b.editParams.extraparam[g] = f.editoper, d = b.editParams);
								a(e).jqGrid("saveRow", c, d)
					...
					!0 === b.restoreAfterSelect
							&& (o = a.isFunction(e.p.beforeSelectRow)
									? e.p.beforeSelectRow
									: !1, e.p.beforeSelectRow = function(c, f) {
								var g = true;
								if (e.p.savedRow.length > 0
										&& e.p._inlinenav === true
										&& c !== e.p.selrow
										&& e.p.selrow !== null) {
									e.p.selrow === b.addParams.rowID
											? a(e).jqGrid("delRowData",
													e.p.selrow)
											: a(e).jqGrid("restoreRow",
													e.p.selrow, b.editParams);
									a(e).jqGrid("showAddEditButtons")
								}
								o && (g = o.call(e, c, f));
								return g
	...
	b.jgrid.extend({
				...
				if (c.grid && !0 === c.p.cellEdit) {
					...
					if (!("subgrid" === g || "cb" === g || "rn" === g)) {
						...
						if (!0 === i.editable && !0 === a
							...
							0 <= parseInt(c.p.iCol, 10)
									&& 0 <= parseInt(c.p.iRow, 10)
									&& (b("td:eq(" + c.p.iCol + ")",
											c.rows[c.p.iRow])
											.removeClass("edit-cell ui-state-highlight"), b(c.rows[c.p.iRow])
											.removeClass("selected-row ui-state-hover"));
							...
							if (b.isFunction(c.p.formatCell)) {
								var j = c.p.formatCell.call(c, c.rows[d].id, g,
										e, d, f);
								void 0 !== j && (e = j)
							}
							var j = b.extend({}, i.editoptions || {}, {
										id : d + "_" + g,
										name : g
									}), n = b.jgrid.createEl.call(c,
									i.edittype, j, e, !0, b.extend({},
											b.jgrid.ajaxOptions,
											c.p.ajaxSelectOptions || {}));
									...
									function(a) {
										...
										if (a.keyCode === 9) {
											if (c.grid.hDiv.loading)
												return false;
											a.shiftKey ? b(c).jqGrid(
													"prevCell", d, f) : b(c)
													.jqGrid("nextCell", d, f)
										}
										a.stopPropagation()
									});
							b(c).triggerHandler("jqGridAfterEditCell",
									[c.rows[d].id, g, e, d, f]);
							...
							0 <= parseInt(c.p.iCol, 10)
									...
									&& (b("td:eq(" + c.p.iCol + ")",
											c.rows[c.p.iRow])
											.removeClass("edit-cell ui-state-highlight"), b(c.rows[c.p.iRow])
											.removeClass("selected-row ui-state-hover")), h
									.addClass("edit-cell ui-state-highlight"), b(c.rows[d])
									.addClass("selected-row ui-state-hover"), e = h
									.html().replace(/\&#160\;/ig, ""), b(c)
									.triggerHandler("jqGridSelectCell",
											[c.rows[d].id, g, e, d, f]), b
									.isFunction(c.p.onSelectCell)
									&& c.p.onSelectCell.call(c, c.rows[d].id,
											g, e, d, f);
						c.p.iCol = f;
						c.p.iRow = d
					}
		...
		saveCell : function(d, f) {
			return this.each(function() {
				...
				if (a.grid && !0 === a.p.cellEdit) {
					...
					if (null !== c) {
						var g = b("td:eq(" + f + ")", a.rows[d]), e, h, i = a.p.colModel[f], k = i.name, j = b.jgrid
								.jqID(k);
						switch (i.edittype) {
							case "select" :
							...
							case "checkbox" :
								var l = ["Yes", "No"];
								i.editoptions
										&& (l = i.editoptions.value.split(":"));
								h = e = b("#" + d + "_" + j, a.rows[d])
										.is(":checked") ? l[0] : l[1];
								break;
							case "password" :
							case "text" :
							...
							case "custom" :
								try {
									if (i.editoptions
										...
										e = i.editoptions.custom_value.call(a,
												b(".customelement", g), "get");
										if (void 0 === e)
											throw "e2";
										h = e
									} else
						...
						if (h !== a.p.savedRow[c].v) {
							if (c = b(a).triggerHandler("jqGridBeforeSaveCell",
									[a.rows[d].id, k, e, d, f]))
								h = e = c;
							if (b.isFunction(a.p.beforeSaveCell)
									&& (c = a.p.beforeSaveCell.call(a,
											a.rows[d].id, k, e, d, f)))
								h = e = c;
							var p = b.jgrid.checkValues.call(a, e, f);
							if (!0 === p[0]) {
								c = b(a).triggerHandler(
										"jqGridBeforeSubmitCell",
										[a.rows[d].id, k, e, d, f])
										|| {};
								b.isFunction(a.p.beforeSubmitCell)
										&& ((c = a.p.beforeSubmitCell.call(a,
												a.rows[d].id, k, e, d, f)) || (c = {}));
								0 < b("input.hasDatepicker", g).length
										&& b("input.hasDatepicker", g)
												.datepicker("hide");
								if ("remote" === a.p.cellsubmit)
									if (a.p.cellurl) {
										var m = {};
										a.p.autoencode
												&& (e = b.jgrid.htmlEncode(e));
										m[k] = e;
										l = a.p.prmNames;
										i = l.id;
										j = l.oper;
										m[i] = b.jgrid.stripPref(a.p.idPrefix,
												a.rows[d].id);
										m[j] = l.editoper;
										m = b.extend(c, m);
										b("#lui_" + b.jgrid.jqID(a.p.id))
										...
										try {
											b.jgrid.info_dialog(
													...
													b.jgrid.edit.bClose), b(a)
													.jqGrid("restoreCell", d, f)
										} catch (q) {
										}
								"clientArray" === a.p.cellsubmit
										&& (b(g).empty(), b(a).jqGrid(
												"setCell", a.rows[d].id, f, h,
												!1, !1, !0), b(g)
												.addClass("dirty-cell"), b(a.rows[d])
												.addClass("edited"), b(a)
												.triggerHandler(
														"jqGridAfterSaveCell",
														[a.rows[d].id, k, e, d,
					...
					window.setTimeout(function() {
								b("#" + b.jgrid.jqID(a.p.knv)).attr("tabindex",
										"-1").focus()
							}, 0)
				}
			})
		...
		GridNav : function() {
			return this.each(function() {
				function d(c, d, e) {
					if ("v" === e.substr(0, 1)) {
						var f = b(a.grid.bDiv)[0].clientHeight, g = b(a.grid.bDiv)[0].scrollTop, l = a.rows[c].offsetTop
								+ a.rows[c].clientHeight, o = a.rows[c].offsetTop;
						"vd" === e
								&& l >= f
								&& (b(a.grid.bDiv)[0].scrollTop = b(a.grid.bDiv)[0].scrollTop
										+ a.rows[c].clientHeight);
						"vu" === e
								&& o < g
								&& (b(a.grid.bDiv)[0].scrollTop = b(a.grid.bDiv)[0].scrollTop
										- a.rows[c].clientHeight)
					...
					"h" === e
							&& (e = b(a.grid.bDiv)[0].clientWidth, f = b(a.grid.bDiv)[0].scrollLeft, g = a.rows[c].cells[d].offsetLeft, a.rows[c].cells[d].offsetLeft
									+ a.rows[c].cells[d].clientWidth >= e
									+ parseInt(f, 10)
									? b(a.grid.bDiv)[0].scrollLeft = b(a.grid.bDiv)[0].scrollLeft
											+ a.rows[c].cells[d].clientWidth
									: g < f
											&& (b(a.grid.bDiv)[0].scrollLeft = b(a.grid.bDiv)[0].scrollLeft
													- a.rows[c].cells[d].clientWidth))
				}
				...
				if (a.grid && !0 === a.p.cellEdit) {
					...
					b("#" + a.p.knv).focus().keydown(function(c) {
						...
						switch (e) {
							case 38 :
								0 < a.p.iRow - 1
										&& (d(a.p.iRow - 1, a.p.iCol, "vu"), b(a)
												.jqGrid("editCell",
														a.p.iRow - 1, a.p.iCol,
														!1));
								break;
							case 40 :
								a.p.iRow + 1 <= a.rows.length - 1
										&& (d(a.p.iRow + 1, a.p.iCol, "vd"), b(a)
												.jqGrid("editCell",
														a.p.iRow + 1, a.p.iCol,
														!1));
								break;
							case 37 :
								0 <= a.p.iCol - 1
										&& (g = f(a.p.iCol - 1, "lft"), d(
												a.p.iRow, g, "h"), b(a).jqGrid(
												"editCell", a.p.iRow, g, !1));
								break;
							case 39 :
								a.p.iCol + 1 <= a.p.colModel.length - 1
										&& (g = f(a.p.iCol + 1, "rgt"), d(
												a.p.iRow, g, "h"), b(a).jqGrid(
												"editCell", a.p.iRow, g, !1));
								break;
							case 13 :
								0 <= parseInt(a.p.iCol, 10)
										&& 0 <= parseInt(a.p.iRow, 10)
		...
		getChangedCells : function(d) {
			...
			this.each(function() {
				...
				a.grid && !0 === a.p.cellEdit && b(a.rows).each(function(g) {
					var e = {};
					b(this).hasClass("edited")
							&& (b("td", this).each(function(f) {
...
(function(c) {
	...
	c.jqm = {
		hash : {},
		open : function(a, i) {
			var b = j[a], e = b.c, h = "." + e.closeClass, f = parseInt(b.w
					.css("z-index")), f = 0 < f ? f : 3E3, g = c("<div></div>")
					.css({
								height : "100%",
								width : "100%",
								position : "fixed",
			...
			e.modal ? (k[0] || setTimeout(function() {
						p("bind")
					}, 1), k.push(a)) : 0 < e.overlay ? e.closeoverlay
					&& b.w.jqmAddClose(g) : g = d;
			b.o = g ? g.addClass(e.overlayClass).prependTo("body") : d;
			e.ajax ? (f = e.target || b.w, g = e.ajax, f = "string" == typeof f
					? c(f, b.w)
					: c(f), g = "@" == g.substr(0, 1) ? c(i).attr(g
					.substring(1)) : g, f.html(e.ajaxText).load(g, function() {
			...
			e.toTop
					&& b.o
					&& b.w.before('<span id="jqmP' + b.w[0]._jqm + '"></span>')
							.insertAfter(b.o);
	...
	var l = 0, j = c.jqm.hash, k = [], d = !1, m = function(a) {
		...
		b && (c(".jqmID" + d.s).each(function() {
			var d = c(this), h = d.offset();
			if (h.top <= a.pageY && a.pageY <= h.top + d.height()
					&& h.left <= a.pageX && a.pageX <= h.left + d.width())
				return b = !1
		}), m(d));
		return !b
	}, o = function(a, i, b) {
...
(function(b) {
	b.jgrid.extend({
		...
		addSubGridCell : function(b, c) {
			...
			return '<td role="gridcell" aria-describedby="' + l
			...
			return this.each(function() {
				...
				if (a.grid) {
					var m = function(c, e, h) {
						e = b("<td align='" + a.p.subGridModel[0].align[h]
								+ "'></td>").html(e);
						b(c).append(e)
					}, l = function(c, e) {
						...
						for (f = 0; f < a.p.subGridModel[0].name.length; f++)
							h = b("<th class='ui-state-default ui-th-subgrid ui-th-column ui-th-"
									+ a.p.direction + "'></th>"), b(h)
									.html(a.p.subGridModel[0].name[f]), b(h)
									.width(a.p.subGridModel[0].width[f]), b(i)
									.append(h);
						b(d).append(i);
						c
								&& (n = a.p.xmlReader.subgrid, b(
										n.root + " " + n.row, c).each(
										function() {
											...
											if (!0 === n.repeatitems)
												...
												var c = a.p.subGridModel[0].mapping
						...
						var h, f, d, g, i, k = b("<table cellspacing='0' cellpadding='0' border='0'><tbody></tbody></table>"), j = b("<tr></tr>");
						for (f = 0; f < a.p.subGridModel[0].name.length; f++)
							h = b("<th class='ui-state-default ui-th-subgrid ui-th-column ui-th-"
									+ a.p.direction + "'></th>"), b(h)
									.html(a.p.subGridModel[0].name[f]), b(h)
									.width(a.p.subGridModel[0].width[f]), b(j)
									.append(h);
						b(k).append(j);
						if (c
								&& (g = a.p.jsonReader.subgrid, h = b.jgrid
										.getAccessor(c, g.root), void 0 !== h))
						...
						if (a.p.subGridModel[0].params)
							for (g = 0; g < a.p.subGridModel[0].params.length; g++)
								for (f = 0; f < a.p.colModel.length; f++)
									a.p.colModel[f].name === a.p.subGridModel[0].params[g]
											&& (d[a.p.colModel[f].name] = b(
													"td:eq(" + f + ")", c)
													.text().replace(
															/\&#160\;/ig, ""));
						if (!a.grid.hDiv.loading)
							switch (a.grid.hDiv.loading = !0, b("#load_"
									+ b.jgrid.jqID(a.p.id)).show(), a.p.subgridtype
									|| (a.p.subgridtype = a.p.datatype), b
									.isFunction(a.p.subgridtype)
									? a.p.subgridtype.call(a, d)
									: a.p.subgridtype = a.p.subgridtype
											.toLowerCase(), a.p.subgridtype) {
								case "xml" :
								case "json" :
									b.ajax(b.extend(
											{
					...
					for (; o < s;)
						b(a.rows[o]).hasClass("jqgrow")
								&& b(a.rows[o].cells[e]).bind("click",
										function() {
											...
											if (b(this).hasClass("sgcollapsed")) {
												...
												if (a.p.subGridOptions.reloadOnExpand === true
													...
													if (g === false)
														return false;
													b(c)
															.after("<tr role='row' class='ui-subgrid'>"
																	+ q
													...
													b(a)
															.triggerHandler(
																	...
																	[
																			...
																			d]);
													b
															.isFunction(a.p.subGridRowExpanded)
													...
													b(j).show();
												b(this)
														.html("<a href='javascript:void(0);'><span class='ui-icon "
					...
					!0 === a.p.subGridOptions.expandOnLoad
							&& b(a.rows).filter(".jqgrow").each(function(a, c) {
										b(c.cells[0]).click()
									});
	...
	d.jgrid.extend({
				...
				if (null !== a && ("object" === typeof a || d.isFunction(a)))
					if (a.groupField.length) {
						...
						for (b = 0; b < a.groupField.length; b++)
							a.groupOrder[b] || (a.groupOrder[b] = "asc"), a.groupText[b]
									|| (a.groupText[b] = "{0}"), "boolean" !== typeof a.groupColumnShow[b]
									&& (a.groupColumnShow[b] = !0), "boolean" !== typeof a.groupSummary[b]
									&& (a.groupSummary[b] = !1), !0 === a.groupColumnShow[b]
									? (a.visibiltyOnNextGrouping[b] = !0, d(this)
											.jqGrid("showCol", a.groupField[b]))
									: (a.visibiltyOnNextGrouping[b] = d("#"
											+ d.jgrid.jqID(this.p.id + "_"
													+ a.groupField[b]))
											.is(":visible"), d(this).jqGrid(
											"hideCol", a.groupField[b]));
						a.summary = [];
						b = 0;
		...
		groupingPrepare : function(b, g, f, a) {
			this.each(function() {
				...
				for (c = 0; c < k; c++)
					l = e.groupField[c], m = e.displayField[c], j = f[l], m = null == m
							? null
							: f[m], null == m && (m = j), void 0 !== j
							&& (0 === a
									? (e.groups.push({
												idx : c,
												dataIndex : l,
									...
									: "object" !== typeof j
											&& (d.isArray(e.isInTheSameGroup)
													&& d
															.isFunction(e.isInTheSameGroup[c])
													? !e.isInTheSameGroup[c]
															.call(
																	h,
																	e.lastvalues[c],
																	j, c, e)
											...
											: 1 === q
													...
													: (e.counters[c].cnt += 1, e.groups[e.counters[c].pos].cnt = e.counters[c].cnt), d
									.each(e.counters[c].summary, function() {
										this.v = d.isFunction(this.st)
												? this.st.call(h, this.v,
														this.nm, f)
												: d(h)
														.jqGrid(
		...
		groupingToggle : function(b) {
			this.each(function() {
				var g = this.p.groupingView, f = b.split("_"), a = parseInt(
						f[f.length - 2], 10);
				f.splice(f.length - 2, 2);
				var f = f.join("_"), e = g.minusicon, h = g.plusicon, c = d("#"
						+ d.jgrid.jqID(b)), c = c.length
						? c[0].nextSibling
						: null, k = d("#" + d.jgrid.jqID(b)
						+ " span.tree-wrap-" + this.p.direction), l = !1;
				if (k.hasClass(e)) {
					if (g.showSummaryOnHide) {
						if (c)
							for (; c
									&& !(d(c).hasClass("jqfoot") && parseInt(
											d(c).attr("jqfootlevel"), 10) <= a);)
								d(c).hide(), c = c.nextSibling
					} else if (c)
						for (; c;) {
							g = c.className.indexOf(f);
							if (-1 !== g
									&& parseInt(c.className.substring(g
													+ f.length + 1), 10) <= a)
								break;
							d(c).hide();
							c = c.nextSibling
					...
					if (c)
						for (; c;) {
							...
							d(c).show();
							(g = d(c)
									.find("span.tree-wrap-" + this.p.direction))
									&& d(g).hasClass(h)
									&& d(g).removeClass(h).addClass(e);
							c = c.nextSibling
						}
					k.removeClass(h).addClass(e)
				}
				d(this).triggerHandler("jqGridGroupingClickGroup", [b, l]);
				d.isFunction(this.p.onClickGroup)
						&& this.p.onClickGroup.call(this, b, l)
			});
			return !1
		},
		groupingRender : function(b, g) {
			return this.each(function() {
				...
				var a = this, e = a.p.groupingView, h = "", c = "", k, l, j = e.groupCollapse
						? e.plusicon
						: e.minusicon, m, q = [], w = e.groupField.length, j = j
						+ (" tree-wrap-" + a.p.direction);
				...
				d.each(e.groups, function(s, i) {
					...
					k = l + "_" + s;
					c = "<span style='cursor:pointer;' class='ui-icon " + j
							+ "' onclick=\"jQuery('#" + d.jgrid.jqID(a.p.id)
							+ "').jqGrid('groupingToggle','" + k
							+ "');return false;\"></span>";
					try {
						d.isArray(e.formatDisplayField)
								&& d.isFunction(e.formatDisplayField[i.idx])
								&& (i.displayValue = e.formatDisplayField[i.idx]
										.call(a, i.displayValue, i.value,
												a.p.colModel[q[i.idx]], i.idx,
												e)), m = a.formatter(k,
					...
					h += '<tr id="'
							...
							* i.idx
							...
							+ '">'
							+ c
							+ d.jgrid.template(e.groupText[i.idx], m, i.cnt,
									i.summary) + "</td></tr>";
					if (w - 1 === i.idx) {
						var o = e.groups[s + 1], p, n, B = void 0 !== o
						...
						var r;
						if (void 0 !== o) {
							for (r = 0; r < e.groupField.length
									&& o.dataIndex !== e.groupField[r]; r++);
							t = e.groupField.length - r
						}
						for (o = 0; o < t; o++)
							if (x[o]) {
								n = "";
								e.groupCollapse && !e.showSummaryOnHide
		...
		groupingGroupBy : function(b, g) {
			return this.each(function() {
						...
						this.p.grouping = !0;
						void 0 === f.visibiltyOnNextGrouping
								&& (f.visibiltyOnNextGrouping = []);
						var a;
						for (a = 0; a < f.groupField.length; a++)
							!f.groupColumnShow[a]
									&& f.visibiltyOnNextGrouping[a]
									&& d(this).jqGrid("showCol",
											f.groupField[a]);
						for (a = 0; a < b.length; a++)
							f.visibiltyOnNextGrouping[a] = d("#"
									+ d.jgrid.jqID(this.p.id) + "_"
									+ d.jgrid.jqID(b[a])).is(":visible");
			...
			return this.each(function() {
						...
						if (!0 === b) {
							...
							for (f = 0; f < g.groupField.length; f++)
								!g.groupColumnShow[f]
										&& g.visibiltyOnNextGrouping[f]
										&& d(this).jqGrid("showCol",
												g.groupField);
							d(
									"tr.jqgroup, tr.jqfoot",
									"#" + d.jgrid.jqID(this.p.id)
											+ " tbody:first").remove();
							d(
									"tr.jqgrow:hidden",
									"#" + d.jgrid.jqID(this.p.id)
		...
		groupingCalculations : {
			handler : function(b, d, f, a, e, h) {
				var c = {
					...
					min : function() {
						return "" === d ? parseFloat(h[f] || 0) : Math.min(
								parseFloat(d), parseFloat(h[f] || 0))
					},
					max : function() {
						return "" === d ? parseFloat(h[f] || 0) : Math.max(
								parseFloat(d), parseFloat(h[f] || 0))
					},
					count : function() {
						"" === d && (d = 0);
				...
				b = c[b]();
				null != a
						&& ("fixed" === e ? b = b.toFixed(a) : (a = Math.pow(
								10, a), b = Math.round(b * a) / a));
				return b
			}
		}
	})
...
(function(d) {
	d.jgrid.extend({
			...
			return this.each(function() {
				...
				if (a.grid && a.p.treeGrid)
					for (var h = a.p.expColInd, e = a.p.treeReader.expanded_field, i = a.p.treeReader.leaf_field, g = a.p.treeReader.level_field, f = a.p.treeReader.icon_field, l = a.p.treeReader.loaded, k, m, n, j; b < c;)
						j = d.jgrid.stripPref(a.p.idPrefix, a.rows[b].id), j = a.p.data[a.p._index[j]], "nested" === a.p.treeGridModel
								&& !j[i]
								&& (k = parseInt(j[a.p.treeReader.left_field],
										10), m = parseInt(
										j[a.p.treeReader.right_field], 10), j[i] = m === k
										+ 1 ? "true" : "false", a.rows[b].cells[a.p._treeleafpos].innerHTML = j[i]), k = parseInt(
								j[g], 10), 0 === a.p.tree_root_level ? (n = k
								+ 1, m = k) : (n = k, m = k - 1), n = "<div class='tree-wrap tree-wrap-"
								+ a.p.direction
								+ "' style='width:"
								+ 18
								* n
								+ "px;'>", n += "<div style='"
								+ ("rtl" === a.p.direction ? "right:" : "left:")
								+ 18 * m + "px;' class='ui-icon ", void 0 !== j[l]
								&& (j[l] = "true" === j[l] || !0 === j[l]
										? !0
										: !1), "true" === j[i] || !0 === j[i]
								? (n += (void 0 !== j[f] && "" !== j[f]
										? j[f]
										: a.p.treeIcons.leaf)
										+ " tree-leaf treeclick", j[i] = !0, m = "leaf")
								: (j[i] = !1, m = ""), j[e] = ("true" === j[e]
								|| !0 === j[e] ? !0 : !1)
								&& (j[l] || void 0 === j[l]), n = !1 === j[e]
								? n
										+ (!0 === j[i]
												? "'"
												: a.p.treeIcons.plus
								...
								: n
										+ (!0 === j[i]
												? "'"
												: a.p.treeIcons.minus
														+ " tree-minus treeclick'"), n += "></div></div>", d(a.rows[b].cells[h])
								.wrapInner("<span class='cell-wrapper" + m
										+ "'></span>").prepend(n), k !== parseInt(
								a.p.tree_root_level, 10)
								&& ((j = (j = d(a).jqGrid("getNodeParent", j))
										&& j.hasOwnProperty(e) ? j[e] : !0) || d(a.rows[b])
										.css("display", "none")), d(a.rows[b].cells[h])
															...
															.stripPref(
																	...
																	d(
																			b.target
																					|| b.srcElement,
																			a.rows)
																			.closest("tr.jqgrow")[0].id), c = a.p._index[b];
													if (!a.p.data[c][i])
														if (a.p.data[c][e]) {
															d(a)
																	.jqGrid(
				...
				if (b.p.treeGrid) {
					...
					for (e in b.p.colModel)
						if (b.p.colModel.hasOwnProperty(e))
							for (i in h = b.p.colModel[e].name, h === b.p.ExpandColumn
									&& !a && (a = !0, b.p.expColInd = c), c++, b.p.treeReader)
								b.p.treeReader.hasOwnProperty(i)
										&& b.p.treeReader[i] === h && g.push(h);
		...
		expandRow : function(b) {
			this.each(function() {
				...
				if (c.grid && c.p.treeGrid) {
					...
					d(a).each(function() {
						var a = c.p.idPrefix
								+ d.jgrid.getAccessor(this, c.p.localReader.id);
			...
			this.each(function() {
						if (this.grid && this.p.treeGrid)
							switch (this.p.treeGridModel) {
								case "nested" :
									c = parseInt(
											b[this.p.treeReader.level_field],
											10)
											- parseInt(this.p.tree_root_level,
													10);
									break;
								case "adjacency" :
			...
			this.each(function() {
				...
				if (a.grid && a.p.treeGrid)
					switch (a.p.treeGridModel) {
						case "nested" :
							var h = a.p.treeReader.left_field, e = a.p.treeReader.right_field, i = a.p.treeReader.level_field, g = parseInt(
									b[h], 10), f = parseInt(b[e], 10), l = parseInt(
									b[i], 10);
							d(this.p.data).each(function() {
								if (parseInt(this[i], 10) === l - 1
										&& parseInt(this[h], 10) < g
										&& parseInt(this[e], 10) > f)
									return c = this, !1
							});
							break;
						case "adjacency" :
							...
							d(this.p.data).each(function() {
								if (this[m] === d.jgrid.stripPref(a.p.idPrefix,
										b[k]))
									return c = this, !1
							})
					}
		...
		getFullTreeNode : function(b) {
			...
			this.each(function() {
				...
				if (a.grid && a.p.treeGrid)
					switch (a.p.treeGridModel) {
						case "nested" :
							var e = a.p.treeReader.left_field, i = a.p.treeReader.right_field, g = a.p.treeReader.level_field, f = parseInt(
									b[e], 10), l = parseInt(b[i], 10), k = parseInt(
									b[g], 10);
							d(this.p.data).each(function() {
								parseInt(this[g], 10) >= k
										&& parseInt(this[e], 10) >= f
						...
						case "adjacency" :
							if (b) {
								...
								d(this.p.data).each(function(b) {
									h = c.length;
									for (b = 0; b < h; b++)
										if (d.jgrid.stripPref(a.p.idPrefix,
												c[b][n]) === this[m]) {
											c.push(this);
											break
										}
			...
			this.each(function() {
						if (this.grid && this.p.treeGrid)
							for (var a = d(this).jqGrid("getNodeParent", b); a;)
								c.push(a), a = d(this).jqGrid("getNodeParent",
										a)
					});
			return c
		},
		...
		expandNode : function(b) {
			return this.each(function() {
				if (this.grid && this.p.treeGrid) {
					...
					if (!b[c]) {
						var f = d.jgrid.getAccessor(b, this.p.localReader.id), l = d(
								"#" + this.p.idPrefix + d.jgrid.jqID(f),
								this.grid.bDiv)[0], k = this.p._index[f];
						d(this).jqGrid("isNodeLoaded", this.p.data[k])
								? (b[c] = !0, d("div.treeclick", l)
								...
								: this.grid.hDiv.loading
										|| (b[c] = !0, d("div.treeclick", l)
												.removeClass(this.p.treeIcons.plus
														+ " tree-plus")
												.addClass(this.p.treeIcons.minus
														+ " tree-minus"), this.p.treeANode = l.rowIndex, this.p.datatype = this.p.treedatatype, "nested" === this.p.treeGridModel
												? d(this).jqGrid(
														"setGridParam", {
															postData : {
																nodeid : f,
												...
												.trigger("reloadGrid"), b[h] = !0, "nested" === this.p.treeGridModel
												? d(this).jqGrid(
														"setGridParam", {
															postData : {
																nodeid : "",
		...
		collapseNode : function(b) {
			return this.each(function() {
						if (this.grid && this.p.treeGrid) {
							...
							b[c]
									&& (b[c] = !1, c = d.jgrid.getAccessor(b,
											this.p.localReader.id), c = d("#"
													+ this.p.idPrefix
													+ d.jgrid.jqID(c),
											this.grid.bDiv)[0], d(
											"div.treeclick", c)
			...
			return this.each(function() {
						if (this.grid && this.p.treeGrid) {
							...
							for (i = k.length; e < i; e++)
								g = k[e], f.push(g), d(this).jqGrid(
										"collectChildrenSortTree", f, g, b, c,
										a, h);
							d.each(f, function(a) {
										var b = d.jgrid.getAccessor(this,
												l.p.localReader.id);
										d("#" + d.jgrid.jqID(l.p.id)
												+ " tbody tr:eq(" + a + ")")
												.after(d(
														"tr#" + d.jgrid.jqID(b),
														l.grid.bDiv))
			...
			return this.each(function() {
						if (this.grid && this.p.treeGrid) {
							...
							for (f = k.length; g < f; g++)
								l = k[g], b.push(l), d(this).jqGrid(
										"collectChildrenSortTree", b, l, a, h,
										e, i)
						}
					})
		},
		setTreeRow : function(b, c) {
			var a = !1;
			this.each(function() {
						this.grid && this.p.treeGrid
								&& (a = d(this).jqGrid("setRowData", b, c))
					});
			return a
		},
			...
			if (a) {
				...
				if (void 0 === b || null === b) {
					...
					if (0 <= p)
						for (; 0 <= p;)
							j = Math.max(j,
									parseInt(e.p.data[p][e.p.localReader.id],
											10)), p--;
					b = j + 1
				}
				...
				if (void 0 === c || null === c || "" === c)
					s = c = null, j = "last", t = e.p.tree_root_level, p = e.p.data.length
							+ 1;
				else if (j = "after", r = e.p._index[c], q = e.p.data[r], c = q[e.p.localReader.id], t = parseInt(
						q[f], 10)
						+ 1, p = d(e).jqGrid("getFullTreeNode", q), p.length
						? (s = p = p[p.length - 1][e.p.localReader.id], p = d(e)
								.jqGrid("getInd", s)
								+ 1)
						: p = d(e).jqGrid("getInd", c) + 1, q[g])
					u = !0, q[i] = !0, d(e.rows[v])
							.find("span.cell-wrapperleaf")
							.removeClass("cell-wrapperleaf")
							.addClass("cell-wrapper").end()
							.find("div.tree-leaf")
							.removeClass(e.p.treeIcons.leaf + " tree-leaf")
							.addClass(e.p.treeIcons.minus + " tree-minus"), e.p.data[r][g] = !1, q[n] = !0;
				r = p + 1;
				void 0 === a[i] && (a[i] = !1);
				void 0 === a[n] && (a[n] = !1);
				a[f] = t;
				...
				if ("nested" === e.p.treeGridModel) {
					...
					if (null !== c) {
						...
						if (f.length)
							for (o in f)
								f.hasOwnProperty(o)
										&& (f[o][k] = f[o][k] > g ? parseInt(
												f[o][k], 10)
												+ 2 : f[o][k], f[o][m] = f[o][m] >= g
												? parseInt(f[o][m], 10) + 2
												: f[o][m]);
						a[k] = g;
						a[m] = g + 1
						...
						if (f.length)
							for (o in f)
								f.hasOwnProperty(o)
										&& (f[o][m] = parseInt(f[o][m], 10) + 2);
						a[k] = g + 1;
						a[m] = g + 2
					}
				}
				if (null === c || d(e).jqGrid("isNodeLoaded", q) || u)
					d(e).jqGrid("addRowData", b, a, j, s), d(e).jqGrid(
							"setTreeNode", p, r);
			...
			return this.each(function() {
				var d = this, f = function(a, b) {
					...
					if (xmlJsonClass.xml2json && c.jgrid.parse) {
						...
						h
								? (h = e.grid.datatype, e.grid.datatype = "xmlstring", e.grid.datastr = a, c(d)
				...
				switch (a.imptype) {
					...
					case "xmlstring" :
						if (a.impstring && "string" === typeof a.impstring) {
							...
							g
									&& (f(g, a), c(d).triggerHandler(
											"jqGridImportComplete", [g, a]), c
											.isFunction(a.importComplete)
											&& a.importComplete(g), a.impstring = null);
							g = null
						}
						break;
					case "json" :
					...
					case "jsonstring" :
						a.impstring
								&& "string" === typeof a.impstring
								&& (b(a.impstring, a), c(d).triggerHandler(
										"jqGridImportComplete",
										[a.impstring, a]), c
										.isFunction(a.importComplete)
										&& a.importComplete(a.impstring), a.impstring = null)
				}
			})
		},
		jqGridExport : function(a) {
			...
			this.each(function() {
				if (this.grid) {
					...
					b.rownumbers
							&& (b.colNames.splice(0, 1), b.colModel
									.splice(0, 1));
					b.multiselect
							&& (b.colNames.splice(0, 1), b.colModel
									.splice(0, 1));
					...
					if (b.treeGrid)
						for (f in b.treeReader)
							b.treeReader.hasOwnProperty(f)
									&& (b.colNames
											.splice(b.colNames.length - 1), b.colModel
											.splice(b.colModel.length - 1));
					switch (a.exptype) {
						case "xmlstring" :
							d = "<" + a.root + ">"
									+ xmlJsonClass.json2xml(b, a.ident) + "</"
									+ a.root + ">";
							break;
						case "jsonstring" :
							d = "{"
									+ xmlJsonClass.toJson(b, a.root, a.ident,
											!1) + "}", void 0 !== b.postData.filters
									&& (d = d
											.replace(/filters":"/, 'filters":'), d = d
											.replace(/}]}"/, "}]}"))
					}
				}
			});
		...
		excelExport : function(a) {
			...
			return this.each(function() {
				if (this.grid) {
					var d;
					"remote" === a.exptype
							&& (d = c.extend({}, this.p.postData), d[a.oper] = a.tag, d = jQuery
									.param(d), d = -1 !== a.url.indexOf("?")
									? a.url + "&" + d
...
var xmlJsonClass = {
	...
	json2xml : function(a, b) {
		var g = function(a, b, e) {
			...
			if (a instanceof Array)
				...
				for (i in a)
					a.hasOwnProperty(i)
							&& ("@" === i.charAt(0) ? d += " " + i.substr(1)
									+ '="' + a[i].toString() + '"' : f = !0);
				d += f ? ">" : "/>";
				if (f) {
					for (i in a)
						a.hasOwnProperty(i)
								&& ("#text" === i ? d += a[i] : "#cdata" === i
										? d += "<![CDATA[" + a[i] + "]]\>"
										: "@" !== i.charAt(0)
												&& (d += g(a[i], i, e + "\t")));
		...
		if (1 === a.nodeType) {
			if (a.attributes.length) {
				...
				for (f = 0; f < a.attributes.length; f += 1)
					b["@" + a.attributes[f].nodeName] = (a.attributes[f].nodeValue || "")
							.toString()
			}
			if (a.firstChild) {
				var e = f = 0, h = !1, c;
				for (c = a.firstChild; c; c = c.nextSibling)
					1 === c.nodeType ? h = !0 : 3 === c.nodeType
							&& c.nodeValue.match(/[^ \f\n\r\t\v]/)
							? f += 1
							: 4 === c.nodeType && (e += 1);
				if (h)
					if (2 > f && 2 > e) {
						...
						a.attributes.length ? b["#text"] = this.escape(this
								.innerXml(a)) : b = this.escape(this
								.innerXml(a));
				else if (f)
					a.attributes.length
	...
	toJson : function(a, b, g, f) {
		...
		if ("[]" === a)
			...
			e += (b ? ":[" : "[")
					+ (1 < k.length ? c + g + h + k.join("," + c + g + h) + c
							+ g : k.join("")) + "]"
		} else if (null === a)
			e += (b && ":") + "null";
		else if ("object" === typeof a) {
			...
			for (d in a)
				a.hasOwnProperty(d)
						&& (j[j.length] = this.toJson(a[d], d, g + h, f));
			e += (b ? ":{" : "{")
					+ (1 < j.length ? c + g + h + j.join("," + c + g + h) + c
							+ g : j.join("")) + "}"
		} else
			e = "string" === typeof a
					? e
			...
			for (var g = function(a) {
				...
				if (1 === a.nodeType) {
					...
					for (h = 0; h < a.attributes.length; h += 1)
						b += " " + a.attributes[h].nodeName + '="'
								+ (a.attributes[h].nodeValue || "").toString()
								+ '"';
					if (a.firstChild) {
						b += ">";
...
function tableToGrid(j, k) {
	jQuery(j).each(function() {
		if (!this.grid) {
			...
			var b = jQuery(this).width(), c = jQuery(
					"tr td:first-child input[type=checkbox]:first",
					jQuery(this)), a = jQuery(
					"tr td:first-child input[type=radio]:first", jQuery(this)), c = 0 < c.length, a = !c
					&& 0 < a.length, i = c || a, d = [], e = [];
			jQuery("th", jQuery(this)).each(function() {
				0 === d.length && i ? (d.push({
							...
							name : jQuery(this).attr("id")
									|| jQuery.trim(jQuery.jgrid
											.stripHtml(jQuery(this).html()))
											.split(" ").join("_"),
			...
			jQuery("tbody > tr", jQuery(this)).each(function() {
				...
				jQuery("td", jQuery(this)).each(function() {
					if (0 === a && i) {
						var c = jQuery("input", jQuery(this)), e = c
								.attr("value");
						g.push(e || f.length);
			...
			for (b = 0; b < f.length; b++)
				a = null, 0 < g.length && (a = g[b]) && a.replace
						&& (a = encodeURIComponent(a).replace(/[.\-%]/g, "_")), null === a
						&& (a = b + 1), jQuery(this).jqGrid("addRowData", a,
						f[b]);
...
(function(b) {
	b.jgrid.msie && 8 === b.jgrid.msiever()
			&& (b.expr[":"].hidden = function(b) {
	...
	if (b.ui && b.ui.multiselect) {
			...
			b.ui.multiselect.prototype._setSelected = function(a, d) {
				...
				if (d && this.selectedList) {
					...
					this.selectedList.find("li").each(function() {
						b(this).data("optionLink")
								&& b(this).data("optionLink").remove()
										.appendTo(e)
					})
				}
				return c
		...
		b.ui.multiselect.prototype.destroy
				&& (b.ui.multiselect.prototype.destroy = function() {
					...
					b.Widget === void 0 ? b.widget.prototype.destroy.apply(
							this, arguments) : b.Widget.prototype.destroy
	...
	b.jgrid.extend({
		sortableColumns : function(a) {
			return this.each(function() {
				...
				var c = this, e = b.jgrid.jqID(c.p.id), e = {
					...
					axis : "x",
					scrollSensitivity : "1",
					items : ">th:not(:has(#jqgh_" + e + "_cb,#jqgh_" + e
							+ "_rn,#jqgh_" + e + "_subgrid),:hidden)",
					placeholder : {
						element : function(a) {
						...
						update : function(b, a) {
							a.height(b.currentItem.innerHeight()
									- parseInt(b.currentItem.css("paddingTop")
													|| 0, 10)
									- parseInt(b.currentItem
													.css("paddingBottom")
													|| 0, 10));
							a.width(b.currentItem.innerWidth()
					...
					update : function(a, e) {
						var d = b(e.item).parent(), d = b(">th", d), f = {}, g = c.p.id
								+ "_";
						b.each(c.p.colModel, function(b) {
									f[this.name] = b
								});
						var j = [];
						d.each(function() {
									var a = b(">div", this).get(0).id.replace(
											/^jqgh_/, "").replace(g, "");
									f.hasOwnProperty(a) && j.push(f[a])
								});
						b(c).jqGrid("remapColumns", j, true, true);
						b.isFunction(c.p.sortable.update)
								&& c.p.sortable.update(j);
						setTimeout(function() {
		...
		columnChooser : function(a) {
			function d(a, c) {
				a
						&& (typeof a === "string" ? b.fn[a]
								&& b.fn[a].apply(c, b.makeArray(arguments)
												.slice(2)) : b.isFunction(a)
								&& a.apply(c, b.makeArray(arguments).slice(2)))
			}
			var c = this;
			if (!b("#colchooser_" + b.jgrid.jqID(c[0].p.id)).length) {
				var e = b('<div id="colchooser_'
						+ c[0].p.id
						+ '" style="position:relative;overflow:hidden"><div><select multiple="multiple"></select></div></div>'), g = b(
						"select", e), a = b.extend({
							width : 420,
							height : 240,
							classname : null,
							...
							apply_perm : function() {
								b("option", g).each(function() {
									this.selected ? c.jqGrid("showCol",
											i[this.value].name) : c.jqGrid(
											"hideCol", i[this.value].name)
								});
								var e = [];
				...
				if (b.ui && b.ui.multiselect && a.msel === "multiselect") {
					...
					a.msel_opts = b.extend(b.ui.multiselect.defaults,
							a.msel_opts)
				}
				...
				var i = c.jqGrid("getGridParam", "colModel"), q = c.jqGrid(
						"getGridParam", "colNames"), m = {}, f = [];
				g.empty();
				b.each(i, function(a) {
							m[this.name] = a;
							this.hidedlg ? this.hidden || f.push(a) : g
									.append("<option value='"
											+ a
											+ "' "
											+ (this.hidden
													? ""
													: "selected='selected'")
											+ ">" + b.jgrid.stripHtml(q[a])
											+ "</option>")
						});
				var n = b.isFunction(a.dlog_opts)
						? a.dlog_opts.call(c, a)
						: a.dlog_opts;
				d(a.dlog, e, n);
				n = b.isFunction(a.msel_opts)
						? a.msel_opts.call(c, a)
						: a.msel_opts;
				d(a.msel, g, n)
			}
		},
			...
			return this.each(function() {
				...
				if (d.grid && !d.p.treeGrid && b.fn.sortable) {
					...
					a.update = function(c, e) {
						...
						d.p.rownumbers === true
								&& b("td.jqgrid-rownum", d.rows).each(
										function(a) {
											b(this)
													.html(a
															+ 1
		...
		gridDnD : function(a) {
			return this.each(function() {
				function d() {
					var a = b.data(c, "dnd");
					b("tr.jqgrow:not(.ui-draggable)", c)
							.draggable(b.isFunction(a.drag) ? a.drag.call(b(c),
									a) : a.drag)
				}
				var c = this, e, g;
				if (c.grid && !c.p.treeGrid && b.fn.draggable && b.fn.droppable) {
					b("#jqgrid_dnd")[0] === void 0
							&& b("body")
									.append("<table id='jqgrid_dnd' class='ui-jqgrid-dnd'></table>");
					if (typeof a === "string" && a === "updateDnD"
							&& c.p.jqgdnd === true)
						d();
					else {
						a = b.extend({
								...
								return b.extend({
									start : function(e, d) {
										...
										b("td", d.helper).each(function(b) {
											this.style.width = c.grid.headers[b].width
													+ "px"
										});
										a.onstart && b.isFunction(a.onstart)
												&& a.onstart.call(b(c), e, d)
									},
									stop : function(e, d) {
										var f;
										...
										for (f = 0; f < b.data(c, "dnd").connectWith.length; f++)
											b(b.data(c, "dnd").connectWith[f])
													.jqGrid("delRowData",
															"jqg_empty_row");
										a.onstop && b.isFunction(a.onstop)
												&& a.onstop.call(b(c), e, d)
									}
								}, a.drag_opts || {})
							},
							drop : function(a) {
								return b.extend({
									...
									drop : function(e, d) {
										if (b(d.draggable).hasClass("jqgrow")) {
											var f = b(d.draggable).attr("id"), f = d.draggable
													.parent().parent().jqGrid(
															"getRowData", f);
											if (!a.dropbyname) {
												var g = 0, j = {}, h, l, p = b("#"
														+ b.jgrid.jqID(this.id))
														.jqGrid("getGridParam",
																"colModel");
												try {
													for (l in f)
											...
											if (d.helper.dropped) {
												...
												b("#" + b.jgrid.jqID(this.id))
														.jqGrid("addRowData",
																k, f, a.droppos)
											}
											a.ondrop
													&& b.isFunction(a.ondrop)
													&& a.ondrop.call(this, e,
															d, f)
										}
									}
								}, a.drop_opts || {})
						...
						if (a.connectWith) {
							...
							for (e = 0; e < a.connectWith.length; e++) {
								g = a.connectWith[e];
								b(g).droppable(b.isFunction(a.drop) ? a.drop
										.call(b(c), a) : a.drop)
							}
						}
					}
			...
			return this.each(function() {
						...
						if (d.grid && b.fn.resizable) {
							...
							a.stop = function(e, g) {
								...
								b(d).jqGrid("setGridWidth", g.size.width,
										a.shrinkToFit);
