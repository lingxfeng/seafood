...
Ext.samples.samplesCatalog = [
{
    title: '集成应用',
    samples: [{
        text: 'Disco RIA API Document',
        url:  '../docs/index.html',
        icon: 'docs.gif',
        desc: 'Disco RIA API Document'
    }]
},{
    title: '列表(Grid)',
    samples: [{
    ...
    samples: [{
        text: 'Panel',
        url:  'panel/Disco.Ext.CrudPanel.html',
        icon: 'Disco.Ext.CrudPanel.png',
        desc: '这是一个演示Disco.Ext.CrudPanel,面板融入了增删改查！'
    }]
},{
    title: '标签页(Tabs)',
    samples: [{
    ...
    samples: [{
        ...
        desc: '复杂的Form布局,使用disco Util包中的方法快速布局'
    },{
    ...
    title: '前端缓存',
    samples: [{
    	text : 'Disco.Ext.CachedRemoteStore',
    	url : 'caches/Disco.Ext.CachedRemoteStore.html',
    	icon: 'Disco.Ext.CachedRemoteStore.png',
