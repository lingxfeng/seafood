...
SubscribeGridListPanel = Ext.extend(Disco.Ext.CrudPanel, {
	gridSelModel : 'checkbox',
	id : "subscribeGridListPanel",
	baseUrl : "subscribe.java",
	baseQueryParameter : {
		orgType : 1
	},
	showView: false,
	...
	edit : function() {
		var win = SubscribeGridListPanel.superclass.edit.call(this);
		if (win) {
	...
	createWin : function(callback, autoClose) {
		return this.initWin(350, 180, "首次关注回复管理", callback, autoClose);
	},
	...
	storeMapping : [ "id", "template", "msgType","addTime", "account"],
	initComponent : function() {
		...
		SubscribeGridListPanel.superclass.initComponent.call(this);
...
// 模版栏目分类
SubscribeManagePanel = function() {
	this.list = new SubscribeGridListPanel({
		region : "center"
	});
	...
	SubscribeManagePanel.superclass.constructor.call(this, {
		id : "subscribeManagePanel",
		closable : true,
		border : false,
		autoScroll : true,
		layout : "border",
...
Ext.extend(SubscribeManagePanel, Ext.Panel, {});