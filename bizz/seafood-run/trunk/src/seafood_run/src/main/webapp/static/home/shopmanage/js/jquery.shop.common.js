...
function showDialog() {
  ...
  var c="<div id='"+id+"'><div class='message_white_content'> <a href='javascript:void(0);' class='white_close' onclick='javascript:jQuery(\"#"+id+"\").remove();'></a><div ><div class='message_white_iframe_del' style='border:none;'><h3 class='message_white_title'><span>"+title+"</span></h3><div class='message_white_box_del' style='width:90%;'><span class='message_white_img_"+icon+"'></span><span class='message_white_font' style='font-size:14px;'>"+content+"</span></div>   <div class='message_white_box1' style='text-align:center;'><input id='sure' type='button' value='确定' style='padding: 5px 10px;border: none;font-size: 16px;'/><input id='cancel' type='button' value='取消' style='padding: 5px 10px;border: none;font-size: 16px;'/></div>    </div></div></div><div class='black_overlay'></div>";
  var t="<div id='"+id+"'><div class='message_white_content'> <a href='javascript:void(0);' class='white_close' onclick='javascript:jQuery(\"#"+id+"\").remove();'></a><div ><div class='message_white_iframe_del' style='border:none;'><h3 class='message_white_title'><span>"+title+"</span></h3><div class='message_white_box_del' style='width:90%;'><span class='message_white_img_"+icon+"'></span><span class='message_white_font' style='font-size:14px;'>"+content+"</span></div>   <div class='message_white_box2' style='text-align:center;'><input id='ok' type='button' value='确定' style='padding: 5px 30px;border: none;font-size: 16px;'/></div></div></div></div><div class='black_overlay'></div>";
  if(type==0){//消息框
...
jQuery(document).ready(function(){
  ...
  tipStyle();
  //单独弹出一个编辑窗口
  jQuery("a[dialog_uri!=undefined],input[dialog_uri!=undefined][dialog_uri!=''],dt[dialog_uri!=undefined]").live("click",function(e){
	...
	jQuery("#"+dialog_id).remove();
	 if(dialog_uri!=undefined&&dialog_uri!=""){
       ...
       jQuery(".white_content").css("position","fixed").css("top",parseInt(dialog_top)+"px").css("left",parseInt(dialog_left)+"px");
  ...
  jQuery("a[ck_dialog_uri!=undefined],input[ck_dialog_uri!=undefined][ck_dialog_uri!=''],dt[ck_dialog_uri!=undefined]").live("click",function(e){
      var mulitId="";
	  jQuery("#ListForm").find(":checkbox:checked").each(function(){
	    if(jQuery(this).val()!=""){	  
	      mulitId+=jQuery(this).val()+",";
