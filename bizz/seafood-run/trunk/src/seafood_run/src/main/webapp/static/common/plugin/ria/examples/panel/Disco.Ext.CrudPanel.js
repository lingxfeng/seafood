Ext.onReady(function(){
	/*
	 *通常来说Disco.Ext.CrudPanel都是通过继承方式来使用！ 
	 */
	
	Disco_RIA.permissionCheck = false; //是否进行权限检查
	
	Ext.ns('Ext.example');
	Ext.example.Employee = Ext.extendX(Disco.Ext.CrudPanel,function(superclass){
		return {
						...
						},
						{
							...
							tree : new Ext.tree.TreePanel({
								...
								loader : new Ext.tree.TreeLoader({
									nodeParameter : 'id',
									url  : '/department.java?cmd=getDepartmentTree'
								})
							})
						},
						{
