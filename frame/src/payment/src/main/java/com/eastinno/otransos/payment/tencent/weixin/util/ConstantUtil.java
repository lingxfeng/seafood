...
public class ConstantUtil {
    ...
    // 初始化
    public static String APP_ID = "wx4239df9439b84968";// 微信开发平台应用id
    public static String APP_SECRET = "7afa493f688cc6b41918a73b46a9fcdc";// 应用对应的凭证
    // 应用对应的密钥
    public static String APP_KEY = "uVE9nOXrff2ZoEa3vwdjIwBPKLtrQCkI3gQybWe5NvpKeWbE1bVj0fh7QB7OHHpu13eYyjvX9WjDscs2iXu3uXKcXiL8xwO8NNhug38mM9slXBk34EDpIT8yjgmRvzeG";
    public static String PARTNER = "1219263201";// 财付通商户号
    public static String PARTNER_KEY = "2fc46fa64ea3e4bb89b2c2959ad89701";// 商户号对应的密钥
    ...
    public static String NotifyUrl = "weixin_tenpay_notify.otr";
}
