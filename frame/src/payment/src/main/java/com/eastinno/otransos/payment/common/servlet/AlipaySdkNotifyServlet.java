...
import com.eastinno.otransos.payment.alipay.mobile.app.util.AlipayNotify;
import com.eastinno.otransos.payment.common.domain.PayReturnObj;

/**
 * 支付宝快捷支付异步通知
 */
@WebServlet("/alipay_sdk_notify.otr")
public class AlipaySdkNotifyServlet extends BasePayCallSevlet {
	...
	protected void service(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		boolean isverify=AlipayNotify.verify(params);
		if(!isverify){
			...
			isverify=AlipayNotify.verify(params);
		}
