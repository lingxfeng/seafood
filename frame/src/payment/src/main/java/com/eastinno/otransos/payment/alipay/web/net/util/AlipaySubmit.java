package com.eastinno.otransos.payment.alipay.web.net.util;
...
import com.eastinno.otransos.payment.alipay.web.net.config.AlipayConfig;
import com.eastinno.otransos.payment.alipay.web.net.sign.MD5;
import com.eastinno.otransos.payment.alipay.web.net.util.httpClient.HttpProtocolHandler;
import com.eastinno.otransos.payment.alipay.web.net.util.httpClient.HttpRequest;
import com.eastinno.otransos.payment.alipay.web.net.util.httpClient.HttpResponse;
import com.eastinno.otransos.payment.alipay.web.net.util.httpClient.HttpResultType;
...
public class AlipaySubmit {
	...
	public static String getHtmlStr(PayParamsObj payParams) throws Exception {
		...
		String notify_url = domain+AlipayConfig.notifyUrl;
		// 需http://格式的完整路径，不能加?id=123这类自定义参数

		// 页面跳转同步通知页面路径
		String return_url = domain+AlipayConfig.returnUrl;
		...
		String body = payParams.getOrderDesc();
		// 默认支付方式
		String paymethod = "bankPay";
		// 必填
		// 默认网银
		String defaultbank = payParams.getDefaultbank();
		// 必填，银行简码请参考接口技术文档
		...
		System.out.println("支付已经开始，请求参数："+sHtmlText);
		return sHtmlText;
	}
}
