...
package com.eastinno.otransos.dbo.beans.exception;

/**
 * Abstract superclass for all exceptions thrown in the beans package and subpackages.
 * <p>
 * Note that this is a runtime (unchecked) exception. Beans exceptions are usually fatal; there is no reason for them to
 * be checked.
 * 
 * @Author <a href="mailto:ksmwly@gmail.com">lengyu</a>
 * @Creation date: 2014年12月17日 下午3:15:46
 * @Intro
 */
