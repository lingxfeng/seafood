...
public class SocketIOManager {
    ...
    private static final ScheduledExecutorService scheduledExecutorService = Executors.newScheduledThreadPool(Runtime
            .getRuntime().availableProcessors() * 2 + 1);

    public static final Set<String> fobbiddenEvents = new HashSet<String>(
            Arrays.asList("message,connect,disconnect,open,close,error,retry,reconnect".split(",")));
    ...
    public static ScheduledFuture<?> scheduleClearTask(Runnable runnable, long delay, TimeUnit unit) {
