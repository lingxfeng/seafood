...
abstract class EventClientIO implements IOClient {
    ...
    protected static class ClearTask implements Runnable {
        ...
        public ClearTask(String sessionId, final IOHandler handler, boolean clearSession) {
        ...
        @Override
        public void run() {
            log.debug("entry ClearTask run method clearSession is " + clearSession + " and sessionId is " + sessionId);
            ...
            if (!clearSession) {
                ...
                SocketIOManager.scheduleClearTask(new ClearTask(sessionId, handler, true));
                return;
            }
