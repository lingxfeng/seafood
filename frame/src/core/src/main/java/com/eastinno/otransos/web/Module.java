...
import com.eastinno.otransos.core.util.StringUtils;
 ...
 * </p>
 * <p>
 * Description:处理模块配置文件信息,跟Action对应 在Disco中，一个Module对应一个IWebAction，IWebAction是由Module来定义的。
...
public class Module extends PropertyInfo {
    ...
    /**
     * 返回该Module对应的Action Bean中各元素的注入方式，包括bytype,byname,auto及no几种。默认情况下为no，表示不使用自动注入。
     * 
     * @return 注入的类型
     */
