...
public class ActionContext {
     ...
     * 设置当前ActionContext的值
     * 
     * @param context 指定的ActionContext
     */
    ...
    /**
     * 得到当前调用中Disco框架调用参数信息，包括Module，Form，具体执行的Action等
     * 
     * @return 返回Disco框架调用参数对象
     */
    ...
    /**
     * 可以手动设置模板的输出，比如下面的代码把Disco框架的执行结果输出到文件中：
     * 
     * <pre>
     * java.io.Writer writer = new OutputStreamWriter(new FileOutputStream(new File(&quot;c://test.htm&quot;)), &quot;UTF-8&quot;);
