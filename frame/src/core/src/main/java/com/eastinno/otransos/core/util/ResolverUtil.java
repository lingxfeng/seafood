 ...
 * {@link #find(com.opensymphony.xwork2.util.ResolverUtil.Test, String...)} ()} method and supplying a package name and
 * a Test instance. This will cause the named package <b>and all sub-packages</b> to be scanned for classes that meet
 * the test. There are also utility methods for the common use cases of scanning multiple packages for extensions of
...
public class ResolverUtil<T> {
    ...
    private static final Logger log = org.apache.log4j.Logger.getLogger(ResolverUtil.class);
    ...
    protected void addIfMatching(Test test, String fqn) {
        try {
            ...
            /*
             * if (log.isDebugEnabled()) { log.debug("Checking to see if class " + externalName + " matches criteria ["
             * + test + "]"); }
             */
    ...
    /**
     * Attempts to discover classes who's name ends with the provided suffix. Accumulated classes can be accessed by
     * calling {@link #getClasses()}.
     * 
