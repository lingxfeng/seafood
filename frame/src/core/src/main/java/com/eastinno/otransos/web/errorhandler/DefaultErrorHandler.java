...
public class DefaultErrorHandler implements IErrorHandler {
    ...
    public Page handle(HttpServletRequest request, HttpServletResponse response, WebForm form, Throwable e)
            throws ServletException {
        try {
            StringBuffer html = new StringBuffer();
            String title = request.getCharacterEncoding() != null ? I18n
                    .getLocaleMessage("core.web.disco.framework.error") : "Disco Framework error";
