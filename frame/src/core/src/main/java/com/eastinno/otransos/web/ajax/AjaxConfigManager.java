...
import com.eastinno.otransos.web.config.ConfigManager;
...
public class AjaxConfigManager implements ConfigManager {
    ...
    private static final Logger logger = org.apache.log4j.Logger.getLogger(AjaxConfigManager.class.getName());
        ...
        if (list != null) {
            for (int i = 0; i < list.size(); i++) {
                ...
                if (StringUtils.hasText(name)) {
                    ...
                    if (attrInclude != null) {
                        String[] is = StringUtils.tokenizeToStringArray(attrInclude, ",");
                        if (is != null) {
                    ...
                    if (attrExclude != null) {
                        String[] is = StringUtils.tokenizeToStringArray(attrExclude, ",");
                        if (is != null) {
                            for (int t = 0; t < is.length; t++)
