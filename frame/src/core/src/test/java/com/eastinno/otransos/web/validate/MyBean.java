...
@FormPO(validators = {@com.eastinno.otransos.container.annonation.Validator(name = "required", field = "name,bornDate")})
public class MyBean {
    private Long id;

    @Field(name = "姓名", fieldName = "name", validator = @com.eastinno.otransos.container.annonation.Validator(name = "string", required = true, value = "min:5;minMsg:字符数必须超过5个;max:8;trim;blank"))
    private String name;
