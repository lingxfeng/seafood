...
public class O {
    ...
    @InnerProperty
    private Inner inner;
    @InnerProperty(overrides = {@OverrideProperty(name = "amount", newName = "amount1"),
            @OverrideProperty(name = "dw", newName = "dw1")})
    ...
    public String toString() {
        return "id:" + this.id + ",userName:" + this.userName + ",inner:[" + inner + "],inner2:[" + inner2 + "],po:["
                + this.po + "]";
    }
