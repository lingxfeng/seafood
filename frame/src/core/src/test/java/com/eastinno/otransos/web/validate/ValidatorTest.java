...
import com.eastinno.otransos.container.annonation.Name;
import com.eastinno.otransos.web.core.FrameworkEngine;
import com.eastinno.otransos.web.validate.TargetObject;
import com.eastinno.otransos.web.validate.ValidatorManager;
import com.eastinno.otransos.web.validate.Validators;

public class ValidatorTest extends TestCase {
    public void testValidator() {
        MyBean bean = new MyBean();
        java.beans.PropertyDescriptor property = BeanUtils.getPropertyDescriptor(bean.getClass(), "name");
    ...
    public void testValidatorsConfig() {
        ...
        MyBean bean = new MyBean();
        // 测试在bornDate属性上配置参数
        java.beans.PropertyDescriptor property = BeanUtils.getPropertyDescriptor(bean.getClass(), "bornDate");
        TargetObject validateObject = vm.findValidateObject(property);
