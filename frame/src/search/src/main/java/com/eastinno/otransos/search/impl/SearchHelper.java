...
public class SearchHelper {
    ...
    public static Query makeQuery(String field, String q, float boost) {
        if (StringUtils.isBlank(q) || StringUtils.isBlank(field))
            return nullQuery;
        QueryParser parser = new QueryParser(Version.LUCENE_4_9_1, field, analyzer);
        ...
        try {
            ...
            if (fields != null) {
                for (String fn : fields) {
                    // 处理高亮
                    String v = SearchHelper.highlight(doc.get(fn), "中国人");
                    writeField(obj, fn, v);
                }
            }
            obj.setId(id);
    ...
    private static void writeField(Object obj, String field, String value) {
        try {
