package com.eastinno.otransos.web.struts;
...
import com.eastinno.otransos.web.core.ExtResult;
...
public abstract class BaseJSONCrudAction extends DispatchAction {
    ...
    protected ActionForward resultForExtForm(HttpServletRequest request, HttpServletResponse response) throws Exception {
    ...
    protected ActionForward jsonForward(HttpServletRequest request, HttpServletResponse response) throws Exception {
        String json = "function(){" + AjaxUtil.getJSON(this.getJsonData()) + "}()";
