...
if (!Global.depotLoader) {
    Ext.apply(Global, {
        depotLoader: new Disco.Ext.MemoryTreeLoader({
            ...
            url: "depot.java?cmd=getDepotTree&pageSize=-1&treeData=true&all=true",
            listeners: {
...
if (!Global.departmentLoader) {
    Global.departmentLoader = new Disco.Ext.MemoryTreeLoader({
        lazyLoad: true,
        leafOnly: true,
        varName: "Global.DEPT_NODES",
        iconCls: 'disco-tree-node-icon',
        url: "department.java?cmd=getTree&pageSize=-1&treeData=true&all=true",
        listeners: {
            'beforeload': function(treeLoader, node) {
...
ConfigConst.BASE = {
    yesNo: Ext.apply({}, {
        disableChoice: true
    }, Disco.Ext.Util.buildCombox("type", "是否", [["是", true], ["否", false]], false, true)),
    sex: Ext.apply({}, {
        disableChoice: true
    }, Disco.Ext.Util.buildCombox("sex", "性别", [["男", "男"], ["女", "女"]], null, true)),
    status: Ext.apply({}, {
        disableChoice: true
    }, Disco.Ext.Util.buildCombox("status", "状态", [["启用", 0], ["停用", -1]], 0, true)),
    systemRegion: {
        xtype: "treecombo",
        fieldLabel: "所在地区",
        name: "region",
    ...
    dept: {
        ...
        tree: new Ext.tree.TreePanel({
            ...
            root: new Ext.tree.AsyncTreeNode({
                ...
                icon: "images/system/root.gif",
                expanded: true,
                loader: new Disco.Ext.MemoryTreeLoader({
    ...
    getDictionaryCombo: function(name, fieldLabel, sn, valueField, disableBlank, editable) {
        return {
            ...
            store: new Ext.data.JsonStore({
                id: "id",
                url: "systemDictionary.java?cmd=getDictionaryBySn&sn=" + sn,
                root: "result",
                totalProperty: "rowCount",
                remoteSort: true,
                baseParams: {
    ...
    companyDictionary: Disco.Ext.Util.buildRemoteCombox("item", "数据字典", "/companyDictionary.java?cmd=getDictionaryItemBySn", ["id", "title", "tvalue"], "title", "id", true),
    getCompanyDictionaryCombo: function(name, fieldLabel, sn, valueField, disableBlank, editable) {
        return {
            ...
            store: new Ext.data.JsonStore({
                id: "id",
                url: "companyDictionary.java?cmd=getDictionaryItemBySn&sn=" + sn,
                root: "result",
                totalProperty: "rowCount",
                remoteSort: true,
                baseParams: {
...
ConfigConst.STOCK = {
    showBill: function(g, r, e) {
        ...
        if (billId) {
            ...
            Disco.Ext.Util.viewObject(appClass, null, "stock/" + appClass + ".js", null, billId);
        }
    },
    depot: {
        xtype: "treecombo",
...
ConfigConst.CRM = {
    shoppingGuide: Ext.apply({}, {
        ...
        editable: true,
        anchor: "-0"
    }, Disco.Ext.Util.buildRemoteCombox("employee", "员工", "employee.java?cmd=getShoppingGuide", ["id", "name", "trueName", "duty", "tel", "dept", "sex", "email"], "trueName", "id", true)),
    user: Ext.apply({}, {
        xtype: "employeecombo",
        disableChoice: true,
        editable: true,
        anchor: "-0"
    }, Disco.Ext.Util.buildRemoteCombox("user", "员工", "employee.java?cmd=getDepartmentUserBySn&deptSn", ["id", "name", "trueName", "duty", "tel", "dept", "sex", "email"], "name", "id", true, "cache_user_store")),
    seller: Ext.apply({}, {
        xtype: "employeecombo",
        editable: true,
        anchor: "-0"
    }, Disco.Ext.Util.buildRemoteCombox("seller", "业务员", "employee.java?cmd=list", ["id", "name", "trueName", "duty", "tel", "dept", "sex", "email"], "trueName", "id", true, 'cache_user_store')),
    client: Ext.apply({}, {
        xtype: "clientcombo",
        disableChoice: true,
        editable: true,
    ...
    }, Disco.Ext.Util.buildRemoteCombox("client", "客户", "client.java?cmd=autocompleteList", ["id", "fullName", "name", "tel", "address", "fax", "linkMan"], "name", "id", true)),
    supplier: Ext.apply({}, {
        xtype: "clientcombo",
        disableChoice: true,
        editable: true,
        baseUrl: "supplier.java",
        width: 160,
        listWidth: 250,
        pageSize: 10,
        enableKeyEvents: true,
        minChars: 2,
        queryParam: "searchKey"
    }, Disco.Ext.Util.buildRemoteCombox("supplier", "供货商", "supplier.java?cmd=autocompleteList", ["id", "fullName", "name", "tel", "address", "fax", "linkMan"], "name", "id", true)),
    distributor: Ext.apply({}, {
        xtype: "clientcombo",
        disableChoice: true,
        editable: true,
        baseUrl: "distributor.java",
        width: 250,
        listWidth: 250,
        pageSize: 15,
        enableKeyEvents: true,
        minChars: 20,
        queryParam: "searchKey"
    }, Disco.Ext.Util.buildRemoteCombox("distributor", "分销商", "distributor.java?cmd=autocompleteList&pageSize=15", ["id", "fullName", "name", "tel", "address", "fax", "linkMan", "accountBalance", "qualityAssure", "other1", "company"], "name", "id", true)),
    orders: Ext.apply({}, {
        editable: true,
        enableKeyEvents: true,
        minChars: 2,
        pageSize: 10,
        queryParam: "searchKey"
    }, Disco.Ext.Util.buildRemoteCombox("orders", "销售订单", "orders.java?cmd=autocompleteList", ["id", "orderInfo", "sn", "buyTime", "clientId", "clientName"], "orderInfo", "id", true)),
    contract: Ext.apply({}, {
        editable: true,
        enableKeyEvents: true,
        minChars: 2,
        pageSize: 10,
        queryParam: "searchKey"
    }, Disco.Ext.Util.buildRemoteCombox("contract", "合同", "clientContract.java?cmd=autocompleteList", ["id", "title", "clientId", "clientName", "detail"], "title", "id", true)),
    linkMan: Ext.apply({}, {
        editable: true,
        minChars: 2,
        pageSize: 10,
        ...
        enableKeyEvents: true,
        queryParam: "searchKey"
    }, Disco.Ext.Util.buildRemoteCombox("linkMan", "联系人", "linkMan.java?cmd=autocompleteList", ["id", "tel", "trueName", "appellation", "detail", "clientId", "clientName"], "detail", "id", true)),
    opporunity: Ext.apply({}, {
        ...
        enableKeyEvents: true,
        queryParam: "searchKey"
    }, Disco.Ext.Util.buildRemoteCombox("opporunity", "销售机会", "businessOpporunity.java?cmd=autocompleteList", ["id", "title", "beginTime", "userId", "userName", "clientId", "clientName"], "title", "id", true)),
    event: Ext.apply({}, {
        editable: true,
        minChars: 2,
        pageSize: 10,
        enableKeyEvents: true,
        queryParam: "searchKey"
    }, Disco.Ext.Util.buildRemoteCombox("event", "销售机会", "clientEvent.java?cmd=autocompleteList", ["id", "title", "beginTime", "userId", "userName", "clientId", "clientName"], "title", "id", true)),
    qa: Ext.apply({}, {
        editable: true,
        minChars: 2,
        pageSize: 10,
        enableKeyEvents: true,
        queryParam: "searchKey"
    }, Disco.Ext.Util.buildRemoteCombox("qa", "对应QA", "clientQA.java?cmd=autocompleteList", ["id", "question"], "question", "id", true)),
    ordersQuote: Ext.apply({}, {
        pageSize: 10
    }, Disco.Ext.Util.buildRemoteCombox("ordersQuote", "业务员", "ordersQuote.java?cmd=autocompleteList", ["id", "quoteInfo", "sn", "vdate", "clientId", "clientName"], "quoteInfo", "id", true)),
    trade: Disco.Ext.Util.buildRemoteCombox("trade", '行业', "trade.java?cmd=list", ["id", "title", "sn"], "title", "id", true),
    brand: Ext.apply({}, {
        disableChoice: true
    }, Disco.Ext.Util.buildRemoteCombox("brand", '品牌', "brand.java?cmd=list", ["id", "name"], "name")),
    deliveryType: Disco.Ext.Util.buildRemoteCombox("deliveryType", "送货方式", "deliveryType.java?cmd=list&pageSize=-1", ["id", "name", "price", "freePrice"], "name", "id", true),
    payType: Disco.Ext.Util.buildRemoteCombox("payType", "支付方式", "paymentType.java?cmd=list&pageSize=-1", ["id", "name", "discount", "intro"], "name", "id", true),
    product: Ext.apply({}, {
        xtype: "productcombo",
        disableChoice: true,
        editable: true,
        ...
        listWidth: 200,
        queryDelay: 1000
    }, Disco.Ext.Util.buildRemoteCombox("product", "业务员", "product.java?cmd=autocompleteList", ["id", "fullName", "attributeType", "title", "sn", "keyword", "simiProducts", "brand", "unit", "spec", "model", "types", "buyPrice", "dir", {
        name: "dirId",
        mapping: "dir"
    }, "reCost", "salePrice", "ratePrice", "marketPrice", "tradePrice", "bottomPrice", "stockWarnNum", "leastOrderNum", "encapNum", "size", "updateTime", "provideType", "virtualStock", "storeNum", "intro", "content", "pj", "star", "auditing", "inputTime", "readTimes", "status", "vdate", "propertys", "color", "colorSn", "stockMinNum", "stockMaxNum", "encapUnit", "encapSn", "encaped", "buyPeriod", "colors", "sizes", "sizeGroup", "stockNO"], "fullName", "id", true))
}
...
ConfigConst.ACCOUNT = {
    showCert: function(g, r, e) {
        ...
        if (certId) {
            Disco.Ext.Util.viewObject("TransferCertificatePanel", null, "account/CertificatePanel.js", null, certId);
        }
    },
    accountEntryBrief: Ext.apply({}, {
        ...
        pageSize: 20,
        queryParam: "searchKey"
    }, Disco.Ext.Util.buildRemoteCombox("brief", "摘要", "accountEntryBrief.java?cmd=list&pageSize=20", ["id", "title"])),
    accountChart: Ext.apply({}, {
        ...
        queryParam: "searchKey",
        value: ""
    }, Disco.Ext.Util.buildRemoteCombox("accountChart", "会计科目", "accountChart.java?cmd=autocompleteList", ["id", "title", "sn", "fullName"], "fullName", "id", true))
}
...
AccoutChartGridList = Ext.extend(BaseGridList, {
    ...
    selectSingle: false,
    pageSize: 15,
    url: "accountChart.java?cmd=list&pageSize=15",
...
AccountChartSelectWin = Ext.extend(Ext.Window, {
    title: "选择会计科目",
    width: 800,
    height: 500,
    layout: "border",
    ...
    choice: function(e) {
        ...
        if (!records || records.length < 1) {
            Ext.Msg.alert("$!{lang.get('Prompt')}", "$!{lang.get('Select first')}");
            return false;
        }
        var datas = [];
        for (var i = 0; i < records.length; i++) {
            datas[i] = records[i].data;
            datas[i].fullName = datas[i].title + "[" + datas[i].sn + "]";
        }
        this.hide();
    ...
    initComponent: function() {
        ...
        if (!Global.accountChartLoader) {
            Global.accountChartLoader = new Ext.tree.TreeLoader({
                url: "accountChart.java?cmd=getAccountChartTree&pageSize=-1&treeData=true",
                listeners: {
                    'beforeload': function(treeLoader, node) {
                        treeLoader.baseParams.id = (node.id.indexOf('root') < 0 ? node.id : "");
                        if (typeof node.attributes.checked !== "undefined") {
...
AccoutChartComboBox = Ext.extend(Disco.Ext.SmartCombox, {
    ...
    choiceProvider: function() {
        if (!this.lookupWin) {
            ...
            this.lookupWin.on("select", function(data) {
                if (data && data.length) {
                    var text = data[0][this.displayField ? this.displayField : "title"];
                    this.setValue({
                        id: data[0].id,
                        title: text,
                        fullName: text
    ...
    autoSelectBySn: function(c, e) {
        if (e.getKey() == Ext.EventObject.ENTER) {
            ...
            if (r >= 0)
                ...
                Ext.Ajax.request({
                    url: "accountChart.java?cmd=loadBySn",
                    params: {
                        sn: t
                    },
                    success: function(response) {
                        ...
                        if (obj) {
                            ...
                            Ext.Msg.alert("提示", "科目编号不正确,请重新输入!", function() {
                                this.focus(true, 100);
                            }, this);
                        }
                    },
        ...
        if (!this.lookupWin) {
            ...
            this.lookupWin.on("select", function(data) {
                if (data && data.length) {
                    this.setValue({
                        id: data[0].id,
                        title: data[0][this.displayField ? this.displayField : "title"]
                    });
                    if (this.choiceValue) {
                        this.choiceValue(data[0]);
                    }
...
ClientGridList = Ext.extend(BaseGridList, {
    ...
    columnLock: true,
    pageSize: 18,
    url: "client.java?cmd=list&pageSize=18",
    refresh: function() {
        this.store.baseParams = {
    ...
    createClient: function() {
        Disco.Ext.Util.addObject("ClientPanel", this.refresh.createDelegate(this), "crm/ClientPanel.js", null, function(win) {
            if (this.currentRegion)
                win.getComponent(0).findSomeThing("region").setOriginalValue(this.currentRegion);
        }.createDelegate(this));
    },
    ...
    initComponent: function() {
        ...
        this.btn_types = new Disco.Ext.SmartCombox(Ext.apply({}, {
            width: 100,
            listeners: {
                "select": this.refresh,
                scope: this
    ...
    initComponent: function() {
        ...
        if (!Global.productDirLoader) {
            Global.productDirLoader = new Ext.tree.TreeLoader({
                url: "productDir.java?cmd=getProductDirTree&pageSize=-1",
                listeners: {
                    'beforeload': function(treeLoader, node) {
        ...
        if (!this.lookupWin) {
            ...
            this.lookupWin.on("select", function(data) {
                if (data && data.length) {
                    ...
                    var displayField = this.displayField ? this.displayField : "fullName";
...
EmployeeGridList = Ext.extend(BaseGridList, {
    ...
    selectSingle: false,
    pageSize: 10,
    url: "employee.java?cmd=list&pageSize=10",
    ...
    initComponent: function() {
        this.btn_dept = new Disco.Ext.TreeComboField({
            xtype: "treecombo",
            fieldLabel: "部门",
            name: "parentId",
            hiddenName: "parentId",
...
EmployeeComboBox = Ext.extend(Disco.Ext.SmartCombox, {
    choiceValue: Ext.emptyFn(),
    hideTrigger1: true,
    /*triggerConfig : {
    ...
    choiceProvider: function() {
        if (!this.lookupWin) {
            ...
            this.lookupWin.on("select", function(data) {
                this.setValue({
                    id: data[0].id,
                    name: data[0][this.displayField ? this.displayField : "trueName"]
                });
                if (this.choiceValue)
                    this.choiceValue(data[0]);
            }, this);
    ...
    onRender: function(ct, position) {
        EmployeeComboBox.superclass.onRender.call(this, ct, position);
        var label = this.el.findParent('.x-form-element', 5, true) || this.el.findParent('.x-form-field-wrap', 5, true);
        this.helpIcon = label.createChild({
            cls: "object-select-icon",
            style: 'width:16px;height:18px; position:absolute; left:0; top:0; display:block; background:transparent no-repeat scroll 0 2px;'
...
ShoppingGuideComboBox = Ext.extend(Disco.Ext.SmartCombox, {
    disableChoice: true,
    choiceValue: Ext.emptyFn(),
    doQuery: Ext.emptyFn,
    enableKeyEvents: true,
    choiceProvider: function() {
        if (!this.lookupWin) {
            ...
            this.lookupWin.on("select", function(data) {
                this.setValue({
                    id: data[0].id,
                    trueName: data[0][this.displayField ? this.displayField : "trueName"]
                });
                if (this.choiceValue)
                    this.choiceValue(data[0]);
            }, this);
    ...
    autoSelectBySn: function(c, e) {
        if (e.getKey() == Ext.EventObject.ENTER && !this.isExpanded()) {
            var t = c.el.dom.value;
            Ext.Ajax.request({
                url: "employee.java?cmd=getShoppingGuide",
                params: {
                    searchKey: t
                },
                success: function(response, opt) {
        ...
        this.fp.form.submit({
            ...
            success: function(form, action) {
                ...
                if (userName != Global.User.name) {
                    if (Ext.isIE) {
                        ...
                        window.location = "manage.java";
                    }
                } else {
                    this.close();
                    Disco.Ext.isLogin = false;

                }
                /*this.close();
                OnlineMessageManager.me=action.result.data;
                main.loadPersonality();
            ...
            failure: function(form, action) {
                if (action.failureType == Ext.form.Action.SERVER_INVALID)
                    Disco.Ext.Msg.error(action.result.errors.msg);
    ...
    initComponent: function() {
        ...
        this.addButton('退出', function() {
            Ext.Msg.confirm("提示", "确认要退出系统吗？", function(btn) {
                if (btn == "yes")
                    window.location.href = "login.java?cmd=logout";
            })
        }, this);
    }
});
ChangePasswordWindow = Ext.extend(Ext.Window, {
    ...
    save: function() {
        ...
        this.fp.form.submit({
            waitTitle: "请稍候",
            waitMsg: "正在保存...",
            url: 'login.java?cmd=changePasssword&ext=true',
            success: function(form, action) {
...
SystemConfigWindow = Ext.extend(Ext.Window, {
    ...
    styleDatas: [["默认风格", "ext-all"], ["银白风格", "xtheme-gray"], ["绿色风格", "xtheme-green"], ["粉红风格", "xtheme-pink"], ["蓝色风格", "xtheme-blue"]],
    ...
    createFormPanel: function() {
        return new Ext.form.FormPanel({
            ...
            items: [Disco.Ext.Util.buildCombox('homePage', '首页设置', this.desktopTypes, Disco_RIA.getCfg('homePage')), {
                xtype: 'iconcombo',
                valueField: 'id',
                name: 'lang',
                hiddenName: 'lang',
                ...
                mode: 'local',
                editable: false,
                value: Disco_RIA.getCfg('lang'),
                triggerAction: 'all',
                store: new Ext.data.SimpleStore({
                    fields: ['id', 'text', 'icon'],
                    data: [['zh_CN', '中国', 'x-flag-zh-CN'], ['en', 'English', 'x-flag-en']]
                })
            }, Disco.Ext.Util.buildCombox('tabType', '窗体支持', this.tabTypes, Disco_RIA.getCfg('singleTabMode')), Disco.Ext.Util.buildCombox('appType', 'IFrame支持', this.appTypes, Disco_RIA.getCfg('iframe')), Disco.Ext.Util.buildCombox('style', '皮肤', this.styleDatas, (Disco_RIA.getCfg('style') || "default")), Ext.apply({}, {
                fieldLabel: '开取动画',
                name: 'enableAnimate',
                ...
                name: 'maxTab',
                fieldLabel: '最大Tab数',
                value: Disco_RIA.getCfg('maxTabs')
            }]
        });
    },
    save: function() {
        ...
        var homePage = this.fp.form.findField("homePage").getValue();
...
function logout() {
    Ext.Msg.confirm("友情提示", "是否真的要注销当前用户?", function(btn) {
        if (btn == "yes") {
            window.location.href = "login.java?cmd=logout";
            /*Ext.Ajax.request({
            	url:"login.java?cmd=logout&ext=true",
            	success:function(){
 ...
 */
BaseProductBillPanel = Ext.extend(Disco.Ext.CrudListPanel, {
    printData: true,
    ...
    }, "price", "num", "remark", "marketPrice", "packageFee", "taxRate", "taxPrice", "totalAmount"],
    gridForceFit: false,
    columnLock: false,
    maximizable: true,
    pageSize: 20,
    ...
    getEditColumnModel: function() {
        ...
        return new Ext.grid.ColumnModel([new Ext.grid.RowNumberer({
            ...
            dataIndex: "brand",
            width: 80,
            renderer: this.objectRender("name", Disco.Ext.Util.readOnlyGridCellColor)
        }, {
            header: "材质/型号",
            dataIndex: "model",
            width: 80,
            ...
            dataIndex: "unit",
            width: 50,
            renderer: this.objectRender("title", Disco.Ext.Util.readOnlyGridCellColor)
        }, {
            header: "单价",
            dataIndex: "price",
            width: 60,/*editor:new Ext.form.NumberField()*/
            renderer: this.readOnlyRender(),
            summaryType: 'average',
            summaryRenderer: moenyRender
        },
        //{header:"市场价格",dataIndex:"marketPrice",width:80,hidden:false,renderer:this.readOnlyRender(),summaryType: 'average',summaryRenderer: moenyRender},
        {
            header: "数量",
            dataIndex: "num",
            width: 50,
            ...
            width: 80,
            renderer: this.readOnlyRender(moenyRender),
            summaryType: 'sum',
            summaryRenderer: moenyRender
        }, {
            header: "备注",
    ...
    createFormToolBar: function() {
        ...
        //Ext.apply({}, {text:"预览[v]",handler:this.preview,scope:this}, ConfigConst.buttons.preview),
    ...
    addRow: function(rs) {
        Disco.Ext.Util.appendGridRows(this.editGrid, this.editStoreMapping, rs, this.addRowDataHandler.createDelegate(this), true);
    },
    removeRow: function() {
        Disco.Ext.Util.removeEditorGridRow(this.editGrid);
    },
    ...
    showBarCodeWindow: function() {
        BarCodeWindow = Ext.extend(Ext.Window, {
            ...
            addProductTo: function(autoAdd) {
                if (this.data) {
                    ...
                    if (obj)
                        o['stockNum'] = Ext.num(obj.product['storeNum'], 0);
                    this.form.getForm().setValues(o);
                    this.data.product['color'] = obj.color;
                    autoAdd = autoAdd || this.findSomeThing('quickScan').getValue();
                    if (autoAdd) {
                        if (this.form.findField("fixedNum").getValue()) {
                            this.data['num'] = this.form.findField("num").getValue();
                        } else if (!this.form.findField('quickScan').getValue()) {
                            this.data['num'] = this.form.findField("num").getValue();
                        } else {
                            this.form.findField("num").setValue(1);
                            this.data['num'] = 1;
                        }
                        service.addProductByBarCode(this.data);
                        this.form.findField("barCode").focus(true, 100);
                    } else if (!this.form.findField("fixedNum").getValue()) {
                        this.form.findField("num").focus(true, 100);
                    } else {
            ...
            getloadProductByBarCodeParams: function() {
                var params = {};
                var supplier = this.crudService.fp.getForm().findField('supplier');
                if (supplier)
                    params['client'] = supplier.getValue();
                return params;
            },
            loadProductByBarCode: function(autoAdd) {
                var code = this.findSomeThing("barCode").getValue();
                var params = this.getloadProductByBarCodeParams();
                Ext.Ajax.request({
                    waitMsg: '正在加载信息，请稍后。。。。',
                    url: 'product.java',
                    params: Ext.apply({
                                ...
                                specialkey: function(textfield, e) {
                                    if (e.keyCode == 13) {
                                        if (textfield.getValue().trim() == '') {
                                            Disco.Ext.Msg.error('请录入条码！', null, function() {
                                                textfield.focus();
                                            }, this);
                                            return;
                                        }
        ...
        var barWin = Disco.Ext.Util.barWin, supplierId;
        if (!barWin) {
            barWin = new BarCodeWindow();
            Disco.Ext.Util.barWin = barWin;
        }
            ...
            success: function(req) {
                ...
                if (ret.items && ret.items.length) {
                    if (this.beforeLoadItem)
                        this.beforeLoadItem(ret.items, grid, ret);
                    grid.store.loadData({
    ...
    save: function() {
        var o = Disco.Ext.Util.getEditGridData(this.editGrid, "item_", "product");
        o.red = (this.red == true);
    ...
    operateRender: function(v, p, r) {
        ...
        if (v != 1)
            return t.applyTemplate(["审核确认", "auditing", r.get("id")]);
    },
...
BasePurchaseBillPanel = Ext.extend(BaseProductBillPanel, {
    ...
    editStoreMapping: ["id", "product", {
        ...
        name: "colorSn",
        mapping: "product.colorSn"
    }, "unit", "price", "num", "remark", "marketPrice", "packageFee", "taxRate", "taxPrice", "totalAmount", "vdate", "approveNum", "blockSn", "closed", "purpose"],
    formFocus: function() {
...
BaseStockBillPanel = Ext.extend(BaseProductBillPanel, {
    baseUrl: "stockIncome.java",
    storeMapping: ["id", "sn", "vdate", "supplier", "purchaseOrder", "transfer", "types", "sender", "deliver", "depot", "red", "inputTime", "inputUser", "auditing", "auditor", "recipient", "keeper", "manager", "totalAmount", "closed", "status", "remark", "items", "fee1", "fee2", "fee3", "fee4", "other1", "other2", "other3", "other4", "other5"],
    editEmptyObj: {
        "id": null,
        "product": null,
        productTitle: null,
    ...
    editStoreMapping: ["id", "product", {
        ...
        name: "colorSn",
        mapping: "product.colorSn"
    }, "price", "num", "remark", "location", "depot", "blockSn", "totalAmount", "vdate", "totalAmount", "salePrice", "saleAmount", "other1", "other2", "other3"],
    /**
     * 子类根据情况重载
     * @param {} record
     */
     ...
     */
    selectRowDataHandler: function(obj, record) {
        obj.toString = Disco.Ext.Util.objectToString;
        record.set("product", obj);
        record.set("productTitle", obj.title);
        record.set("productSn", obj.sn);
        record.set("spec", obj.spec);
    ...
    afterList: function() {
        ...
        this.grid.on("render", function() {
            this.grid.getTopToolbar().insert(10, [{
                ...
                scope: this
            }, "-", "时间:从", this.search_vdate1, "到", this.search_vdate2, "供应商", this.search_supplier, {
                text: "查询",
...
BaseStockOutcomeBillPanel = Ext.extend(BaseStockBillPanel, {
    ...
    getEditColumnModel: function() {
        ...
        var other1Editor = new Disco.Ext.SmartCombox(Ext.apply({}, {
            typeAhead: false,
            editable: true,
            hiddenName: null
        }, otherConfig));
    ...
    afterList: function() {
        ...
        this.grid.on("render", function() {
            this.grid.getTopToolbar().insert(10, ["-", {
                ...
                handler: this.executeMulitCmd("batchAuditing"),
                scope: this
            }, "-", "时间:从", this.search_vdate1, "到", this.search_vdate2, this.search_distributor, this.search_client, "-", {
                text: "查询",
                handler: this.quickSearch,
                scope: this
            }]);
...
BaseStockTakeBillPanel = Ext.extend(BaseStockBillPanel, {
    ...
    editStoreMapping: ["id", "product", {
        ...
        name: "unit",
        mapping: "product.unit"
    }, "price", "num", "remark", "location", "depot", "blockSn", "totalAmount", "vdate", "totalAmount", "salePrice", "saleAmount", "factNum", "accountNum"],
    formFocus: function() {
...
Disco.Ext.AdvanceSearch = Ext.extend(Ext.Button, {
    iconCls: "search-icon",
    text: "高级搜索",
    store: undefined,
    formConfig: {},
    ...
    expand: function() {
        if (!this.isCreate()) {
            ...
            this.formPanel.getForm().items.each(function(field) {
                ...
                if (field.getXType() == "datefield" || field.getXType() == "datesearchfield")
...
Ext.reg("advanceSearch", Disco.Ext.AdvanceSearch);
//屏蔽浏览器的右键
if (Ext.isIE) {
        ...
        fn: function(k, e) {
            var node = {
                ...
                attributes: {
                    ...
                    script: "sys/SystemHelpDocPanel.js",
                    inWin: true
                }
            };
