...
import com.eastinno.otransos.core.support.query.GenericFieldQuery;
...
public class GenericFieldPageList implements IPageList {
    ...
    public GenericFieldPageList(Class cls, IFieldQueryObject fqObject, IJpaGenericDAO dao) {
        this(cls, fqObject.getSelectFields(), fqObject.getQuery(), fqObject.getParameters(), dao, fqObject.getQueryFields());
    }

    public GenericFieldPageList(Class cls, String fields, String scope, Collection paras, IJpaGenericDAO dao, List<String> queryFields) {
