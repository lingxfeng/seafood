...
/**
 * Spring and Disco Integeration Container .
 * <p>
 * <b>Some Questions :</b> 1.Why there is a parent bean in {@link InnerContainer} ? 2.Should this {@link InnerContainer}
 * be used in representation layer ? 3.Dose Method <code>getBean(Class type)</code> have any value ?
 * <p>
 * <b>Usage :</b> <code>
 *      <bean name="SpringIntegerationContainer" class="com.eastinno.otransos.container.impl.SpringIntegerationContainer" scope="singleton">
