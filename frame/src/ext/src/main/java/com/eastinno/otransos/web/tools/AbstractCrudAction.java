 ...
 * @version 1.0
 */
public abstract class AbstractCrudAction extends com.eastinno.otransos.web.core.AbstractPageCmdAction {
    ...
    protected Serializable getIdValue(WebForm form) {
        return (Serializable) new BeanWrapperImpl().convertIfNecessary(form.get(getIdName()), getIdClass());
    }
