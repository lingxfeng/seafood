...
public class FieldQueryObject implements IFieldQueryObject {
    ...
    protected String orderString() {
        ...
        if (getOrderBy().size() > 0 && getOrderType().size() > 0 && getOrderBy().size() == getOrderType().size()) {
    ...
    public IFieldQueryObject addQuery(String field, Object para, String expression) {
    ...
    public IFieldQueryObject addQuery(String field, Object para, String expression, String logic) {
        if (field != null && para != null) {
            queryString += " " + logic + " " + field + " " + handleExpression(expression) + " ? ";
            params.add(para);
        }
        return this;
    }
    ...
    public static void main(String[] args) {
        ...
        String sql = "select " + fqo.getSelectFields() + " from User obj where " + fqo.getQuery();
