...
Ext.ux.BaseGridChartPanel=Ext.extend(BaseGridList,{
	...
	createToolbar : function(){
		...
		var fixBtn= ["-",
			...
			{id:"btn_chart",text : "图表分析",iconCls : 'f5',handler : this.analysis,scope : this}
		];
	...
	analysis:function(){
		ChartWindow.showChart({max:20,label:"name",title:"图表分析",field:"age",store:this.store,columnModel:[{id:"age",title:"年龄"}]});
	},
	printList:function(){
		var parsep = this.parseParams();
		var tag = parsep === undefined||parsep === true;
...
BaseGridListReport=Ext.extend(Ext.ux.BaseGridChartPanel,{
	...
	createButtonToolBar:function(){
		...
		this.search_sex=new Ext.form.ComboBox(Ext.apply({},{width:80},Disco.Ext.Util.buildCombox("sex", "sex", [["男", "1"],["女", "0"]], "1", true)));
		this.search_compare=new Ext.form.ComboBox(Ext.apply({},{width:80},Disco.Ext.Util.buildCombox("compare", "compare", [[">=", "1"],["<=", "0"]], "1", true)));
