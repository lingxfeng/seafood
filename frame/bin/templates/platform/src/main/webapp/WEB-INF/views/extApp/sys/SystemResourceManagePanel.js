...
// 信息分类栏目管理
SystemResourceManagePanel = function() {
    ...
    SystemResourceManagePanel.superclass.constructor.call(this, {
...
Ext.extend(SystemResourceManagePanel, Ext.Panel, {
    ...
    beforeDestroy: function() {
        ...
        SystemResourceManagePanel.superclass.beforeDestroy.call(this);
    },
    /**
     * 批量创建权限
     */
