...
// 系统限资源管理
SystemLogListPanel = Ext.extend(Disco.Ext.CrudPanel, {
    ...
    storeMapping: ["id", "user", "vdate", "ip", "action", "cmd", "types", "params"],
...
SystemLogManagePanel = function() {
    ...
    SystemLogManagePanel.superclass.constructor.call(this, {
...
Ext.extend(SystemLogManagePanel, Ext.Panel, {});