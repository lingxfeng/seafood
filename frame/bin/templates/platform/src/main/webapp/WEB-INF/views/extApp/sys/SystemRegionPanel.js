...
SystemRegionListPanel = Ext.extend(Disco.Ext.CrudPanel, {
			...
			createForm : function() {
				var formPanel = new Ext.form.FormPanel({
					...
					items : [{
							...
							{xtype:"textarea",name:"intro",fieldLabel : "简介",anchor:"100%"}
							]
				});
				return formPanel;
			},
			...
			storeMapping : ["id","sn", "title", "englishName", "spell","shortSpell","parent",{name:"parentId",mapping:"parent"},"lev", "sequence", "inputTime","inputUser", "status"],
