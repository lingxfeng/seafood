...
DepartmentListPanel=Ext.extend(Disco.Ext.CrudPanel,{
    id:"departmentListPanel",
    //title:"Department管理",
    baseUrl:"department.java",
    viewWin:{
    	width : 430,
    	height :　310,
    	title : '部门信息'
    ...
    var formPanel=new Ext.form.FormPanel({
        ...
        defaultType:'textfield',
					    ...
					    {fieldLabel:'编码',name:'sn',allowBlank:false},
					    {fieldLabel:'名称',name:'title',allowBlank:false},
                        {fieldLabel:'上级部门',name:'parent',xtype:"treecombo",hiddenName:"parent",displayField:"title",valueField:"id",
					    ...
					    {fieldLabel:'排序',name:'sequence',xtype:"numberfield"},
    ...
    storeMapping:["id","sn","title","intro","dirPath","tel","fax","sequence","parent"   ],
    initComponent : function(){
    this.cm=new Ext.grid.ColumnModel([
		{header: "编号", sortable:true,width: 100, dataIndex:"sn"},
		{header: "名称", sortable:true,width: 100, dataIndex:"title"},
		{header: "上级", sortable:true,width: 100, dataIndex:"parent",renderer:this.objectRender("title")},
		{header: "电话", sortable:true,width: 100, dataIndex:"tel"},
		{header: "传真", sortable:true,width: 100, dataIndex:"fax"},
...
DepartmentPanel = Ext.extendX(Disco.Ext.TreeCascadePanel,function(superclass){
	return {
		queryParam:'parentId',
		treeCfg : {
			title :"部门树",
