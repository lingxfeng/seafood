...
/**
 * 用于CRUDPanel上的查询控件
 * @class Disco.Ext.CrudSearchField
 * @extends Ext.form.TwinTriggerField
 */
Disco.Ext.CrudSearchField = Ext.extend(Ext.form.TwinTriggerField, {
            initComponent : function() {
                if (!this.store.baseParams) {
                    this.store.baseParams = {};
                }
                Disco.Ext.CrudSearchField.superclass.initComponent.call(this);
            ...
            reset:function(){
                ...
                Disco.Ext.CrudSearchField.superclass.reset.call(this);
            },
...
Disco.Ext.CrudPanel=Ext.extend(Ext.Panel,{
    ...
    initComponent : function(){   
       this.store=new Ext.data.JsonStore({
        ...
        this.searchField=new Disco.Ext.CrudSearchField({hidden:!this.showSearchField,width:this.searchFieldWidth||100,store:this.store});
        var tbar=[
             {    
                text: '添加',  
                handler: this.create,
...
Ext.apply(Disco.Ext.CrudPanel.prototype,Disco.Ext.Util);

Disco.Ext.CrudTreePanel=Ext.extend(Disco.Ext.CrudPanel,{
    ...
    initComponent:function(){
        Disco.Ext.CrudTreePanel.superclass.initComponent.call(this);
...
Disco.Ext.BaseGridList = Ext.extend(Ext.Panel, {
            layout : "fit",
            loadData : false,
            pageSize : 10,
            closable : true,
            ...
            refresh : function() {
                ...
                this.store.reload({callback:function(rs){
                    if(rs && rs.length<1){Ext.Msg.alert("提示","没有符合条件的数据！");Disco.Ext.Util.autoCloseMsg.defer(2000);}
                    }
                });
            },
            ...
            initComponent : function() {
                Disco.Ext.BaseGridList.superclass.initComponent.call(this);
                if(!this.store){
...
Ext.apply(Disco.Ext.BaseGridList.prototype,Disco.Ext.Util);        


//下面的代码参考自DiscoRIA Framework,主要用于处理对象选择
Disco.Ext.ObjectSelectWin=Ext.extend(Ext.Window,{
    width:700,
    height:500,
    layout:"fit",
    closeAction:"hide",
    ...
    initComponent:function(){
        ...
        Disco.Ext.ObjectSelectWin.superclass.initComponent.call(this);                
        if(!this.gridListClz){
...
Disco.Ext.ObjectSearchField = Ext.extend(Ext.form.SearchField,{
    hideTrigger1:true,
   // searchUrl:"product.java?cmd=list&pageSize=15",
    paramName:'searchKey',
    choiceValue : Ext.emptyFn(),
    blank:Ext.emptyFn,
    noneProductExistMsg:"该编号没有货品对应",
    beforeDestroy:function(){
        Disco.Ext.ObjectSearchField.superclass.beforeDestroy.call(this);
        if(this.searchWin){
    ...
    getSearchWin:function(){
        if(!this.searchWin){
            ...
            this.searchWin = new Disco.Ext.ObjectSelectWin({gridListClz:this.gridListClz});
 ...
 * @class Disco.Ext.BaseProductBillPanel
 * @extends Disco.Ext.CrudPanel
 */
Disco.Ext.CrudMainDetailPanel=Ext.extend(Disco.Ext.CrudPanel,{
    //子类可以替换该方法
    ...
    addRow:function(){
       Disco.Ext.Util.addGridRow(this.editGrid,{product:{sn:null}});
    },
    removeRow:function(){
       Disco.Ext.Util.removeGridRow(this.editGrid);
    },
    edit:function(){
        Disco.Ext.CrudMainDetailPanel.superclass.edit.call(this);
        var record=this.grid.getSelectionModel().getSelected();
        if(record){
    ...
    create:function(){
        Disco.Ext.CrudMainDetailPanel.superclass.create.call(this);
        this.editGrid.store.removeAll();
        this.autoAddLastRow();
    },
    save:function(){
        var o=Disco.Ext.Util.getEditGridData(this.editGrid,"item_",this.detailItemKey||"product");
        this.fp.form.baseParams=o;
        Disco.Ext.CrudMainDetailPanel.superclass.save.call(this);
    },
    createWin:function(){
    ...
    createColumnEditor:function(){
        ...
        //下面的代码仅提供给子类中参考
        /*var service=this;
        this.productEditor=new Disco.Ext.ObjectSearchField({
    ...
    getEditGridColumn : function() {
                ...
                return new Ext.grid.ColumnModel([new Ext.grid.RowNumberer({header:"序号",width:40,name:"sequence"}),
                    {header:"Id",dataIndex:"id",width:1,hidden:true,hideable:false},
                    {
                            ...
                            editor:new Ext.form.NumberField(),
                            summaryType: 'sum',
                            summaryRenderer: Disco.Ext.Util.moneyRender
                        }, {
                            header : "金额",
                            width : 60,
                            sortable : true,
...
Disco.Ext.LabelField = Ext.extend(Ext.form.Field, {
    defaultAutoCreate: {tag: 'div'},
    fieldClass:"x-form-item-label",
    style:"padding-top:3px",
    onRender : function(ct, position){
      Disco.Ext.LabelField.superclass.onRender.call(this, ct, position);
      this.el.dom.name=this.initialConfig.name;
      this.el.dom.value='';      
    },  
    setValue : function(v){
       Disco.Ext.LabelField.superclass.setValue.call(this,v);  
       var t=v;    
...
Ext.reg('labelfield', Disco.Ext.LabelField);
/**
 * 树状下拉框
 */
Disco.Ext.TreeComboField = Ext.extend(Ext.form.TriggerField, {
        ...
        selectPrevious:function(){
            ...
            onRender : function(ct, position) {
                Disco.Ext.TreeComboField.superclass.onRender.call(this, ct,
                        position);
